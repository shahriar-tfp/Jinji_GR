...
Partial Class Pages_Organisation_OCP_Name
...
#Region "Sub & Function"
    ...
    Private Function ValidateUpdate() As Boolean
        ...
        Try
            lblresult2.Visible = True
            myDS = mySQL.ExecuteSQL("Select Code,Option_Data_Type,[Name] From Table_Field Where Table_Profile_Code='" & "OCP_NAME" & "' And Option_Primary_Key='NO' And Option_View_Card='YES' Order By Table_Profile_Code,Sequence_No", Session("Company").ToString, Session("EmpID").ToString)
            ssql = "Update [" & "OCP_NAME" & "] Set "
            If myDS.Tables(0).Rows.Count > 0 Then
                For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                myDS2 = mySQL.ExecuteSQL("Select Code,Option_Data_Type,[Name] From Table_Field Where Table_Profile_Code='" & "OCP_NAME" & "' And Option_Primary_Key='YES' Order By Table_Profile_Code,Sequence_No", Session("Company").ToString, Session("EmpID").ToString)
                If myDS2.Tables(0).Rows.Count > 0 Then
    ...
    Private Function ValidateInsert() As Boolean
        ...
        Try
            ...
            Dim dv As Integer = 7
            ssql = "exec sp_sa_get_insert_statement '" & Session("Company") & "','" & Session("Module") & "','" & "OCP_NAME" & "'"
            myDSInsert = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)

            lblresult2.Visible = True
            ssql = "Insert Into [" & "OCP_NAME" & "] ("
            ssql2 = ") Values("
            ssql3 = "Select * From [" & "OCP_NAME" & "] Where "
            ssql4 = ""
