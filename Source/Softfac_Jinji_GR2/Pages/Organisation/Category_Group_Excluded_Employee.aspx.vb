...
Partial Class Pages_Organisation_Category_Group_Excluded_Employee
...
#Region "Panel Edit"
    ...
    Protected Sub imgBtnEmployee_Profile_ID2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnEMPLOYEE_PROFILE_ID2.Click
        ...
        lstleft.Items.Clear()
        lstright.Items.Clear()
        ssql = "Exec sp_sa_getListBoxValue 'getGroupByValue4','" & Session("Company") & "','" & txtOCP_ID_CATEGORY_GROUP.Text & "','','','','',''"
        myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
        If myDS.Tables(0).Rows.Count > 0 Then
            ...
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "EMPLOYEE_PROFILE_ID" Then
                    If Session("action_edit") = "value" Then
                        ...
                        'imgEMPLOYEE_PROFILE_ID.CssClass = myPosition & autonum
                        ...
                        autonum += 1
                        'lblEmployee_Profile_ID.CssClass = myPosition & autonum
                        ...
                        'pnllstleft.CssClass = myPosition & autonum
                        ...
                        'imgBtnEMPLOYEE_PROFILE_ID2.CssClass = "RL" & autonum2 & "_6"
