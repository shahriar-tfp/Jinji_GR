...
Partial Class Pages_System_User_Security
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        mySetting.GetImgBtnUrl(imgBtnUSER_PROFILE_CODE2, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
...
#Region "Panel Edit"
    ...
    Protected Sub imgbtnUSER_PROFILE_CODE_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnUSER_PROFILE_CODE.Click
    ...
    Protected Sub imgBtnUSER_PROFILE_CODE2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUSER_PROFILE_CODE2.Click

        lstleft.Items.Clear()
        lstright.Items.Clear()
        ssql = "Exec sp_sa_getListBoxValue 'getGroupByOCPIDUsrSec','" & Session("Company") & "','" & txtSECURITY_ROLE_HEADER_CODE.Text & "','','','','',''"
        myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
        If myDS.Tables(0).Rows.Count > 0 Then
...
#Region "Sub & Function"
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        imgBtnUSER_PROFILE_CODE2.Visible = False
        imgbtnUSER_PROFILE_CODE.Visible = True
            ...
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "USER_PROFILE_CODE" Then
                    If Session("action_edit") = "value" Then
                        ...
                        txtUSER_PROFILE_CODE.Visible = False
                        ...
                        imgBtnUSER_PROFILE_CODE2.Visible = True
                        imgbtnUSER_PROFILE_CODE.Visible = False
                        imgBtnUSER_PROFILE_CODE2.Style.Add("left", mySetting.GetObjPositionRL(EctWidth, 6, "X"))
                        imgBtnUSER_PROFILE_CODE2.Style.Add("top", mySetting.GetObjPositionRL(6, autonum2, "Y"))
                        imgBtnUSER_PROFILE_CODE2.Style.Add("position", "absolute")
                        autonum += 44
                    Else
                        If lblUSER_PROFILE_CODE.Visible = True Then
                            autonum += 1
                            imgUSER_PROFILE_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgUSER_PROFILE_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgUSER_PROFILE_CODE.Style.Add("position", "absolute")
                            ...
                            lblUSER_PROFILE_CODE.Style.Add("position", "absolute")
                            autonum += 1
                            txtUSER_PROFILE_CODE.Visible = True
