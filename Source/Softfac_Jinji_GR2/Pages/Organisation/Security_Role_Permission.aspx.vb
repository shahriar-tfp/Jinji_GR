...
Partial Class Pages_Organisation_Security_Role_Permission
...
#Region "Page Setting"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If Session("action") = "filter" Then
                If txtSECURITY_ROLE_DETAILS_CODE.Text <> "" Then
                    ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "TABLE_FIELD_CODE" & """," & """" & Trim(txtSECURITY_ROLE_DETAILS_CODE.Text) & """," & """" & Session("EmpID").ToString & """"
    ...
    Sub PagePreload()
        ...
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "SECURITY_ROLE_DETAILS_CODE" & """," & """" & """," & """" & Session("EmpID").ToString & """"
        mySetting.GetLookupValue_ImageButton(imgbtnSECURITY_ROLE_DETAILS_CODE, Form.ID, "txtSECURITY_ROLE_DETAILS_CODE", "CodeName", ssql)
...
#Region "Panel Edit"
    ...
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        ssql1 = "select dbo.fn_ReturnCompanyProfileCode('" & txtCOMPANY_PROFILE_CODE.Text & "'),dbo.fn_ReturnSecurityRoleProfileCode('" & txtSECURITY_ROLE_PROFILE_CODE.Text & "'),dbo.fn_ReturnSecurityRoleHeaderCode('" & txtSECURITY_ROLE_HEADER_CODE.Text & "'),dbo.fn_ReturnSecurityRoleDetailsCode('" & txtSECURITY_ROLE_DETAILS_CODE.Text & "')"
        myDS = mySQL.ExecuteSQL(ssql1)
        If myDS.Tables(0).Rows.Count > 0 Then
            ssql = "Delete from " & Form.ID & " Where Company_profile_Code='" & myDS.Tables(0).Rows(0).Item(0).ToString & "' and SECURITY_ROLE_PROFILE_CODE='" & myDS.Tables(0).Rows(0).Item(1).ToString & "' and SECURITY_ROLE_HEADER_CODE='" & myDS.Tables(0).Rows(0).Item(2).ToString & "' and SECURITY_ROLE_DETAILS_CODE='" & myDS.Tables(0).Rows(0).Item(3).ToString & "'"
    ...
    Protected Sub imgbtnTABLE_FIELD_CODE_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnTABLE_FIELD_CODE.Click
        ...
        If Session("action") <> "filter" Then
            ...
            If ActionValidateFieldSecurityRoleHeader() = False Then
                ...
                Exit Sub
            End If
            If ActionValidateFieldSecurityRoleDetails() = False Then
                lblresult2.Text = lblSECURITY_ROLE_DETAILS_CODE.Text & " field is required..."
                Exit Sub
            End If
            visibleLst()
            lstleft.Items.Clear()
    ...
    Protected Sub imgBtnTABLE_FIELD_CODE2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnTABLE_FIELD_CODE2.Click
        ...
        lstleft.Items.Clear()
        lstright.Items.Clear()
        ssql = "Exec sp_sa_getListBoxValue 'getGroupByTFCSRP','" & Session("Company") & "','" & txtSECURITY_ROLE_DETAILS_CODE.Text & "','" & txtSECURITY_ROLE_PROFILE_CODE.Text & "','" & txtSECURITY_ROLE_HEADER_CODE.Text & "','','',''"
        myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
        If myDS.Tables(0).Rows.Count > 0 Then
...
#Region "Panel Action"
    ...
    Protected Sub imgbtnSECURITY_ROLE_DETAILS_CODE_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnSECURITY_ROLE_DETAILS_CODE.Click
        invisibleLst()
        lstleft.Items.Clear()
        lstright.Items.Clear()
        txtTABLE_FIELD_CODE.Text = ""
        Session("action_edit") = "novalue"
        AutoAdjustPosition("2")
        imgBtnCancel.CssClass = buttonPosition3
        imgBtnClear.CssClass = buttonPosition2
        imgBtnSubmit.CssClass = buttonPosition1
...
#Region "Sub & Function"
    ...
    Private Function ActionValidateFieldSecurityRoleDetails() As Boolean
        If txtSECURITY_ROLE_DETAILS_CODE.Text <> "" Then
            Return True
        Else
            Return False
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "SECURITY_ROLE_DETAILS_CODE" Then
                    If lblSECURITY_ROLE_DETAILS_CODE.Visible = True And txtSECURITY_ROLE_DETAILS_CODE.Visible = True Then
                        autonum += 1
                        imgSECURITY_ROLE_DETAILS_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgSECURITY_ROLE_DETAILS_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgSECURITY_ROLE_DETAILS_CODE.Style.Add("position", "absolute")
                        autonum += 1
                        lblSECURITY_ROLE_DETAILS_CODE.CssClass = "wordstyle12"
                        lblSECURITY_ROLE_DETAILS_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblSECURITY_ROLE_DETAILS_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblSECURITY_ROLE_DETAILS_CODE.Style.Add("position", "absolute")
                        autonum += 1
                        txtSECURITY_ROLE_DETAILS_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtSECURITY_ROLE_DETAILS_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtSECURITY_ROLE_DETAILS_CODE.Style.Add("position", "absolute")
                        txtSECURITY_ROLE_DETAILS_CODE.Width = txtWidth
                        autonum += 1
                        imgbtnSECURITY_ROLE_DETAILS_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnSECURITY_ROLE_DETAILS_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnSECURITY_ROLE_DETAILS_CODE.Style.Add("position", "absolute")
                    End If
                End If
