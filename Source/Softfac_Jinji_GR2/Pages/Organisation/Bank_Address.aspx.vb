...
Partial Class Pages_Organisation_Bank_Address
                                ...
                                If myTextBox.Text <> "" Then
                                    If mySetting.ValidateInput(myTextBox, myDS.Tables(0).Rows(i).Item(1).ToString) = True Then
                                        ...
                                        If myDST.Tables(0).Rows.Count > 0 Then
                                            If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "BANK_PROFILE_CODE" Then
                                                If myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" Then
                                                    If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                                        ssql6 = "Select " & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "','" & Session("Company").ToString & "')"
                                                    Else
                                                        ssql6 = "Select " & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString & "','" & Session("Company").ToString & "')"
                                                    End If
                                                Else
                                ...
                                If logic = True Then
                                    If myTextBox.Text <> "" Then
                                        If mySetting.ValidateInput(myTextBox, myDS2.Tables(0).Rows(i).Item(1).ToString) = True Then
                                            ...
                                            myDST = mySQL.ExecuteSQL(ssql5, Session("Company").ToString, Session("EmpID").ToString)
                                            If myDST.Tables(0).Rows.Count > 0 Then
                                                If myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper = "BANK_PROFILE_CODE" Then
                                                    If myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" Then
                                                        If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                                            ssql6 = "Select " & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "','" & Session("Company").ToString & "')"
                                                        Else
                                ...
                                If logic = True Then
                                    If myTextBox.Text <> "" Then
                                        If mySetting.ValidateInput(myTextBox, myDSInsert.Tables(0).Rows(i).Item(odt).ToString) = True Then
                                            ...
                                            myDST = mySQL.ExecuteSQL(ssql5, Session("Company").ToString, Session("EmpID").ToString)
                                            If myDST.Tables(0).Rows.Count > 0 Then
                                                If myDSInsert.Tables(0).Rows(i).Item(code).ToString.ToUpper = "BANK_PROFILE_CODE" Then
                                                    If myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" Then
                                                        If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                                            ssql6 = "Select " & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "','" & Session("Company").ToString & "')"
                                                        Else
