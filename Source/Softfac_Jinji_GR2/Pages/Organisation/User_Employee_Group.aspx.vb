...
Partial Class Pages_Organisation_User_Employee_Group
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        mySetting.GetImgBtnUrl(imgbtnEMPLOYEE_GROUP_ID2, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
...
#Region "Panel Edit"
    ...
    Protected Sub imgbtnEMPLOYEE_GROUP_ID_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnEMPLOYEE_GROUP_ID.Click

        If ActionValidateFieldComProCode() = False Then
            lblresult2.Text = lblCOMPANY_PROFILE_CODE.Text & " field is required..."
            Exit Sub
        End If
        If ActionValidateFieldUsrProCode() = False Then
    ...
    Protected Sub imgbtnEMPLOYEE_GROUP_ID2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnEMPLOYEE_GROUP_ID2.Click

        lstleft.Items.Clear()
        lstright.Items.Clear()
        ssql = "Exec sp_sa_getListBoxValue 'getUsrEmpGroup','" & Session("Company") & "','" & txtUSER_PROFILE_CODE.Text & "','','','','',''"
        myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
        If myDS.Tables(0).Rows.Count > 0 Then
...
#Region "Sub & Function"
    ...
    Private Function ActionValidateFieldComProCode() As Boolean
    ...
    Private Function ActionValidateFieldUsrProCode() As Boolean
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        imgbtnEMPLOYEE_GROUP_ID2.Visible = False
        imgbtnEMPLOYEE_GROUP_ID.Visible = True
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "EMPLOYEE_GROUP_ID" Then
                    If Session("action_edit") = "value" Then
                        ...
                        imgEMPLOYEE_GROUP_ID.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgEMPLOYEE_GROUP_ID.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgEMPLOYEE_GROUP_ID.Style.Add("position", "absolute")
                        autonum += 1
                        lblEMPLOYEE_GROUP_ID.CssClass = "wordstyle12"
                        lblEMPLOYEE_GROUP_ID.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblEMPLOYEE_GROUP_ID.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblEMPLOYEE_GROUP_ID.Style.Add("position", "absolute")
                        autonum += 1

                        txtEMPLOYEE_GROUP_ID.Visible = False
                        ...
                        imgbtnEMPLOYEE_GROUP_ID2.Visible = True
                        imgbtnEMPLOYEE_GROUP_ID.Visible = False
                        imgbtnEMPLOYEE_GROUP_ID2.Style.Add("left", mySetting.GetObjPositionRL(EctWidth, 6, "X"))
                        imgbtnEMPLOYEE_GROUP_ID2.Style.Add("top", mySetting.GetObjPositionRL(6, autonum2, "Y"))
                        imgbtnEMPLOYEE_GROUP_ID2.Style.Add("position", "absolute")
                        autonum += 44
                    Else
                        If lblEMPLOYEE_GROUP_ID.Visible = True Then
                            autonum += 1
                            imgEMPLOYEE_GROUP_ID.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgEMPLOYEE_GROUP_ID.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgEMPLOYEE_GROUP_ID.Style.Add("position", "absolute")
                            ...
                            lblEMPLOYEE_GROUP_ID.Style.Add("position", "absolute")
                            autonum += 1
                            txtEMPLOYEE_GROUP_ID.Visible = True
                            txtEMPLOYEE_GROUP_ID.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            txtEMPLOYEE_GROUP_ID.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            txtEMPLOYEE_GROUP_ID.Style.Add("position", "absolute")
                            txtEMPLOYEE_GROUP_ID.Width = txtWidth
                            autonum += 1
                            imgbtnEMPLOYEE_GROUP_ID.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgbtnEMPLOYEE_GROUP_ID.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgbtnEMPLOYEE_GROUP_ID.Style.Add("position", "absolute")
                        End If
                    End If
                End If
