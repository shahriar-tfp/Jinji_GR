...
Partial Class Pages_Organisation_Category_Profile
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        mySetting.GetImgBtnUrl(imgBtnOCP_ID_CATEGORY2, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
...
#Region "Panel Edit"
    ...
    Protected Sub imgBtnOCP_ID_Category_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Category.Click
        ...
        If ActionValidateFieldGroupBy() = False Then
            lblresult2.Text = lblOption_Category.Text & " field is required..."
            Exit Sub
        End If
        visibleLst()
        lstleft.Items.Clear()
        lstright.Items.Clear()
        txtOCP_ID_Category.Text = ""
    ...
    Protected Sub imgBtnOCP_ID_Category2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Category2.Click

        lstleft.Items.Clear()
        lstright.Items.Clear()
        ssql = "Exec sp_sa_getListBoxValue 'getGroupByValue3','" & Session("Company") & "','" & ddlOPTION_CATEGORY.SelectedValue & "','','','','',''"
        myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
        If myDS.Tables(0).Rows.Count > 0 Then
...
#Region "Sub & Function"
    ...
    Private Function ActionValidateFieldGroupBy() As Boolean
        If ddlOption_Category.SelectedValue <> "" Then
            Return True
        Else
            Return False
        End If
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        imgBtnOCP_ID_Category2.Visible = False
        imgBtnOCP_ID_Category.Visible = True
            ...
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OPTION_CATEGORY" Then
                    If lblOption_Category.Visible = True And ddlOption_Category.Visible = True Then
                        autonum += 1
                        imgOPTION_CATEGORY.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgOPTION_CATEGORY.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgOPTION_CATEGORY.Style.Add("position", "absolute")
                        autonum += 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OCP_ID_CATEGORY" Then
                    If Session("action_edit") = "value" Then
                        ...
                        imgOCP_ID_CATEGORY.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgOCP_ID_CATEGORY.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgOCP_ID_CATEGORY.Style.Add("position", "absolute")
                        autonum += 1
                        lblOCP_ID_CATEGORY.CssClass = "wordstyle12"
                        lblOCP_ID_CATEGORY.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOCP_ID_CATEGORY.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOCP_ID_CATEGORY.Style.Add("position", "absolute")
                        autonum += 1

                        txtOCP_ID_CATEGORY.Visible = False
                        ...
                        imgBtnOCP_ID_Category2.Visible = True
                        imgBtnOCP_ID_Category.Visible = False
                        imgBtnOCP_ID_CATEGORY2.Style.Add("left", mySetting.GetObjPositionRL(EctWidth, 6, "X"))
                        imgBtnOCP_ID_CATEGORY2.Style.Add("top", mySetting.GetObjPositionRL(6, autonum2, "Y"))
                        imgBtnOCP_ID_CATEGORY2.Style.Add("position", "absolute")
                        autonum += 44
                    Else
                        If lblOCP_ID_CATEGORY.Visible = True Then
                            autonum += 1
                            imgOCP_ID_CATEGORY.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgOCP_ID_CATEGORY.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgOCP_ID_CATEGORY.Style.Add("position", "absolute")
                            ...
                            lblOCP_ID_CATEGORY.Style.Add("position", "absolute")
                            autonum += 1
                            txtOCP_ID_CATEGORY.Visible = True
                            txtOCP_ID_CATEGORY.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            txtOCP_ID_CATEGORY.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            txtOCP_ID_CATEGORY.Style.Add("position", "absolute")
                            txtOCP_ID_CATEGORY.Width = txtWidth
                            autonum += 1
                            imgBtnOCP_ID_CATEGORY.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgBtnOCP_ID_CATEGORY.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgBtnOCP_ID_CATEGORY.Style.Add("position", "absolute")
                        End If
                    End If
                End If
