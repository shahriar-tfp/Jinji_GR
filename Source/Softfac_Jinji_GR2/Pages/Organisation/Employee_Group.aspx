<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Group.aspx.vb" Inherits="Pages_Organisation_Employee_Group" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Organisation - Employee Group Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_Group" runat="server">
    <div>
    <asp:Panel ID="pnledit" runat="server" visible="true"> 
    <!--// 1 //-->
    <asp:imagebutton id="imgEMPLOYEE_GROUP_ID" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblEMPLOYEE_GROUP_ID" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtEMPLOYEE_GROUP_ID" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnEMPLOYEE_GROUP_ID" runat="server" Height="21px"></asp:imagebutton>
    <!--// 2 //-->
  ...
  <%--  <asp:HyperLink ID="HyplnkReport1" runat="server" Text="Salary/" NavigateUrl="../Information_System/Employee_Salary.aspx"></asp:HyperLink>
    <asp:HyperLink ID="HyplnkReport2" runat="server" Text="Status/" NavigateUrl="../Information_System/Employee_Status.aspx"></asp:HyperLink>
    <asp:HyperLink ID="HyplnkReport3" runat="server" Text="Statutory/" NavigateUrl="../Information_System/Employee_Statutory.aspx"></asp:HyperLink>
    <asp:HyperLink ID="HyplnkReport4" runat="server" Text="Resignation/" NavigateUrl="../Information_System/Employee_Resign.aspx"></asp:HyperLink>
    <asp:HyperLink ID="HyplnkReport5" runat="server" Text="Payment Bank info/" NavigateUrl="../Information_System/Employee_Bank_split.aspx"></asp:HyperLink>
    <asp:HyperLink ID="HyplnkReport6" runat="server" Text="No Of Child Info" NavigateUrl="../Information_System/Employee_No_Of_Child.aspx"></asp:HyperLink>--%>
</div>
						</td>
					</tr>
				</table>
