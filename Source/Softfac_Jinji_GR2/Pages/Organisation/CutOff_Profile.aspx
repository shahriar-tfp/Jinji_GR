<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CutOff_Profile.aspx.vb" Inherits="Pages_Organisation_CutOff_Profile" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Organisation - Cutoff Pprofile Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="CutOff_Profile" runat="server">
    <div>
    ...
    <!--// 2 //-->
    <asp:image id="imgOPTION_PAY_CYCLE" runat="server" Width="21px" Height="21px"></asp:image>
    ...
    <!--// 3 //-->
    <asp:image id="imgYEAR" runat="server" Width="21px" Height="21px"></asp:image>
    ...
    <!--// 4 //-->
    <asp:image id="imgMONTH" runat="server" Width="21px" Height="21px"></asp:image>
    ...
    <!--// 5 //-->
    <asp:image id="imgMODULE_PROFILE_CODE" runat="server" Width="21px" Height="21px"></asp:image>
    ...
    <!--// 6 //-->
	<asp:image id="imgOPTION_PAY_TYPE" runat="server" Height="21px" Width="21px"></asp:image>
	...
	<!--// 7 //-->
	<asp:image id="imgSTART_DATE" runat="server" Height="21px" Width="21px"></asp:image>
	...
	<asp:imagebutton id="imgBtnSTART_DATE" runat="server" Height="21px"></asp:imagebutton>
	<!--// 8 //-->
	<asp:image id="imgEND_DATE" runat="server" Height="21px" Width="21px"></asp:image>
	<asp:label id="lblEND_DATE" runat="server" Width="140px"></asp:label>
	<asp:textbox id="txtEND_DATE" runat="server" Width="150px"></asp:textbox>
	<asp:imagebutton id="imgBtnEND_DATE" runat="server" Height="21px"></asp:imagebutton>
	<!--// Panel //-->
