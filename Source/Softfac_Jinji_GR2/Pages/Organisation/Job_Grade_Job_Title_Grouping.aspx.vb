...
Partial Class Pages_Organisation_Job_Grade_Job_Title
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        mySetting.GetImgBtnUrl(imgBtnOCP_ID_JOB_TITLE2, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
        ...
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID_JOB_GRADE" & """," & """" & """," & """" & Session("EmpID").ToString & """"
        mySetting.GetLookupValue_ImageButton(imgBtnOCP_ID_JOB_GRADE, Form.ID, "txtOCP_ID_JOB_GRADE", "CodeName", ssql)
    ...
    Sub BindGrid()
        ...
        Try
            ...
            Else
                ssql = "Exec sp_sa_GetTableRecordsWithSecurity '" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & Session("Module").ToString & "','" & "job_grade_job_title_grouping_vw" & "','" & myGridView.PageSize & "','" & Session("currentpage") & "'"
                ssql1 = "exec sp_sa_compareTableRecords '" & Session("Company") & "','" & Session("EmpID") & "','" & Session("Module") & "','" & "job_grade_job_title_grouping_vw" & "','" & myGridView.PageSize & "','" & Session("currentpage") & "'"
            End If
...
#Region "Panel Edit"
    ...
    Protected Sub imgBtnOCP_ID_Job_Grade_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Job_Grade.Click
        disableLst()
        disableTxt()
        txtOCP_ID_Job_Grade.Enabled = True
        lstleft.Items.Clear()
        lstright.Items.Clear()
        lblresult2.Text = ""
    End Sub

    Protected Sub imgBtnOCP_ID_Job_Title_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Job_Title.Click

        If ActionValidateFieldJobGrade() = False Then
            lblresult2.Text = lblOCP_ID_Job_Grade.Text & " field is required..."
            Exit Sub
        End If
        visibleLst()
        lstleft.Items.Clear()
    ...
    Protected Sub imgBtnOCP_ID_Job_Title2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Job_Title2.Click

        lstleft.Items.Clear()
        lstright.Items.Clear()
        ssql = "Exec sp_sa_getListBoxValue 'Job_Grade_Job_Title','" & Session("Company") & "','" & txtOCP_ID_Job_Grade.Text & "','','','','',''"
        myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
        If myDS.Tables(0).Rows.Count > 0 Then
    ...
    Sub disableTxt()
        txtOCP_ID_Job_Grade.Enabled = False
        txtOCP_ID_Job_Title.Enabled = False
    End Sub
...
#Region "Sub & Function"
    ...
    Private Function ActionValidateFieldJobGrade() As Boolean

        If txtOCP_ID_Job_Grade.Text <> "" Then
            Return True
        Else
            Return False
        End If
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        imgBtnOCP_ID_Job_Title2.Visible = False
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OCP_ID_JOB_GRADE" Then
                    If lblOCP_ID_Job_Grade.Visible = True And txtOCP_ID_Job_Grade.Visible = True Then
                        autonum += 1
                        imgOCP_ID_JOB_GRADE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgOCP_ID_JOB_GRADE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgOCP_ID_JOB_GRADE.Style.Add("position", "absolute")
                        autonum += 1
                        lblOCP_ID_JOB_GRADE.CssClass = "wordstyle12"
                        lblOCP_ID_JOB_GRADE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOCP_ID_JOB_GRADE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOCP_ID_JOB_GRADE.Style.Add("position", "absolute")
                        autonum += 1
                        txtOCP_ID_JOB_GRADE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtOCP_ID_JOB_GRADE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtOCP_ID_JOB_GRADE.Style.Add("position", "absolute")
                        txtOCP_ID_JOB_GRADE.Width = txtWidth
                        autonum += 1
                        imgBtnOCP_ID_JOB_GRADE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgBtnOCP_ID_JOB_GRADE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgBtnOCP_ID_JOB_GRADE.Style.Add("position", "absolute")
                    End If
                End If

                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OCP_ID_JOB_TITLE" Then
                    If Session("action_edit") = "job_title" Then
                        ' set lst pnl 
                        ...
                        imgOCP_ID_JOB_TITLE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgOCP_ID_JOB_TITLE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgOCP_ID_JOB_TITLE.Style.Add("position", "absolute")
                        autonum += 1
                        lblOCP_ID_JOB_TITLE.CssClass = "wordstyle12"
                        lblOCP_ID_JOB_TITLE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOCP_ID_JOB_TITLE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOCP_ID_JOB_TITLE.Style.Add("position", "absolute")
                        autonum += 1
                        ...
                        imgBtnOCP_ID_Job_Title2.Visible = True
                        imgBtnOCP_ID_Job_Title.Visible = False
                        imgBtnOCP_ID_JOB_TITLE2.Style.Add("left", mySetting.GetObjPositionRL(EctWidth, 6, "X"))
                        imgBtnOCP_ID_JOB_TITLE2.Style.Add("top", mySetting.GetObjPositionRL(6, autonum2, "Y"))
                        imgBtnOCP_ID_JOB_TITLE2.Style.Add("position", "absolute")
                        autonum += 44
                    Else
                        If lblOCP_ID_Job_Title.Visible = True Then
                            autonum += 1
                            imgOCP_ID_JOB_TITLE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgOCP_ID_JOB_TITLE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgOCP_ID_JOB_TITLE.Style.Add("position", "absolute")
                            ...
                            txtOCP_ID_JOB_TITLE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            txtOCP_ID_JOB_TITLE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            txtOCP_ID_JOB_TITLE.Style.Add("position", "absolute")
                            txtOCP_ID_JOB_TITLE.Width = txtWidth
                            autonum += 1
                            imgBtnOCP_ID_JOB_TITLE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgBtnOCP_ID_JOB_TITLE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgBtnOCP_ID_JOB_TITLE.Style.Add("position", "absolute")
                        End If
                    End If
                End If
            Next
    ...
    Private Function ValidateInsertUpdate() As Boolean
        ...
        Try
            ...
            ssql2 = ") Values("
            ssql3 = "Delete From " & Form.ID & " Where "
            ssql4 = ""
            If myDS.Tables(0).Rows.Count > 0 Then
                For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                    Select Case myDS.Tables(0).Rows(i).Item(1).ToString
                        ...
                        Case Else 'character & lookup
                            ...
                            If i = myDS.Tables(0).Rows.Count - 1 Then
                                Dim myImg2 As Image = Page.FindControl("img" & Trim(myDS.Tables(0).Rows(i).Item(0)))
                                If myImg2.Visible = True Then
                            ...
                            If logic = True Then
                                If mySetting.ValidateInput(myTextBox, myDS.Tables(0).Rows(i).Item(1).ToString) = True Then
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        ssql3 = ssql3 & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString
                                        ...
                                        If myDST.Tables(0).Rows(0).Item(1).ToString.Trim <> "" Then
                                            ssql2 = ssql2 & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString
                                            ssql3 = ssql3 & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString
                                            ssql4 = ssql4 & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString
                                        End If
                                        If myDST.Tables(0).Rows(0).Item(2).ToString.Trim <> "" Then
                                            If UCase(myDST.Tables(0).Rows(0).Item(2).ToString) = "COMPANY" Then
                                                ssql2 = ssql2 & "',N'" & Session("Company").ToString
                                                ssql3 = ssql3 & "',N'" & Session("Company").ToString
                                                ssql4 = ssql4 & "',N'" & Session("Company").ToString
                                            Else
                                                ssql2 = ssql2 & "',N'" & myDST.Tables(0).Rows(0).Item(2).ToString
                                                ssql3 = ssql3 & "',N'" & myDST.Tables(0).Rows(0).Item(2).ToString
                                                ssql4 = ssql4 & "',N'" & myDST.Tables(0).Rows(0).Item(2).ToString
                                            End If
                                        End If
                                        If myDST.Tables(0).Rows(0).Item(3).ToString.Trim <> "" Then
                                            ssql2 = ssql2 & "',N'" & myDST.Tables(0).Rows(0).Item(3).ToString
                                            ssql3 = ssql3 & "',N'" & myDST.Tables(0).Rows(0).Item(3).ToString
                                            ssql4 = ssql4 & "',N'" & myDST.Tables(0).Rows(0).Item(3).ToString
                                        End If
                                        ssql2 = ssql2 & "'),''),"
                                        ssql3 = ssql3 & "'),'') And "
                                        ssql4 = ssql4 & "'),''),"
...
#End Region
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        ...
        'myTargetURL = clsRpt.GetReportURL(Session("Company").ToString, Session("EmpID").ToString, Session("Module").ToString, Form.ID.ToString, myGridView.PageSize, _currentPageNumber, Replace(Form.ID.ToString, "_", " ") & " Report", Session("Company").ToString & ".gif", Session("CompanyName").ToString)
        'myTargetURL = "<script language=""""javascript"""" runat=""""server"""">" & "window.open('" & myTargetURL & "');" & "</script>"
        'Page.ClientScript.RegisterStartupScript(GetType(Page), "ShowReport", myTargetURL)
        ''Response.Write("<script>window.open('" & myTargetURL & "');</script>")
    End Sub
End Class
