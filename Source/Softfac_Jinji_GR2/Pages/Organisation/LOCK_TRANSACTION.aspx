<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LOCK_TRANSACTION.aspx.vb" Inherits="PAGES_INFORMATION_SYSTEM_EMPLOYEE_TAX_CATEGORY" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>EMPLOYEE_TAX_CATEGORY</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="LOCK_TRANSACTION" runat="server">
<div>
...
<!--// 2 //-->
<asp:imagebutton id="imgKeyLOCK_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblLOCK_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtLOCK_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnLOCK_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
