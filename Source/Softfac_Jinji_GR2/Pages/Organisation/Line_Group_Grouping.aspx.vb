...
Partial Class Pages_Organisation_Line_Group
...
#Region "Page Setting"
    ...
    Sub BindGrid()
        ...
        Try
            ...
            Else
                ssql = "Exec sp_sa_GetTableRecordsWithSecurity '" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & Session("Module").ToString & "','" & "Line_Group_Grouping_Vw" & "','" & myGridView.PageSize & "','" & Session("currentpage") & "'"
                ssql1 = "exec sp_sa_compareTableRecords '" & Session("Company") & "','" & Session("EmpID") & "','" & Session("Module") & "','" & "Line_Group_Grouping_Vw" & "','" & myGridView.PageSize & "','" & Session("currentpage") & "'"
            End If
                    ...
                    Select Case myDS.Tables(0).Rows(i).Item(1).ToString
                        ...
                        Case "CHARACTER", "LOOKUP", "DECIMAL", "INTEGER"
                            ...
                            If i = myDS.Tables(0).Rows.Count - 1 Then
                                ...
                                "' And Option_Type = 'Group' And [ID] In (Select OCP_ID_Group From Group_Process_Grouping where ocp_id_sector = '" & _
                                mySetting.GetOCPIDbyCodeName_ReturnString(Session("Company"), txtOCP_ID_SECTOR.Text) & "' and ocp_id_division ='" & _
                                mySetting.GetOCPIDbyCodeName_ReturnString(Session("Company"), txtOCP_ID_DIVISION.Text) & "' and ocp_id_department = '" & _
                                mySetting.GetOCPIDbyCodeName_ReturnString(Session("Company"), txtOCP_ID_DEPARTMENT.Text) & "' and ocp_id_section = '" & _
                                mySetting.GetOCPIDbyCodeName_ReturnString(Session("Company"), txtOCP_ID_SECTION.Text) & "' and ocp_id_line = '" & _
                                mySetting.GetOCPIDbyCodeName_ReturnString(Session("Company"), txtOCP_ID_LINE.Text) & "')"
                                'myDS1 = mySQL.ExecuteSQL("Select Distinct OCP_ID_Group From Group_Process Where Company_Profile_Code ='" & Session("Company") & "'")
                                ...
                                If lstleft.Items.Count <> 0 Then
                                    For Me.j = 0 To lstleft.Items.Count - 1
                                        For Me.k = 0 To myDS1.Tables(0).Rows.Count - 1
