...
Partial Class Pages_Organisation_Appraisal_Profile
    ...
    Private Function ValidateUpdate() As Boolean
        ...
        Try
            ...
            If myDS.Tables(0).Rows.Count > 0 Then
                ...
                If CDec(txtMin_Score.Text) > CDec(txtMax_Score.Text) Then
                    lblresult2.Text = "Value of " & lblMin_Score.Text & " should NOT be greater then " & lblMax_Score.Text & " value..."
                    Return False
                End If
    ...
    Private Function ValidateInsert() As Boolean
        ...
        Try
            ...
            If myDSInsert.Tables(0).Rows.Count > 0 Then
                ...
                If imgMin_Score.Visible = True And imgMax_Score.Visible = True Then
                    If CDec(txtMin_Score.Text) > CDec(txtMax_Score.Text) Then
                        lblresult2.Text = "Value of " & lblMin_Score.Text & " should NOT be greater then " & lblMax_Score.Text & " value..."
                        Return False
                    End If
