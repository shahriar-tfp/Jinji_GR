...
Partial Class Pages_Organisation_Division_Department
...
#Region "Page Setting"
    ...
    Sub BindGrid()
        ...
        Try
            ...
            Else
                ssql = "Exec sp_sa_GetTableRecordsWithSecurity '" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & Session("Module").ToString & "','" & "Division_Department_Grouping_Vw" & "','" & myGridView.PageSize & "','" & Session("currentpage") & "'"
                ssql1 = "exec sp_sa_compareTableRecords '" & Session("Company") & "','" & Session("EmpID") & "','" & Session("Module") & "','" & "Division_Department_Grouping_Vw" & "','" & myGridView.PageSize & "','" & Session("currentpage") & "'"
            End If
                    ...
                    Select Case myDS.Tables(0).Rows(i).Item(1).ToString
                        ...
                        Case "CHARACTER", "LOOKUP", "DECIMAL", "INTEGER"
                            If i = myDS.Tables(0).Rows.Count - 1 Then
                                ...
                                "' And Option_Type = 'Department' And [ID] In (Select OCP_ID_Department From Department_Section_Grouping where ocp_id_sector = '" & _
                                mySetting.GetOCPIDbyCodeName_ReturnString(Session("Company"), txtOCP_ID_SECTOR.Text) & "' and ocp_id_division ='" & mySetting.GetOCPIDbyCodeName_ReturnString(Session("Company"), txtOCP_ID_DIVISION.Text) & "')"
