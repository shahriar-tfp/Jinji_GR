...
Partial Class Pages_System_User_Profile
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        'set UpperCase
        mySetting.ConvertUppercase(txtCODE)
        ...
        mySetting.GetImgUrl(imgCONFIRM_PASSWORD, clsGlobalSetting.ImageType._KEY, Session("Company").ToString)
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnEdit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnEdit.Click
        ...
        If ActionValidateEdit() Then
            ...
            imgCONFIRM_PASSWORD.Visible = False
...
#Region "Sub & Function"
    ...
    '        imgCONFIRM_PASSWORD.Visible = True
    '        lblCONFIRM_PASSWORD.Visible = True
    '        txtCONFIRM_PASSWORD.Visible = True

    '        autonum = autonum + 1
    '        imgCONFIRM_PASSWORD.CssClass = myPosition & autonum
    '        autonum = autonum + 1
    '        lblCONFIRM_PASSWORD.CssClass = myPosition & autonum
    '        autonum = autonum + 1
    '        txtCONFIRM_PASSWORD.CssClass = myPosition & autonum
    '        autonum = autonum + 1
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        Try
            ...
            autonum = autonum + 1
            'imgCONFIRM_PASSWORD.CssClass = myPosition & autonum
            imgCONFIRM_PASSWORD.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
            imgCONFIRM_PASSWORD.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
            imgCONFIRM_PASSWORD.Style.Add("position", "absolute")
            autonum = autonum + 1
            'lblCONFIRM_PASSWORD.CssClass = myPosition & autonum
            lblCONFIRM_PASSWORD.CssClass = "wordstyle12"
            lblCONFIRM_PASSWORD.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
            lblCONFIRM_PASSWORD.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
            lblCONFIRM_PASSWORD.Style.Add("position", "absolute")
            autonum = autonum + 1
            'txtCONFIRM_PASSWORD.CssClass = myPosition & autonum
            txtCONFIRM_PASSWORD.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
            txtCONFIRM_PASSWORD.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
            txtCONFIRM_PASSWORD.Style.Add("position", "absolute")
            txtCONFIRM_PASSWORD.Width = txtWidth
            autonum = autonum + 1
    ...
    Private Function InsertInfo() As Boolean

        If txtPASSWORD.Text = "" Then
            lblresult2.Text = "Password field is required..."
            Return False
        End If
        If txtCONFIRM_PASSWORD.Text = "" Then
            lblresult2.Text = "Confirm Password field is required..."
            Return False
        End If
        If txtPASSWORD.Text <> txtCONFIRM_PASSWORD.Text Then
            lblresult2.Text = "Password is not match..."
            Return False
        End If
        Try
            ssql = "Exec sp_sa_validateSystemLogin 'Get_login_Info','" & Session("Company").ToString & " ','','" & txtPASSWORD.Text & "','',''"
            myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
            If myDS.Tables.Count > 0 Then
                If myDS.Tables(0).Rows.Count > 0 Then
                    If myDS.Tables(0).Rows(0).Item(0).ToString = "SUCCESS" Or myDS.Tables(0).Rows(0).Item(0).ToString = "E09" Then
                        txtLOGIN_COUNT.Text = myDS.Tables(0).Rows(0).Item(1).ToString
                        txtLOGIN_FAIL_COUNT.Text = myDS.Tables(0).Rows(0).Item(2).ToString
                        txtPASSWORD_LAST_UPDATE_DATE.Text = myDS.Tables(0).Rows(0).Item(3).ToString
                        txtPASSWORD_DUE_DAY.Text = myDS.Tables(0).Rows(0).Item(4).ToString
                        txtEXPIRY_DATE.Text = myDS.Tables(0).Rows(0).Item(5).ToString
                        txtLAST_LOGIN_DATE_TIME.Text = myDS.Tables(0).Rows(0).Item(6).ToString
                        txtPASSWORD.Text = myDS.Tables(0).Rows(0).Item(7).ToString
                    ElseIf myDS.Tables(0).Rows(0).Item(0).ToString = "E08" Then
                        lblresult2.Text = "Password lenght must at lease " & myDS.Tables(0).Rows(0).Item(8).ToString
                        Return False
                        'ElseIf myDS.Tables(0).Rows(0).Item(0).ToString = "E09" Then
                        '    lblresult2.Text = "Complexity of password is required!"
                        '    Return False
                    ElseIf myDS.Tables(0).Rows(0).Item(0).ToString = "E10" Then
                        lblresult2.Text = "Password should not start with " & myDS.Tables(0).Rows(0).Item(8).ToString
                        Return False
                    End If
                End If
            End If
            ...
            Return True
        Catch ex As Exception
            lblresult2.Text = "System error! Require infomation fail to retrieve..."
            myDS = Nothing
            Return False
        End Try
    ...
    Private Function UpdateInfo() As Boolean
        ...
        End If
        Try
            ssql = "Exec sp_sa_validateSystemLogin 'Get_login_Info','" & Session("Company").ToString & " ','" & txtCODE.Text & "','" & txtPASSWORD.Text & "','',''"
            myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
            If myDS.Tables.Count > 0 Then
                If myDS.Tables(0).Rows.Count > 0 Then
                    If myDS.Tables(0).Rows(0).Item(0).ToString = "SUCCESS" Or myDS.Tables(0).Rows(0).Item(0).ToString = "E09" Then
        ...
        Try
            ...
            If myDSInsert.Tables(0).Rows.Count > 0 Then
                For Me.i = 0 To myDSInsert.Tables(0).Rows.Count - 1
                    ...
                    If UCase(Trim(myDSInsert.Tables(0).Rows(i).Item(ovc).ToString)) = "YES" Or UCase(Trim(myDSInsert.Tables(0).Rows(i).Item(ovc).ToString)) = "NO" Then
                        ...
                        Select Case UCase(myDSInsert.Tables(0).Rows(i).Item(odt).ToString)
                            ...
                            Case "DATETIME"
                                ...
                                If logic = True Then
                                    If myTextBox.Text <> "" Then
                                        If Len(Trim(myTextBox.Text)) = 14 Then
                                            ssql = ssql & myDSInsert.Tables(0).Rows(i).Item(code) & ","
                                            ssql2 = ssql2 & "'" & Trim(myTextBox.Text) & "',"
                                            If UCase(myDSInsert.Tables(0).Rows(i).Item(opr).ToString) = "YES" Then
                                                ssql3 = ssql3 & myDSInsert.Tables(0).Rows(i).Item(code) & "='" & Trim(myTextBox.Text) & "' And "
                                                ssql4 = ssql4 & myDSInsert.Tables(0).Rows(i).Item(code) & "=" & Trim(myTextBox.Text) & ","
                                            End If
                                        Else
