...
Partial Class Pages_Organisation_Group_Process
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        mySetting.GetImgBtnUrl(imgBtnOCP_ID_DEPARTMENT2, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
        mySetting.GetImgBtnUrl(imgBtnOCP_ID_SECTION2, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
        mySetting.GetImgBtnUrl(imgBtnOCP_ID_LINE2, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
        mySetting.GetImgBtnUrl(imgBtnOCP_ID_GROUP2, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
        mySetting.GetImgBtnUrl(imgBtnOCP_ID_PROCESS2, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
    ...
    Sub BindGrid()
        ...
        Try
            ...
            Else
                ssql = "Exec sp_sa_GetTableRecordsWithSecurity '" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & Session("Module").ToString & "','" & "Group_Process_Grouping_Vw" & "','" & myGridView.PageSize & "','" & Session("currentpage") & "'"
                ssql1 = "exec sp_sa_compareTableRecords '" & Session("Company") & "','" & Session("EmpID") & "','" & Session("Module") & "','" & "Group_Process_Grouping_Vw" & "','" & myGridView.PageSize & "','" & Session("currentpage") & "'"
            End If
...
#Region "Panel Edit"
    ...
    Protected Sub imgBtnOCP_ID_Sector_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Sector.Click
        ...
        If Session("action") = "filter" Then
            ...
            txtOCP_ID_DEPARTMENT.Enabled = True
            txtOCP_ID_SECTION.Enabled = True
            txtOCP_ID_LINE.Enabled = True
            txtOCP_ID_GROUP.Enabled = True
            txtOCP_ID_PROCESS.Enabled = True
        End If
        ...
        txtOCP_ID_Line.Text = ""
        txtOCP_ID_Group.Text = ""
        txtOCP_ID_Process.Text = ""
    ...
    Protected Sub imgBtnOCP_ID_Department_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Department.Click
            ...
            For Me.i = 0 To lstright.Items.Count - 1
                If lstright.Items(i).Selected Then
                    ...
                    If numcount > 1 Then
                        ...
                        Exit Sub
                    Else
                        myDS1 = mySetting.GetCodeNamebyOCPID(Session("Company"), Trim(lstright.Items(i).Value.ToString))
                        If myDS1.Tables(0).Rows.Count > 0 Then
                            txtOCP_ID_DIVISION.Text = Trim(myDS1.Tables(0).Rows(0).Item(0).ToString)
                        Else
                            lblresult2.Text = "Data Error: Process terminated..."
                            myDS1 = Nothing
                            Exit Sub
                        End If
                        myDS1 = Nothing
    ...
    Protected Sub imgBtnOCP_ID_Department2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Department2.Click

        ssql = "Exec sp_sa_getListBoxValue 'Division_Department','" & Session("Company") & "','" & txtOCP_ID_Sector.Text & "','" & txtOCP_ID_Division.Text & "','','','',''"
        mySetting.GetListBoxValue2(lstleft, lstright, ssql)
        disableTxt()
        lstright.Enabled = True
        lblresult2.Text = ""
    ...
    Protected Sub imgBtnOCP_ID_Section_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Section.Click
            ...
            For Me.i = 0 To lstright.Items.Count - 1
                If lstright.Items(i).Selected Then
                    ...
                    Else
                        myDS1 = mySetting.GetCodeNamebyOCPID(Session("Company"), Trim(lstright.Items(i).Value.ToString))
                        If myDS1.Tables(0).Rows.Count > 0 Then
                            txtOCP_ID_DEPARTMENT.Text = Trim(myDS1.Tables(0).Rows(0).Item(0).ToString)
                        Else
                            lblresult2.Text = "Data Error: Process terminated..."
                            myDS1 = Nothing
                            Exit Sub
    ...
    Protected Sub imgBtnOCP_ID_Section2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Section2.Click

        ssql = "Exec sp_sa_getListBoxValue 'Department_Section','" & Session("Company") & "','" & txtOCP_ID_Sector.Text & "','" & txtOCP_ID_Division.Text & "','" & txtOCP_ID_Department.Text & "','','',''"
        mySetting.GetListBoxValue2(lstleft, lstright, ssql)
        disableTxt()
        lstright.Enabled = True
        lblresult2.Text = ""
    ...
    Protected Sub imgBtnOCP_ID_Line_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Line.Click
            ...
            For Me.i = 0 To lstright.Items.Count - 1
                If lstright.Items(i).Selected Then
                    ...
                    Else
                        myDS1 = mySetting.GetCodeNamebyOCPID(Session("Company"), Trim(lstright.Items(i).Value.ToString))
                        If myDS1.Tables(0).Rows.Count > 0 Then
                            txtOCP_ID_SECTION.Text = Trim(myDS1.Tables(0).Rows(0).Item(0).ToString)
                        Else
                            lblresult2.Text = "Data Error: Process terminated..."
                            myDS1 = Nothing
                            Exit Sub
    ...
    Protected Sub imgBtnOCP_ID_Line2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Line2.Click

        ssql = "Exec sp_sa_getListBoxValue 'Section_Line','" & Session("Company") & "','" & txtOCP_ID_Sector.Text & "','" & txtOCP_ID_Division.Text & "','" & txtOCP_ID_Department.Text & "','" & txtOCP_ID_Section.Text & "','',''"
        mySetting.GetListBoxValue2(lstleft, lstright, ssql)
        disableTxt()
        lstright.Enabled = True
        lblresult2.Text = ""
    ...
    Protected Sub imgBtnOCP_ID_Group_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Group.Click
            ...
            For Me.i = 0 To lstright.Items.Count - 1
                If lstright.Items(i).Selected Then
                    ...
                    Else
                        myDS1 = mySetting.GetCodeNamebyOCPID(Session("Company"), Trim(lstright.Items(i).Value.ToString))
                        If myDS1.Tables(0).Rows.Count > 0 Then
                            txtOCP_ID_LINE.Text = Trim(myDS1.Tables(0).Rows(0).Item(0).ToString)
                        Else
                            lblresult2.Text = "Data Error: Process terminated..."
                            myDS1 = Nothing
                            Exit Sub
    ...
    Protected Sub imgBtnOCP_ID_Group2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Group2.Click
        ssql = "Exec sp_sa_getListBoxValue 'Line_Group','" & Session("Company") & "','" & txtOCP_ID_Sector.Text & "','" & txtOCP_ID_Division.Text & "','" & txtOCP_ID_Department.Text & "','" & txtOCP_ID_Section.Text & "','" & txtOCP_ID_Line.Text & "',''"
        mySetting.GetListBoxValue2(lstleft, lstright, ssql)
        disableTxt()
        lstright.Enabled = True
        lblresult2.Text = ""
    ...
    Protected Sub imgBtnOCP_ID_Process_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Process.Click
            ...
            For Me.i = 0 To lstright.Items.Count - 1
                If lstright.Items(i).Selected Then
                    ...
                    Else
                        myDS1 = mySetting.GetCodeNamebyOCPID(Session("Company"), Trim(lstright.Items(i).Value.ToString))
                        If myDS1.Tables(0).Rows.Count > 0 Then
                            txtOCP_ID_GROUP.Text = Trim(myDS1.Tables(0).Rows(0).Item(0).ToString)
                        Else
                            lblresult2.Text = "Data Error: Process terminated..."
                            myDS1 = Nothing
                            Exit Sub
    ...
    Protected Sub imgBtnOCP_ID_Process2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_PROCESS2.Click
        ssql = "Exec sp_sa_getListBoxValue 'Group_Process','" & Session("Company") & "','" & txtOCP_ID_SECTOR.Text & "','" & txtOCP_ID_DIVISION.Text & "','" & txtOCP_ID_DEPARTMENT.Text & "','" & txtOCP_ID_SECTION.Text & "','" & txtOCP_ID_LINE.Text & "','" & txtOCP_ID_GROUP.Text & "'"
        mySetting.GetListBoxValue2(lstleft, lstright, ssql)
        disableTxt()
        enableLst()
        lblresult2.Text = ""
    ...
    Sub disableTxt()
        ...
        txtOCP_ID_DEPARTMENT.Enabled = False
        txtOCP_ID_SECTION.Enabled = False
        txtOCP_ID_LINE.Enabled = False
        txtOCP_ID_GROUP.Enabled = False
        txtOCP_ID_PROCESS.Enabled = False
    End Sub
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnFilter_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnFilter.Click
        ...
        mySetting.GetLookupValue_ImageButton(imgBtnOCP_ID_DEPARTMENT, Form.ID, "txtOCP_ID_DEPARTMENT", "CodeName", ssql)
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID_SECTION" & """," & """" & """," & """" & Session("EmpID").ToString & """"
        mySetting.GetLookupValue_ImageButton(imgBtnOCP_ID_SECTION, Form.ID, "txtOCP_ID_SECTION", "CodeName", ssql)
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID_LINE" & """," & """" & """," & """" & Session("EmpID").ToString & """"
        mySetting.GetLookupValue_ImageButton(imgBtnOCP_ID_LINE, Form.ID, "txtOCP_ID_LINE", "CodeName", ssql)
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID_GROUP" & """," & """" & """," & """" & Session("EmpID").ToString & """"
        mySetting.GetLookupValue_ImageButton(imgBtnOCP_ID_GROUP, Form.ID, "txtOCP_ID_GROUP", "CodeName", ssql)
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID_PROCESS" & """," & """" & """," & """" & Session("EmpID").ToString & """"
        mySetting.GetLookupValue_ImageButton(imgBtnOCP_ID_PROCESS, Form.ID, "txtOCP_ID_PROCESS", "CodeName", ssql)
...
#Region "Sub & Function"
    ...
    Private Function GetErrorField(ByVal strerror As String) As String
        ...
        ElseIf strerror = "4" Then
            strerror = lblOCP_ID_Department.Text
        ElseIf strerror = "5" Then
            strerror = lblOCP_ID_Section.Text
        ElseIf strerror = "6" Then
            strerror = lblOCP_ID_Line.Text
        ElseIf strerror = "7" Then
            strerror = lblOCP_ID_Group.Text
        ElseIf strerror = "8" Then
            strerror = lblOCP_ID_Process.Text
        End If
        Return strerror
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        imgBtnOCP_ID_Department2.Visible = False
        imgBtnOCP_ID_Section2.Visible = False
        imgBtnOCP_ID_Line2.Visible = False
        imgBtnOCP_ID_Group2.Visible = False
        imgBtnOCP_ID_PROCESS2.Visible = False
        If Session("action") <> "filter" Then
            imgBtnOCP_ID_DIVISION.Visible = True
            imgBtnOCP_ID_DEPARTMENT.Visible = True
            imgBtnOCP_ID_SECTION.Visible = True
            imgBtnOCP_ID_LINE.Visible = True
            imgBtnOCP_ID_GROUP.Visible = True
            imgBtnOCP_ID_PROCESS.Visible = True
        End If
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OCP_ID_DEPARTMENT" Then
                    If Session("action_edit") = "department" Then
                        ' set lst pnl 
                        pnllstleft.Visible = True
                        pnllstright.Visible = True
                        enableLst()
                        ...
                        imgOCP_ID_DEPARTMENT.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgOCP_ID_DEPARTMENT.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgOCP_ID_DEPARTMENT.Style.Add("position", "absolute")
                        autonum += 1
                        lblOCP_ID_DEPARTMENT.CssClass = "wordstyle12"
                        lblOCP_ID_DEPARTMENT.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOCP_ID_DEPARTMENT.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOCP_ID_DEPARTMENT.Style.Add("position", "absolute")
                        autonum += 1
                        ...
                        lbllstright.Width = txtWidth
                        'lstright.Width = ddlWidth
                        PnlRightList.Width = ddlWidth

                        imgBtnOCP_ID_DEPARTMENT2.Visible = True
                        imgBtnOCP_ID_DEPARTMENT.Visible = False
                        imgBtnOCP_ID_DEPARTMENT2.Style.Add("left", mySetting.GetObjPositionRL(EctWidth, 6, "X"))
                        imgBtnOCP_ID_DEPARTMENT2.Style.Add("top", mySetting.GetObjPositionRL(6, autonum2, "Y"))
                        imgBtnOCP_ID_DEPARTMENT2.Style.Add("position", "absolute")
                        autonum += 44
                    Else
                        If lblOCP_ID_DEPARTMENT.Visible = True Then
                            autonum += 1
                            imgOCP_ID_DEPARTMENT.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgOCP_ID_DEPARTMENT.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgOCP_ID_DEPARTMENT.Style.Add("position", "absolute")
                            ...
                            txtOCP_ID_DEPARTMENT.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            txtOCP_ID_DEPARTMENT.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            txtOCP_ID_DEPARTMENT.Style.Add("position", "absolute")
                            txtOCP_ID_DEPARTMENT.Width = txtWidth
                            autonum += 1
                            imgBtnOCP_ID_DEPARTMENT.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgBtnOCP_ID_DEPARTMENT.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgBtnOCP_ID_DEPARTMENT.Style.Add("position", "absolute")
                        End If
                    End If
                End If

                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OCP_ID_SECTION" Then
                    If Session("action_edit") = "section" Then
                        ' set lst pnl 
                        pnllstleft.Visible = True
                        pnllstright.Visible = True
                        enableLst()
                        ...
                        imgOCP_ID_SECTION.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgOCP_ID_SECTION.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgOCP_ID_SECTION.Style.Add("position", "absolute")
                        autonum += 1
                        lblOCP_ID_SECTION.CssClass = "wordstyle12"
                        lblOCP_ID_SECTION.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOCP_ID_SECTION.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOCP_ID_SECTION.Style.Add("position", "absolute")
                        autonum += 1
                        ...
                        imgBtnOCP_ID_Section2.Visible = True
                        imgBtnOCP_ID_Section.Visible = False
                        imgBtnOCP_ID_SECTION2.Style.Add("left", mySetting.GetObjPositionRL(EctWidth, 6, "X"))
                        imgBtnOCP_ID_SECTION2.Style.Add("top", mySetting.GetObjPositionRL(6, autonum2, "Y"))
                        imgBtnOCP_ID_SECTION2.Style.Add("position", "absolute")
                        autonum += 44
                    Else
                        If lblOCP_ID_Section.Visible = True Then
                            autonum += 1
                            imgOCP_ID_SECTION.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgOCP_ID_SECTION.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgOCP_ID_SECTION.Style.Add("position", "absolute")
                            ...
                            txtOCP_ID_SECTION.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            txtOCP_ID_SECTION.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            txtOCP_ID_SECTION.Style.Add("position", "absolute")
                            txtOCP_ID_SECTION.Width = txtWidth
                            autonum += 1
                            imgBtnOCP_ID_SECTION.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgBtnOCP_ID_SECTION.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgBtnOCP_ID_SECTION.Style.Add("position", "absolute")
                        End If
                    End If
                End If

                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OCP_ID_LINE" Then
                    If Session("action_edit") = "line" Then
                        ' set lst pnl 
                        pnllstleft.Visible = True
                        pnllstright.Visible = True
                        enableLst()
                        ...
                        imgOCP_ID_LINE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgOCP_ID_LINE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgOCP_ID_LINE.Style.Add("position", "absolute")
                        autonum += 1
                        lblOCP_ID_LINE.CssClass = "wordstyle12"
                        lblOCP_ID_LINE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOCP_ID_LINE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOCP_ID_LINE.Style.Add("position", "absolute")
                        autonum += 1

                        txtOCP_ID_LINE.Visible = False
                        ...
                        imgBtnOCP_ID_Line2.Visible = True
                        imgBtnOCP_ID_Line.Visible = False
                        imgBtnOCP_ID_LINE2.Style.Add("left", mySetting.GetObjPositionRL(EctWidth, 6, "X"))
                        imgBtnOCP_ID_LINE2.Style.Add("top", mySetting.GetObjPositionRL(6, autonum2, "Y"))
                        imgBtnOCP_ID_LINE2.Style.Add("position", "absolute")
                        autonum += 44
                    Else
                        If lblOCP_ID_Line.Visible = True Then
                            autonum += 1
                            imgOCP_ID_LINE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgOCP_ID_LINE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgOCP_ID_LINE.Style.Add("position", "absolute")
                            ...
                            lblOCP_ID_LINE.Style.Add("position", "absolute")
                            autonum += 1
                            txtOCP_ID_LINE.Visible = True
                            txtOCP_ID_LINE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            txtOCP_ID_LINE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            txtOCP_ID_LINE.Style.Add("position", "absolute")
                            txtOCP_ID_LINE.Width = txtWidth
                            autonum += 1
                            imgBtnOCP_ID_LINE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgBtnOCP_ID_LINE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgBtnOCP_ID_LINE.Style.Add("position", "absolute")
                        End If
                    End If
                End If

                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OCP_ID_GROUP" Then
                    If Session("action_edit") = "group" Then
                        ' set lst pnl 
                        pnllstleft.Visible = True
                        pnllstright.Visible = True
                        enableLst()
                        ...
                        imgOCP_ID_GROUP.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgOCP_ID_GROUP.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgOCP_ID_GROUP.Style.Add("position", "absolute")
                        autonum += 1
                        lblOCP_ID_GROUP.CssClass = "wordstyle12"
                        lblOCP_ID_GROUP.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOCP_ID_GROUP.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOCP_ID_GROUP.Style.Add("position", "absolute")
                        autonum += 1

                        txtOCP_ID_GROUP.Visible = False
                        ...
                        imgBtnOCP_ID_Group2.Visible = True
                        imgBtnOCP_ID_Group.Visible = False
                        imgBtnOCP_ID_GROUP2.Style.Add("left", mySetting.GetObjPositionRL(EctWidth, 6, "X"))
                        imgBtnOCP_ID_GROUP2.Style.Add("top", mySetting.GetObjPositionRL(6, autonum2, "Y"))
                        imgBtnOCP_ID_GROUP2.Style.Add("position", "absolute")
                        autonum += 44
                    Else
                        If lblOCP_ID_Group.Visible = True Then
                            autonum += 1
                            imgOCP_ID_GROUP.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgOCP_ID_GROUP.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgOCP_ID_GROUP.Style.Add("position", "absolute")
                            ...
                            lblOCP_ID_GROUP.Style.Add("position", "absolute")
                            autonum += 1
                            txtOCP_ID_GROUP.Visible = True
                            txtOCP_ID_GROUP.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            txtOCP_ID_GROUP.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            txtOCP_ID_GROUP.Style.Add("position", "absolute")
                            txtOCP_ID_GROUP.Width = txtWidth
                            autonum += 1
                            imgBtnOCP_ID_GROUP.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgBtnOCP_ID_GROUP.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgBtnOCP_ID_GROUP.Style.Add("position", "absolute")
                        End If
                    End If
                End If

                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OCP_ID_PROCESS" Then
                    If Session("action_edit") = "process" Then
                        ' set lst pnl 
                        pnllstleft.Visible = True
                        pnllstright.Visible = True
                        enableLst()
                        ...
                        imgOCP_ID_PROCESS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgOCP_ID_PROCESS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgOCP_ID_PROCESS.Style.Add("position", "absolute")
                        autonum += 1
                        lblOCP_ID_PROCESS.CssClass = "wordstyle12"
                        lblOCP_ID_PROCESS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOCP_ID_PROCESS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOCP_ID_PROCESS.Style.Add("position", "absolute")
                        autonum += 1

                        txtOCP_ID_PROCESS.Visible = False
                        ...
                        imgBtnOCP_ID_Process2.Visible = True
                        imgBtnOCP_ID_Process.Visible = False
                        imgBtnOCP_ID_PROCESS2.Style.Add("left", mySetting.GetObjPositionRL(EctWidth, 6, "X"))
                        imgBtnOCP_ID_PROCESS2.Style.Add("top", mySetting.GetObjPositionRL(6, autonum2, "Y"))
                        imgBtnOCP_ID_PROCESS2.Style.Add("position", "absolute")
                        autonum += 44
                    Else
                        If lblOCP_ID_Process.Visible = True Then
                            autonum += 1
                            imgOCP_ID_PROCESS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgOCP_ID_PROCESS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgOCP_ID_PROCESS.Style.Add("position", "absolute")
                            ...
                            lblOCP_ID_PROCESS.Style.Add("position", "absolute")
                            autonum += 1
                            txtOCP_ID_PROCESS.Visible = True
                            txtOCP_ID_PROCESS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            txtOCP_ID_PROCESS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            txtOCP_ID_PROCESS.Style.Add("position", "absolute")
                            txtOCP_ID_PROCESS.Width = txtWidth
                            autonum += 1
                            imgBtnOCP_ID_PROCESS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgBtnOCP_ID_PROCESS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgBtnOCP_ID_PROCESS.Style.Add("position", "absolute")
                        End If
                    End If
                End If
            Next
