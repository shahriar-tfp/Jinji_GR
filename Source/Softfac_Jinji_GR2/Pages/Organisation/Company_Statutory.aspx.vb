...
Partial Class Pages_System_Company_Statutory
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        mySetting.GetImgUrl(imgVALUE, clsGlobalSetting.ImageType._KEY, Session("Company").ToString)
        ...
        mySetting.GetImgBtnUrl(imgBtnVALUE, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
