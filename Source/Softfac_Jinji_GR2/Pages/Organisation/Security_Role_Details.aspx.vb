...
Partial Class Pages_Organisation_Security_Role_Details
...
#Region "Private Declaration"
    ...
    Dim ssql1, ssql2, ssql3, ssql4, ssql5, ssql6 As String
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        mySetting.GetImgBtnUrl(imgbtnTABLE_PROFILE_CODE2, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
        ...
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "SECURITY_ROLE_PROFILE_CODE" & """," & """" & """," & """" & Session("EmpID").ToString & """"
        mySetting.GetLookupValue_ImageButton(imgbtnSECURITY_ROLE_PROFILE_CODE, Form.ID, "txtSECURITY_ROLE_PROFILE_CODE", "CodeName", ssql)
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "SECURITY_ROLE_HEADER_CODE" & """," & """" & """," & """" & Session("EmpID").ToString & """"
        mySetting.GetLookupValue_ImageButton(imgbtnSECURITY_ROLE_HEADER_CODE, Form.ID, "txtSECURITY_ROLE_HEADER_CODE", "CodeName", ssql)
...
#Region "Panel Edit"
    ...
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        ssql1 = "select dbo.fn_ReturnCompanyProfileCode('" & txtCOMPANY_PROFILE_CODE.Text & "'),dbo.fn_ReturnSecurityRoleProfileCode('" & txtSECURITY_ROLE_PROFILE_CODE.Text & "'),dbo.fn_ReturnSecurityRoleHeaderCode('" & txtSECURITY_ROLE_HEADER_CODE.Text & "')"
        myDS = mySQL.ExecuteSQL(ssql1)
        If myDS.Tables(0).Rows.Count > 0 Then
            ssql = "Delete from " & Form.ID & " Where Company_profile_Code='" & myDS.Tables(0).Rows(0).Item(0).ToString & "' and SECURITY_ROLE_PROFILE_CODE='" & myDS.Tables(0).Rows(0).Item(1).ToString & "' and SECURITY_ROLE_HEADER_CODE='" & myDS.Tables(0).Rows(0).Item(2).ToString & "'"
    ...
    Protected Sub imgbtnTABLE_PROFILE_CODE_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnTABLE_PROFILE_CODE.Click
        ...
        If Session("action") <> "filter" Then
            If ActionValidateFieldCompany() = False Then
                ...
                Exit Sub
            End If
            If ActionValidateFieldSecurityRoleProfile() = False Then
                lblresult2.Text = lblSECURITY_ROLE_PROFILE_CODE.Text & " field is required..."
                Exit Sub
            End If
            If ActionValidateFieldSecurityRoleHeader() = False Then
                lblresult2.Text = lblSECURITY_ROLE_HEADER_CODE.Text & " field is required..."
                Exit Sub
            End If
    ...
    Protected Sub imgbtnTABLE_PROFILE_CODE2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnTABLE_PROFILE_CODE2.Click
        lstleft.Items.Clear()
        lstright.Items.Clear()
        ssql = "Exec sp_sa_getListBoxValue 'getGroupByTPCSRD','" & Session("Company") & "','','" & txtSECURITY_ROLE_PROFILE_CODE.Text & "','" & txtSECURITY_ROLE_HEADER_CODE.Text & "','','',''"
        myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
        If myDS.Tables(0).Rows.Count > 0 Then
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnEdit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnEdit.Click
        ...
        If ActionValidateEdit() Then
            ...
            imgTABLE_PROFILE_CODE.Enabled = True
            lblTABLE_PROFILE_CODE.Enabled = True
...
#Region "Sub & Function"
    ...
    Private Function ActionValidateFieldSecurityRoleProfile() As Boolean
        If txtSECURITY_ROLE_PROFILE_CODE.Text <> "" Then
            Return True
        Else
            Return False
        End If
    ...
    Private Function ActionValidateFieldSecurityRoleHeader() As Boolean
        If txtSECURITY_ROLE_HEADER_CODE.Text <> "" Then
            Return True
        Else
            Return False
        End If
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        imgbtnTABLE_PROFILE_CODE2.Visible = False
        imgbtnTABLE_PROFILE_CODE.Visible = True
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "SECURITY_ROLE_PROFILE_CODE" Then
                    If lblSECURITY_ROLE_PROFILE_CODE.Visible = True And txtSECURITY_ROLE_PROFILE_CODE.Visible = True Then
                        autonum += 1
                        imgSECURITY_ROLE_PROFILE_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgSECURITY_ROLE_PROFILE_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgSECURITY_ROLE_PROFILE_CODE.Style.Add("position", "absolute")
                        autonum += 1
                        lblSECURITY_ROLE_PROFILE_CODE.CssClass = "wordstyle12"
                        lblSECURITY_ROLE_PROFILE_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblSECURITY_ROLE_PROFILE_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblSECURITY_ROLE_PROFILE_CODE.Style.Add("position", "absolute")
                        autonum += 1
                        txtSECURITY_ROLE_PROFILE_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtSECURITY_ROLE_PROFILE_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtSECURITY_ROLE_PROFILE_CODE.Style.Add("position", "absolute")
                        txtSECURITY_ROLE_PROFILE_CODE.Width = txtWidth
                        autonum += 1
                        imgbtnSECURITY_ROLE_PROFILE_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnSECURITY_ROLE_PROFILE_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnSECURITY_ROLE_PROFILE_CODE.Style.Add("position", "absolute")
                    End If
                End If

                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "SECURITY_ROLE_HEADER_CODE" Then
                    If lblSECURITY_ROLE_HEADER_CODE.Visible = True And txtSECURITY_ROLE_HEADER_CODE.Visible = True Then
                        autonum += 1
                        imgSECURITY_ROLE_HEADER_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgSECURITY_ROLE_HEADER_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgSECURITY_ROLE_HEADER_CODE.Style.Add("position", "absolute")
                        autonum += 1
                        lblSECURITY_ROLE_HEADER_CODE.CssClass = "wordstyle12"
                        lblSECURITY_ROLE_HEADER_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblSECURITY_ROLE_HEADER_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblSECURITY_ROLE_HEADER_CODE.Style.Add("position", "absolute")
                        autonum += 1
                        txtSECURITY_ROLE_HEADER_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtSECURITY_ROLE_HEADER_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtSECURITY_ROLE_HEADER_CODE.Style.Add("position", "absolute")
                        txtSECURITY_ROLE_HEADER_CODE.Width = txtWidth
                        autonum += 1
                        imgbtnSECURITY_ROLE_HEADER_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnSECURITY_ROLE_HEADER_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnSECURITY_ROLE_HEADER_CODE.Style.Add("position", "absolute")
                    End If
                End If
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "TABLE_PROFILE_CODE" Then
                    If Session("action_edit") = "value" Then
                        ...
                        txtTABLE_PROFILE_CODE.Visible = False
                        ...
                        imgbtnTABLE_PROFILE_CODE2.Visible = True
                        imgbtnTABLE_PROFILE_CODE.Visible = False
                        imgbtnTABLE_PROFILE_CODE2.Style.Add("left", mySetting.GetObjPositionRL(EctWidth, 6, "X"))
                        imgbtnTABLE_PROFILE_CODE2.Style.Add("top", mySetting.GetObjPositionRL(6, autonum2, "Y"))
                        imgbtnTABLE_PROFILE_CODE2.Style.Add("position", "absolute")
                        autonum += 44
                    Else
                        If lblTABLE_PROFILE_CODE.Visible = True Then
                            autonum += 1
                            imgTABLE_PROFILE_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgTABLE_PROFILE_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgTABLE_PROFILE_CODE.Style.Add("position", "absolute")
                            ...
                            lblTABLE_PROFILE_CODE.Style.Add("position", "absolute")
                            autonum += 1
                            txtTABLE_PROFILE_CODE.Visible = True
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OPTION_FULL_ACCESS" Then
                    If lblOPTION_FULL_ACCESS.Visible = True And ddlOPTION_FULL_ACCESS.Visible = True Then
                        autonum += 1
                        imgOPTION_FULL_ACCESS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgOPTION_FULL_ACCESS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgOPTION_FULL_ACCESS.Style.Add("position", "absolute")
                        autonum += 1
                        lblOPTION_FULL_ACCESS.CssClass = "wordstyle12"
                        lblOPTION_FULL_ACCESS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOPTION_FULL_ACCESS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOPTION_FULL_ACCESS.Style.Add("position", "absolute")
                        autonum += 1
                        ddlOPTION_FULL_ACCESS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        ddlOPTION_FULL_ACCESS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        ddlOPTION_FULL_ACCESS.Style.Add("position", "absolute")
                        ddlOPTION_FULL_ACCESS.Width = ddlWidth
                        autonum += 1
                        imgbtnOPTION_FULL_ACCESS.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnOPTION_FULL_ACCESS.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnOPTION_FULL_ACCESS.Style.Add("position", "absolute")
                    End If
                End If
                    ...
                    For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                        Select Case myDS.Tables(0).Rows(i).Item(1).ToString
                            ...
                            Case Else 'character & lookup
                                ...
                                If UCase(Trim(myDS.Tables(0).Rows(i).Item(0))) = "TABLE_PROFILE_CODE" Then
                                    txtTABLE_PROFILE_CODE.Text = lstright.Items(k).Value
                                End If
