...
Partial Class Pages_Organisation_Job_Grade_Profile
...
#Region "Page Setting"
    ...
    Sub BindGrid()
        ...
        Try
            ...
            Else
                ssql = "Exec sp_sa_GetTableRecordsWithSecurity '" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & Session("Module").ToString & "','" & "Job_Grade_Profile_Vw" & "','" & myGridView.PageSize & "','" & Session("currentpage") & "'"
                ssql1 = "exec sp_sa_compareTableRecords '" & Session("Company") & "','" & Session("EmpID") & "','" & Session("Module") & "','" & "Job_Grade_Profile_Vw" & "','" & myGridView.PageSize & "','" & Session("currentpage") & "'"
            End If
...
#Region "Sub & Function"
    ...
    Private Function ValidateDelete() As Boolean
        ...
        ssql = "Select dbo.fn_GetOCPIDByCodeName('" & Trim(FieldValue) & "','" & "JOB_GRADE" & "')"
        myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
        If Trim(myDS.Tables(0).Rows(0).Item(0).ToString) <> "" Then
