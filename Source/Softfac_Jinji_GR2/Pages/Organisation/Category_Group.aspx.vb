...
Partial Class Pages_Organisation_Category_Group
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        mySetting.GetImgBtnUrl(imgBtnOCP_ID_GROUP_BY_VALUE2, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
        ...
        'lookup field seting
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID_CATEGORY_GROUP" & """," & """" & """," & """" & Session("EmpID").ToString & """"
        mySetting.GetLookupValue_ImageButton(imgBtnOCP_ID_CATEGORY_GROUP, Form.ID, "txtOCP_ID_CATEGORY_GROUP", "CodeName", ssql)
...
#Region "Panel Edit"
    ...
    Protected Sub imgBtnOCP_ID_Group_By_Value_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_Group_By_Value.Click

        If ActionValidateFieldEmployee() = False Then
            lblresult2.Text = lblOCP_ID_Category_Group.Text & " field is required..."
            Exit Sub
        End If
        If ActionValidateFieldGroupBy() = False Then
            lblresult2.Text = lblOption_Group_By.Text & " field is required..."
            Exit Sub
        End If
        visibleLst()
        lstleft.Items.Clear()
        lstright.Items.Clear()
        txtOCP_ID_Group_By_Value.Text = ""
    ...
    Protected Sub imgBtnOCP_ID_Group_By_Value2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnOCP_ID_GROUP_BY_VALUE2.Click

        lstleft.Items.Clear()
        lstright.Items.Clear()
        ssql = "Exec sp_sa_getListBoxValue 'getGroupByValue2','" & Session("Company") & "','" & ddlOPTION_GROUP_BY.SelectedValue & "','" & txtOCP_ID_CATEGORY_GROUP.Text & "','','','',''"
        myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
        If myDS.Tables(0).Rows.Count > 0 Then
...
#Region "Sub & Function"
    ...
    Private Function ActionValidateFieldEmployee() As Boolean
        If txtOCP_ID_Category_Group.Text <> "" Then
            Return True
        Else
            Return False
        End If
    ...
    Private Function ActionValidateFieldGroupBy() As Boolean
        If ddlOption_Group_By.SelectedValue <> "" Then
            Return True
        Else
            Return False
        End If
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        imgBtnOCP_ID_Group_By_Value2.Visible = False
        imgBtnOCP_ID_Group_By_Value.Visible = True
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OCP_ID_CATEGORY_GROUP" Then
                    If lblOCP_ID_Category_Group.Visible = True And txtOCP_ID_Category_Group.Visible = True Then
                        autonum += 1
                        imgOCP_ID_CATEGORY_GROUP.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgOCP_ID_CATEGORY_GROUP.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgOCP_ID_CATEGORY_GROUP.Style.Add("position", "absolute")
                        autonum += 1
                        lblOCP_ID_CATEGORY_GROUP.CssClass = "wordstyle12"
                        lblOCP_ID_CATEGORY_GROUP.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOCP_ID_CATEGORY_GROUP.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOCP_ID_CATEGORY_GROUP.Style.Add("position", "absolute")
                        autonum += 1
                        txtOCP_ID_CATEGORY_GROUP.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtOCP_ID_CATEGORY_GROUP.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtOCP_ID_CATEGORY_GROUP.Style.Add("position", "absolute")
                        txtOCP_ID_CATEGORY_GROUP.Width = txtWidth
                        autonum += 1
                        imgBtnOCP_ID_CATEGORY_GROUP.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgBtnOCP_ID_CATEGORY_GROUP.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgBtnOCP_ID_CATEGORY_GROUP.Style.Add("position", "absolute")
                    End If
                End If

                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OPTION_GROUP_BY" Then
                    If lblOption_Group_By.Visible = True And ddlOption_Group_By.Visible = True Then
                        autonum += 1
                        imgOPTION_GROUP_BY.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgOPTION_GROUP_BY.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgOPTION_GROUP_BY.Style.Add("position", "absolute")
                        autonum += 1
                        lblOPTION_GROUP_BY.CssClass = "wordstyle12"
                        lblOPTION_GROUP_BY.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOPTION_GROUP_BY.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOPTION_GROUP_BY.Style.Add("position", "absolute")
                        autonum += 1
                        ddlOPTION_GROUP_BY.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        ddlOPTION_GROUP_BY.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        ddlOPTION_GROUP_BY.Style.Add("position", "absolute")
                        ddlOPTION_GROUP_BY.Width = ddlWidth
                        autonum += 1
                        imgBtnOPTION_GROUP_BY.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgBtnOPTION_GROUP_BY.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgBtnOPTION_GROUP_BY.Style.Add("position", "absolute")
                    End If
                End If

                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OCP_ID_GROUP_BY_VALUE" Then
                    If Session("action_edit") = "value" Then
                        ...
                        imgOCP_ID_GROUP_BY_VALUE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgOCP_ID_GROUP_BY_VALUE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgOCP_ID_GROUP_BY_VALUE.Style.Add("position", "absolute")
                        autonum += 1
                        lblOCP_ID_GROUP_BY_VALUE.CssClass = "wordstyle12"
                        lblOCP_ID_GROUP_BY_VALUE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOCP_ID_GROUP_BY_VALUE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOCP_ID_GROUP_BY_VALUE.Style.Add("position", "absolute")
                        autonum += 1

                        txtOCP_ID_GROUP_BY_VALUE.Visible = False
                        ...
                        imgBtnOCP_ID_GROUP_BY_VALUE2.Visible = True
                        imgBtnOCP_ID_GROUP_BY_VALUE.Visible = False
                        imgBtnOCP_ID_GROUP_BY_VALUE2.Style.Add("left", mySetting.GetObjPositionRL(EctWidth, 6, "X"))
                        imgBtnOCP_ID_GROUP_BY_VALUE2.Style.Add("top", mySetting.GetObjPositionRL(6, autonum2, "Y"))
                        imgBtnOCP_ID_GROUP_BY_VALUE2.Style.Add("position", "absolute")
                        autonum += 44
                    Else
                        If lblOCP_ID_Group_By_Value.Visible = True Then
                            autonum += 1
                            imgOCP_ID_GROUP_BY_VALUE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgOCP_ID_GROUP_BY_VALUE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgOCP_ID_GROUP_BY_VALUE.Style.Add("position", "absolute")
                            ...
                            lblOCP_ID_GROUP_BY_VALUE.Style.Add("position", "absolute")
                            autonum += 1
                            txtOCP_ID_GROUP_BY_VALUE.Visible = True
                            txtOCP_ID_GROUP_BY_VALUE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            txtOCP_ID_GROUP_BY_VALUE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            txtOCP_ID_GROUP_BY_VALUE.Style.Add("position", "absolute")
                            txtOCP_ID_GROUP_BY_VALUE.Width = txtWidth
                            autonum += 1
                            imgBtnOCP_ID_GROUP_BY_VALUE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgBtnOCP_ID_GROUP_BY_VALUE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgBtnOCP_ID_GROUP_BY_VALUE.Style.Add("position", "absolute")
                        End If
                    End If
                End If
