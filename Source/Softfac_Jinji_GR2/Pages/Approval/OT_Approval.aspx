<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OT_Approval.aspx.vb" Inherits="Pages_Approval_OT_Approval" %>
					    ...
					    <td>
					        ...
					        <table id="Table6" cellspacing="0" cellpadding="0" border="0" runat="server">
					            ...
					            <tr>
					                ...
					                <td>
					                    <asp:LinkButton id="lnkBtnViewPerOT" runat="server" CssClass="wordstyle" Text="[ Pre OT Approval (Pending) ]" Enabled="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnClosePerOT" runat="server" CssClass="wordstyle11" Text="[ Pre OT Approval (Pending) ]" Visible="false" ></asp:LinkButton>
					                </td>
					                <td><asp:Image ID="imgBlank05" Width="5px" Height="25px" runat="server" /></td>
					                <td>
					                    <asp:LinkButton id="lnkBtnViewAppPerOT" runat="server" CssClass="wordstyle" Text="[ Pre OT Approved ]" Enabled="false" ></asp:LinkButton>
					                ...
					                <td>
					                    <asp:LinkButton id="lnkBtnViewOTDone" runat="server" CssClass="wordstyle" Text="[ OT Approval (Discrepancy) ]" Enabled="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseOTDone" runat="server" CssClass="wordstyle11" Text="[ OT Approval (Discrepancy) ]" Visible="false" ></asp:LinkButton>
					                </td>
					                <td><asp:Image ID="imgBlank02" Width="5px" Height="25px" runat="server" /></td>
					                <td>
					                    <asp:LinkButton id="lnkBtnViewOT" runat="server" CssClass="wordstyle" Text="[ No Pre OT Approval (Pending) ]" Enabled="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseOT" runat="server" CssClass="wordstyle11" Text="[ No Pre OT Approval (Pending) ]" Visible="false" ></asp:LinkButton>
					                </td>
					                <td><asp:Image ID="imgBlank03" Width="5px" Height="25px" runat="server" /></td>
					                <td>
					                    <asp:LinkButton id="lnkBtnViewAppOT" runat="server" CssClass="wordstyle" Text="[ Approved OT ]" Enabled="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseAppOT" runat="server" CssClass="wordstyle11" Text="[ Approved OT ]" Visible="false" ></asp:LinkButton>
					                </td>
					            </tr>
					        </table>
					    </td> 
								        ...
								        <td>
									        <asp:panel id="pnlprevnext1" runat="server" visible="true">
								                ...
								                <table id="Table11" cellspacing="0" cellpadding="0" border="0" runat="server">
				                                   <tr>
				                                       <td style="height:5px"><asp:CheckBox ID="chkAAll" AutoPostBack="true" Width="120px" BorderStyle="None" CssClass="wordstyle" Runat="server" visible=false/></td>
				                                       <td style="height:5px"><asp:CheckBox ID="chkRAll" AutoPostBack="true" Width="120px" BorderStyle="None" CssClass="wordstyle" Runat="server" visible=false/></td>
				                                   </tr>
				                                </table>
									        </asp:panel>
								        </td>
