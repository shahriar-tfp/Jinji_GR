...
#Region "Private Declaration"
    ...
    Dim EmpID As String, month As String, year As String
...
#End Region
    ...
    Private Sub PagePreload()
        EmpID = Request("EmployeeID").ToString
        month = Request("Month").ToString
        year = Request("Year").ToString
        Session("Company") = Request("CompanyID").ToString
        ...
        ssql = "Exec sp_ts_SelTimeSheet 'EMPLOYEE','" & Session("Company").ToString & "','" & EmpID & "'"
        ...
        txtUser_Profile_code.Enabled = False
