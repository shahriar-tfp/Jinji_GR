...
Partial Class Pages_Approval_User_Approval
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "MODULE_PROFILE_CODE" & """," & """" & """," & """" & Session("EmpID").ToString & """"
        mySetting.GetLookupValue_ImageButton(imgBtnMODULE_PROFILE_CODE, Form.ID, "txtMODULE_PROFILE_CODE", "CodeName", ssql)
...
#Region "Panel Edit"
    ...
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        ssql1 = "select dbo.fn_ReturnCompanyProfileCode('" & txtCOMPANY_PROFILE_CODE.Text & "'),dbo.fn_ReturnModuleProfileCodeByCodeName('" & txtMODULE_PROFILE_CODE.Text & "'),dbo.fn_GetUserProfileCode('" & txtUSER_PROFILE_CODE.Text & "')"
        myDS = mySQL.ExecuteSQL(ssql1)
        If myDS.Tables(0).Rows.Count > 0 Then
            ssql = "Delete from " & Form.ID & " Where Company_profile_Code='" & myDS.Tables(0).Rows(0).Item(0).ToString & "' and MODULE_PROFILE_CODE='" & myDS.Tables(0).Rows(0).Item(1).ToString & "' and USER_PROFILE_CODE='" & myDS.Tables(0).Rows(0).Item(2).ToString & "' AND APPROVAL_LEVEL = '" & txtAPPROVAL_LEVEL.Text & "'"
    ...
    Protected Sub imgBtnEMPLOYEE_PROFILE_ID_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnEMPLOYEE_PROFILE_ID.Click
        ...
        If Session("action") <> "filter" Then
            If ActionValidateFieldCompany() = False Then
                ...
                Exit Sub
            End If
            If ActionValidateFieldModuleProfile() = False Then
                lblresult2.Text = lblMODULE_PROFILE_CODE.Text & " field is required..."
                Exit Sub
            End If
            If ActionValidateFieldApprovalLevel() = False Then
                lblresult2.Text = lblAPPROVAL_LEVEL.Text & " field is required..."
                Exit Sub
            End If
    ...
    Protected Sub imgbtnEMPLOYEE_PROFILE_ID2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnEMPLOYEE_PROFILE_ID2.Click
        lstleft.Items.Clear()
        lstright.Items.Clear()
        ssql = "Exec sp_sa_getListBoxValue 'getGroupByOCP','" & Session("Company") & "','" & ddlOPTION_TYPE.SelectedValue & "','" & ddlOCP_ID.SelectedValue & "','" & txtMODULE_PROFILE_CODE.Text & "','" & txtAPPROVAL_LEVEL.Text & "','" & txtUSER_PROFILE_CODE.Text & "',''"
        myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
        If myDS.Tables(0).Rows.Count > 0 Then
...
#Region "Sub & Function"
    ...
    Private Function ActionValidateFieldModuleProfile() As Boolean
        If txtMODULE_PROFILE_CODE.Text <> "" Then
            Return True
        Else
            Return False
        End If
    ...
    Private Function ActionValidateFieldApprovalLevel() As Boolean
        If txtAPPROVAL_LEVEL.Text <> "" Then
            Return True
        Else
            Return False
        End If
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "MODULE_PROFILE_CODE" Then
                    If lblMODULE_PROFILE_CODE.Visible = True And txtMODULE_PROFILE_CODE.Visible = True Then
                        autonum += 1
                        imgMODULE_PROFILE_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgMODULE_PROFILE_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgMODULE_PROFILE_CODE.Style.Add("position", "absolute")
                        autonum += 1
                        lblMODULE_PROFILE_CODE.CssClass = "wordstyle12"
                        lblMODULE_PROFILE_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblMODULE_PROFILE_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblMODULE_PROFILE_CODE.Style.Add("position", "absolute")
                        autonum += 1
                        txtMODULE_PROFILE_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtMODULE_PROFILE_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtMODULE_PROFILE_CODE.Style.Add("position", "absolute")
                        txtMODULE_PROFILE_CODE.Width = txtWidth
                        autonum += 1
                        imgBtnMODULE_PROFILE_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgBtnMODULE_PROFILE_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgBtnMODULE_PROFILE_CODE.Style.Add("position", "absolute")
                    End If
                End If

                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "APPROVAL_LEVEL" Then
                    If lblAPPROVAL_LEVEL.Visible = True And txtAPPROVAL_LEVEL.Visible = True Then
                        autonum += 1
                        imgAPPROVAL_LEVEL.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgAPPROVAL_LEVEL.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgAPPROVAL_LEVEL.Style.Add("position", "absolute")
                        autonum += 1
                        lblAPPROVAL_LEVEL.CssClass = "wordstyle12"
                        lblAPPROVAL_LEVEL.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblAPPROVAL_LEVEL.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblAPPROVAL_LEVEL.Style.Add("position", "absolute")
                        autonum += 1
                        txtAPPROVAL_LEVEL.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtAPPROVAL_LEVEL.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtAPPROVAL_LEVEL.Style.Add("position", "absolute")
                        txtAPPROVAL_LEVEL.Width = txtWidth
                        autonum += 1
                        imgBtnAPPROVAL_LEVEL.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgBtnAPPROVAL_LEVEL.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgBtnAPPROVAL_LEVEL.Style.Add("position", "absolute")
                    End If
                End If
    ...
    Private Function ValidateInsertUpdate() As Boolean
        ...
        Try
            ...
            For Me.k = 0 To itemCount - 1
                ssql1 = "select dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text.Replace("'", "''") & "'),dbo.fn_GetCode_Module_Profile_Vw(N'" & txtMODULE_PROFILE_CODE.Text & "'),isnull(dbo.fn_GetCode_User_Profile_Vw(N'" & txtUSER_PROFILE_CODE.Text.Replace("'", "''") & "'),''),ISNULL(dbo.fn_ReturnEmpID(N'" & lstright.Items(k).Value.Replace("'", "''") & "'),'')"
