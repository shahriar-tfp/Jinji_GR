<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Medical_Approval.aspx.vb" Inherits="Pages_Approval_Medical_Approval" %>
...
<body id="body" runat="server">
    <form id="Medical_Approval" runat="server">
    <div>
					    ...
					    <td>
					        ...
					        <table id="Table6" cellspacing="0" cellpadding="0" border="0" runat="server">
					            ...
					            <tr>
					                ...
					                <td>
					                    <asp:LinkButton id="lnkBtnViewPending" runat="server" CssClass="wordstyle" Text="[ Pending Claim ]" Enabled="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnClosePending" runat="server" CssClass="wordstyle11" Text="[ Pending Claim ]" Visible="false" ></asp:LinkButton>
					                </td>
					                <td><asp:Image ID="imgBlank03" Width="10px" Height="25px" runat="server" /></td>
					                <td>
					                    <asp:LinkButton id="lnkBtnViewApproved" runat="server" CssClass="wordstyle" Text="[ Approved Claim ]" Enabled="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseApproved" runat="server" CssClass="wordstyle11" Text="[ Approved Claim ]" Visible="false" ></asp:LinkButton>
					                </td>
					                <td><asp:Image ID="imgBlank04" Width="10px" Height="25px" runat="server" /></td>
					                <td>
					                    <asp:LinkButton id="lnkBtnViewReject" runat="server" CssClass="wordstyle" Text="[ Reject Claim ]" Enabled="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseReject" runat="server" CssClass="wordstyle11" Text="[ Reject Claim ]" Visible="false" ></asp:LinkButton>
					                </td>
					                <td><asp:Image ID="imgBlank05" Width="10px" Height="25px" runat="server" /></td>
					                <td>
					                    <asp:LinkButton id="lnkBtnViewBalance" runat="server" CssClass="wordstyle" Text="[ Claim Balance ]" visible="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseBalance" runat="server" CssClass="wordstyle11" Text="[ Claim Balance ]" Visible="false" ></asp:LinkButton>
					                </td>
					            </tr>
					        </table>
					    </td> 
