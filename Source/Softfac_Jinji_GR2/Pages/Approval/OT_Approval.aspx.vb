...
Partial Class Pages_Approval_OT_Approval
...
#Region "Sub & Function"
    ...
    Public Sub SubLoadSSQL(ByVal Status As String, ByVal vtype As String)
        ...
        ssql = "Exec sp_tms_OTApproval '" & Session("Company") & "','%','%','" & "19000101000000" & "','" & _
               "19000101000000" & "','" & Session("EmpID") & "','','" & Status & "','" & vtype & "','" & "SearchType" & "','" & myGridView1.PageSize & "','" & Session("currentPage1") & "'"
    ...
    Public Sub SearchDetail(ByVal SelType As String)
        ...
        If SelType = "PREOTPENDING" Or SelType = "NOPREOTDONE" Then
            status = "PENDING"
        Else
            status = "APPROVED"
        End If
        ...
        If mySetting.CheckTextNull(txtADateFrom.Text) = False Then
            ssql = "Select dbo.fn_DateAdd('Day',-3,'" & Session("CurrentDate") & "')"
            myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
            If myDS.Tables(0).Rows.Count > 0 Then
        ...
        For Me.i = 0 To myGridView1.Rows.Count - 1
            ...
            If chkCursor.Checked = True Then
                ...
                ssql = "Exec sp_tms_updOTApproval '" & Session("Company") & "','" _
                       ...
                       & POH & "','" & "00:00" & "','" & Session("EmpID") & "','" & "" & "','" & "APPROVED" & "'"
                myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
            End If
        Next
...
#Region "Sub & Function 2"
    ...
    Private Function CheckForAGv1() As Integer
        ...
        Try
            For Each Me.grdItem In myGridView1.Rows
