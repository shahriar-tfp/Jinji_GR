...
Partial Class Pages_Application_Development_Designer_Rollback_ADD_Trans
...
#Region "Panel Edit"
    ...
    Protected Sub imgBtnUpdate_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpdate.Click
        If ValidateUpdate() Then
            If ddlOPTION_STATUS.SelectedValue = "ACTIVE" Then
                ssql = "Update Explorer_Profile Set Option_Show='YES' Where Code='" & txtPAGE_PROFILE_CODE.Text.ToString & "'; Update ADD_Page_Profile Set Option_Status='ACTIVE' Where Page_Profile_Code='" & txtPAGE_PROFILE_CODE.Text.ToString & "'"
            ElseIf ddlOPTION_STATUS.SelectedValue = "DISABLED" Then
                ssql = "Update Explorer_Profile Set Option_Show='NO' Where Code='" & txtPAGE_PROFILE_CODE.Text.ToString & "'; Update ADD_Page_Profile Set Option_Status='DISABLED' Where Page_Profile_Code='" & txtPAGE_PROFILE_CODE.Text.ToString & "'"
            ElseIf ddlOPTION_STATUS.SelectedValue = "DELETE" Then
                If File.Exists(System.AppDomain.CurrentDomain.BaseDirectory & "Pages\" & txtMODULE_PROFILE_CODE.Text.ToString & "\" & txtPAGE_PROFILE_CODE.Text.ToString & ".aspx") Then
                    File.Delete(System.AppDomain.CurrentDomain.BaseDirectory & "Pages\" & txtMODULE_PROFILE_CODE.Text.ToString & "\" & txtPAGE_PROFILE_CODE.Text.ToString & ".aspx")
                End If
                If File.Exists(System.AppDomain.CurrentDomain.BaseDirectory & "Pages\" & txtMODULE_PROFILE_CODE.Text.ToString & "\" & txtPAGE_PROFILE_CODE.Text.ToString & ".aspx.vb") Then
                    File.Delete(System.AppDomain.CurrentDomain.BaseDirectory & "Pages\" & txtMODULE_PROFILE_CODE.Text.ToString & "\" & txtPAGE_PROFILE_CODE.Text.ToString & ".aspx.vb")
                End If

                'Delete Report File
                If File.Exists(System.AppDomain.CurrentDomain.BaseDirectory & "Reports\_Definitions\_Reports\" & Session("Company").ToString & ".Standard." & txtMODULE_PROFILE_CODE.Text.ToString & "." & txtPAGE_PROFILE_CODE.Text.ToString & ".lgx") Then
                    File.Delete(System.AppDomain.CurrentDomain.BaseDirectory & "Reports\_Definitions\_Reports\" & Session("Company").ToString & ".Standard." & txtMODULE_PROFILE_CODE.Text.ToString & "." & txtPAGE_PROFILE_CODE.Text.ToString & ".lgx")
                End If

                If Directory.Exists(System.AppDomain.CurrentDomain.BaseDirectory & "Pages\" & txtMODULE_PROFILE_CODE.Text.ToString) Then
                    Dim intCountReport As Integer = 0
                    'Delete Report Folder If No More Sub Reports
                    Dim strReportPath As String = System.AppDomain.CurrentDomain.BaseDirectory & "Pages\" & txtMODULE_PROFILE_CODE.Text.ToString
                    For Each strFile As String In Directory.GetFiles(strReportPath)
                        If Right(strFile, 5).ToString.ToLower = ".aspx" Then
                            intCountReport += 1
                        End If
                        'Dim strNewFileName As String
                        'strNewFileName = Mid(strFile, CInt(strFile.LastIndexOf("\")) + 2, Len(strFile))
                    Next
                    If intCountReport = 0 Then
                        If Directory.Exists(System.AppDomain.CurrentDomain.BaseDirectory & "Pages\" & txtMODULE_PROFILE_CODE.Text.ToString) Then
                            Directory.Delete(System.AppDomain.CurrentDomain.BaseDirectory & "Pages\" & txtMODULE_PROFILE_CODE.Text.ToString)
                        End If
                        If File.Exists(System.AppDomain.CurrentDomain.BaseDirectory & "Reports\_Definitions\_Reports\" & Session("Company").ToString & ".Standard." & txtMODULE_PROFILE_CODE.Text.ToString & ".fld") Then
                            File.Delete(System.AppDomain.CurrentDomain.BaseDirectory & "Reports\_Definitions\_Reports\" & Session("Company").ToString & ".Standard." & txtMODULE_PROFILE_CODE.Text.ToString & ".fld")
                        End If
                    End If
                End If

                ssql = "Exec sp_sa_ADD_RollbackTrans '" & Session("Company").ToString & "','" & txtMODULE_PROFILE_CODE.Text.ToString & _
                        "','" & Session("EmpID").ToString & "','" & txtPAGE_PROFILE_CODE.Text.ToString & "'"
            End If
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnAdd.Click
        ...
        'lblresult2.CssClass = labelPosition1 & autonum
...
#Region "Sub & Function"
    ...
    Private Function ValidateInsert() As Boolean
        lblresult2.Visible = True
        myDS = New DataSet
        myDS = mySQL.ExecuteSQL("Select Code,Option_Data_Type,Option_Editable,Option_Mandatory,Option_Default_Value,Name,Option_Primary_Key From Table_Field Where Table_Profile_Code='" & Form.ID & "' And Option_View_Card='YES' Order By Table_Profile_Code,Sequence_No", Session("Company").ToString, Session("EmpID").ToString)
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            ...
            DefaultDS = mySQL.ExecuteSQL("SELECT Code,Option_Data_Type,Default_Value_Date,Default_Value_DateTime,Default_Value_Time,Default_Value_Integer,Default_Value_Decimal,Default_Value_Character,Option_Primary_Key FROM Table_Field Where Table_Profile_Code='" & Form.ID & "' AND Option_View_Card='NO' AND Option_Default_Value='YES' ORDER BY Sequence_No", Session("Company").ToString, Session("EmpID").ToString)
        ...
        If Not myDS Is Nothing Then
            If myDS.Tables.Count > 0 Then
                ...
                Else
                    ...
                    ssql = "Exec sp_Generate_Query_Filter_WithSecurity '" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & _
                            Session("Module").ToString & "','" & ssql & "','" & ssql2 & "','" & ssql3 & _
                            "','" & myGridView.PageSize & "','" & "1" & "'"
                    ssql2 = ssql.ToString.Replace("sp_Generate_Query_Filter_WithSecurity", "sp_Compare_query_filter")
                End If
            End If
        End If
        myDS = Nothing
