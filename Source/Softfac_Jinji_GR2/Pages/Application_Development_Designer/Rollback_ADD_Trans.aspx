<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Rollback_ADD_Trans.aspx.vb" Inherits="Pages_Application_Development_Designer_Rollback_ADD_Trans" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Rollback ADD Transaction Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="ADD_PAGE_PROFILE" runat="server">
    <div>
    ...
    <!--// 2 //-->
    <asp:imagebutton id="imgKeyMODULE_PROFILE_CODE" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblMODULE_PROFILE_CODE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtMODULE_PROFILE_CODE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnMODULE_PROFILE_CODE" runat="server" Height="21px"></asp:imagebutton>
    <!--// 3 //-->
    <asp:imagebutton id="imgKeyUSER_PROFILE_CODE" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblUSER_PROFILE_CODE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtUSER_PROFILE_CODE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnUSER_PROFILE_CODE" runat="server" Height="21px"></asp:imagebutton>
    <!--// 4 //-->
    <asp:imagebutton id="imgKeyPAGE_PROFILE_CODE" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblPAGE_PROFILE_CODE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtPAGE_PROFILE_CODE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnPAGE_PROFILE_CODE" runat="server" Height="21px"></asp:imagebutton>
    <!--// 5 //-->
    ...
    <asp:imagebutton id="imgbtnOPTION_STATUS" runat="server" Height="21px"></asp:imagebutton>
      <!--// 6 //-->
    <asp:imagebutton id="imgKeyDATETIME_CREATED" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblDATETIME_CREATED" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtDATETIME_CREATED" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnDATETIME_CREATED" runat="server" Height="21px"></asp:imagebutton>
					...
					<tr>
						...
						<table id="Table6" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
                                <tr>
                                    ...
                                    <td style="background-image:url(../../Images/Default/gif/org_title_bar20.gif); vertical-align:bottom"><asp:Label ID="lblTitle" runat="server"></asp:Label></td>
                                </tr>
                            </table>
							<table id="tblGridView" cellspacing="0" cellpadding="0" width="100%" border="0" runat="server">
								<tr>
									<td>
										<asp:panel id="pnlGridview" runat="server" visible="true" ScrollBars="None">
