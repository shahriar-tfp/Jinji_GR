...
Partial Class Pages_Roster_Employee_Shift
    ...
    Private Sub PagePreload()
        Try
            ...
            ssql = "Select Code,Name From Table_Field Where Table_Profile_Code='" & Form.ID & _
                    "' And Code In ('EMPLOYEE_PROFILE_ID','OCP_ID_SHIFT') Order By Sequence_No"
            myDS = New DataSet
            myDS = mySQL.ExecuteSQL(ssql)
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnSubmit.Click
        Try
            If ValidateInput() Then
                myDS = New DataSet
                ssql = "Exec sp_tms_InsUpdDelCalendar '" & Session("Company").ToString & "','" & Trim(txtFromDate.Text.ToString) & "','" & Trim(txtToDate.Text.ToString) & "','" & txtEMPLOYEE_PROFILE_ID.Text.ToString.Replace("'", "''") & "','" & txtOCP_ID_SHIFT.Text.ToString.Trim & "','','','','" & Form.ID.ToString & "'"
