...
Partial Class Pages_Roster_Calendar_TMS_Grouping
    ...
    Sub BindGrid()
        Try
            ...
            Else
                ...
                Else
                    ssql = "Exec sp_sa_GetTableRecordsWithSecurity '" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & Session("Module").ToString & "','Calendar_TMS_Grouping_vw','" & myGridView.PageSize & "','" & _currentPageNumber & "'"
                    ssql2 = "Exec sp_sa_CompareTableRecords '" & Session("Company").ToString & "','" & Session("EmpID").ToString & "','" & Session("Module").ToString & "','Calendar_TMS_Grouping_vw','" & gvHistory.PageSize & "','" & _currentPageNumber & "'"
                End If
            End If
