...
Partial Class PAGES_INFORMATION_SYSTEM_IMPORT_TMS_ROSTER
    ...
    Protected Sub imgBtnUpload_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpload.Click
        If Not (txtFileName.PostedFile Is Nothing) Then
            Try
                ...
                Dim myData As New OleDbDataAdapter("SELECT * FROM [TMS_ROSTER$]", strConn)
    ...
    Protected Sub imgBtnUpdateImport_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpdateImport.Click
        Try
            If GVUpload.Rows.Count > 0 Then
                ssql = "delete from Import_Tms_Roster"
                mySQL.ExecuteSQL(ssql)
                ssql = Nothing
                For Me.i = 0 To GVUpload.Rows.Count - 1

                    ssql = "insert into Import_Tms_Roster"
                    ssql = ssql & " Select N'" & GVUpload.Rows(i).Cells(1).Text.Trim.ToUpper & "',"
                    ssql = ssql & "N'" & GVUpload.Rows(i).Cells(2).Text.Trim.ToUpper & "',"
                    ...
                    ssql1 = Nothing
                Next
                ssql = "exec SP_Tms_ImportTMSRoster"
                'mySQL.ExecuteSQL(ssql)
                ssql = Nothing
            End If
            'GVUpload.DataBind()
