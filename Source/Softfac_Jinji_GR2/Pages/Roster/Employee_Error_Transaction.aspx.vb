...
Partial Class Pages_Roster_Employee_Error_Transaction
        ...
        Try
            ...
            Else
                If SearchByPage = True Then
                    ssql = "Exec sp_tms_SelAttendance N'" & Session("Company").ToString & "',N'',N'','" & Session("EmpID").ToString & "','" & myGridView.PageSize & "','" & txtGoToPage.Text & "'"
                    ssql2 = "Exec sp_tms_SelAttendance N'" & Session("Company").ToString & "',N'',N'','" & Session("EmpID").ToString & "','" & myGridView.PageSize & "','" & txtGoToPage.Text & "'"
                ...
                Else
                    ssql = "Exec sp_tms_SelAttendance N'" & Session("Company").ToString & "',N'',N'',N'',N'',N'','" & Session("EmpID").ToString & "','" & myGridView.PageSize & "','" & _currentPageNumber & "'"
                    ssql2 = "Exec sp_tms_SelAttendance N'" & Session("Company").ToString & "',N'',N'',N'',N'',N'','" & Session("EmpID").ToString & "','" & myGridView.PageSize & "','" & _currentPageNumber & "'"
                End If
            End If
...
#Region "Panel Edit"
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        ...
        If ValidateInsert() = True Then
            myDS = New DataSet
            Dim sql As String = ""
            'sql = "Exec sp_tms_delattendance '" & Session("Company").ToString & "','" & _
            '        GetStoredProcParameter("EMPLOYEE_PROFILE_ID") & "','" & _
            '        Left(GetStoredProcParameter("DATE_TIME_IN"), 8) & "000000" & "','" & _
            '        Right(GetStoredProcParameter("DATE_TIME_IN"), 6) & "','" & _
            '        Left(GetStoredProcParameter("DATE_TIME_OUT"), 8) & "000000" & "','" & _
            '        Right(GetStoredProcParameter("DATE_TIME_OUT"), 6) & "','" & Session("EmpID").ToString & "'"
            'Exec sp_tms_calEmpOTLate 'SFR&D-001 [LS CHEW]','NORMAL [Normal Shift]','20060920000000','083000','20060920000000','173000','',1,'',0
            sql = "Exec sp_tms_calEmpOTLate N'" & mySetting.GetEmployeeIDbyCodeName_ReturnString(Session("Company").ToString, GetStoredProcParameter("EMPLOYEE_PROFILE_ID").Replace("'", "''")) & "',N'" & _
                GetStoredProcParameter("OCP_ID_SHIFT") & "','" & Left(GetStoredProcParameter("DATE_TIME_IN"), 8) & "000000" & "','" & _
                Right(GetStoredProcParameter("DATE_TIME_IN"), 6) & "','" & Left(GetStoredProcParameter("DATE_TIME_OUT"), 8) & "000000" & "','" & _
                Right(GetStoredProcParameter("DATE_TIME_OUT"), 6) & "','',1,N'" & GetStoredProcParameter("REASON") & "',0"
            myDS = mySQL.ExecuteSQL(sql, Session("Company").ToString, Session("EmpID").ToString)
            If Not myDS Is Nothing Then
                If myDS.Tables.Count > 0 Then
                    If myDS.Tables(0).Rows.Count > 0 Then
                        Select Case myDS.Tables(0).Rows(0).Item(0).ToString
                            Case "1"
                                lblresult2.Text = "Inter Department Transfer Record Not Found !!"
                            Case "2"
                                lblresult2.Text = "Shift not setup correctly."
                            Case "3"
                                lblresult2.Text = "Calendar not setup correctly."
                            Case "4"
                                lblresult2.Text = "Duplicate Attendance Found"
                        End Select
                        lblresult2.Visible = True
                    Else
                        pnlEdit.Visible = False
        ...
        End If
    End Sub
    Private Function GetParameter(ByVal Key As String, ByVal intRow As Integer) As String
        Dim strOutput As String = ""
        For i As Integer = 0 To myGridView.HeaderRow.Cells.Count - 1
            If myGridView.HeaderRow.Cells(i).Text.ToString.Replace("&amp;", "&").ToUpper = Key.ToUpper Then
                strOutput = myGridView.Rows(intRow).Cells(i).Text.ToString.Replace("&amp;", "&").Replace("&nbsp;", " ")
                Exit For
            End If
        Next
        Return strOutput.Trim
    End Function
    Private Function GetStoredProcParameter(ByVal Key As String) As String
        Dim myDE As DictionaryEntry, strOutput As String = "", RecFound As Boolean = False
        For Each myDE In htb
            If myDE.Key = Key Then
                strOutput = myDE.Value
                If Left(strOutput, 1) <> "'" And Len(strOutput) > 2 Then
                    Dim tempDS As New DataSet
                    tempDS = mySQL.ExecuteSQL("Select " & strOutput)
                    If Not tempDS Is Nothing Then
                        If tempDS.Tables.Count > 0 Then
                            If tempDS.Tables(0).Rows.Count > 0 Then
                                strOutput = tempDS.Tables(0).Rows(0).Item(0).ToString
                            Else
                                strOutput = ""
                            End If
                        Else
                ...
                Else
                    If Not IsNumeric(strOutput) Then
                        strOutput = Mid(strOutput, 2, Len(strOutput) - 2)
                    Else
                        strOutput = strOutput
                    End If
                End If
    ...
    Protected Sub imgBtnSearch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSearch.Click
        If ValidateSearch() = True Then
            Session("SearchSQL") = "Exec sp_tms_SelAttendance N'" & Session("Company").ToString & "',N'" & _
            txtEMPLOYEE_PROFILE_ID.Text.Replace("'", "''") & "',N'" & txtOCP_ID_DEPARTMENT.Text & "',N'" & txtOCP_ID_SHIFT.Text & "',N'" & _
            mySetting.UnDisplayDateTime(txtCLOCK_IN.Text, Session("Company"), Session("Module")) & "',N'" & _
            mySetting.UnDisplayDateTime(txtCLOCK_OUT.Text, Session("Company"), Session("Module")) & "','" & _
            Session("EmpID").ToString & "','" & myGridView.PageSize & "','"

            Session("SearchSQL1") = "Exec sp_tms_SelAttendance N'" & Session("Company").ToString & "',N'" & _
            txtEMPLOYEE_PROFILE_ID.Text.Replace("'", "''") & "',N'" & txtOCP_ID_DEPARTMENT.Text & "',N'" & txtOCP_ID_SHIFT.Text & "',N'" & _
            mySetting.UnDisplayDateTime(txtCLOCK_IN.Text, Session("Company"), Session("Module")) & "',N'" & _
            mySetting.UnDisplayDateTime(txtCLOCK_OUT.Text, Session("Company"), Session("Module")) & "','" & _
            Session("EmpID").ToString & "','" & myGridView.PageSize & "','"
    ...
    Protected Sub imgBtnUpdate_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpdate.Click
        ...
        If ValidateUpdate() Then
            ...
            Dim strEmpID As String = "", strDateTimeIn As String = "", strDateTimeOut As String = ""
            Dim strShift As String = "", strReason As String = ""
            For Each de In CType(Session("HTB"), Hashtable)
                If de.Key.ToString.ToUpper = "EMPLOYEE_PROFILE_ID" Then
                    strEmpID = mySetting.GetEmployeeIDbyCodeName_ReturnString(Session("Company").ToString, de.Value.ToString.Replace("'", "''"))
                    'strEmpID = de.Value.ToString
                End If
                If de.Key.ToString.ToUpper = "CLOCK_IN" Then
                    If de.Value.ToString.Trim <> "" Then
                        strDateTimeIn = mySetting.UnDisplayDateTime(de.Value.ToString, Session("Company").ToString, "ROSTER")
                    End If
                    'strDateTimeIn=de.Value.ToString 
                End If
                If de.Key.ToString.ToUpper = "CLOCK_OUT" Then
                    If de.Value.ToString.Trim <> "" Then
                        strDateTimeOut = mySetting.UnDisplayDateTime(de.Value.ToString, Session("Company").ToString, "ROSTER")
                    End If
                    'strDateTimeOut=de.Value.ToString 
                End If
                If de.Key.ToString.ToUpper = "OCP_ID_SHIFT" Then
                    If de.Value.ToString.Trim <> "" Then
                        strShift = mySetting.GetOCPIDbyCodeName_ReturnString(Session("Company").ToString, de.Value.ToString)
                    End If
                    'strShift=de.Value.ToString 
                End If
                If de.Key.ToString.ToUpper = "REASON" Then
                    strReason = de.Value.ToString
                    'strReason=de.Value.ToString 
                End If
            Next
            ...
            sql = "Exec sp_tms_delattendance '" & Session("Company").ToString & "','" & _
                    strEmpID & "','" & _
                    Left(strDateTimeIn, 8) & "000000" & "','" & _
                    Right(strDateTimeIn, 6) & "','" & _
                    Left(strDateTimeOut, 8) & "000000" & "','" & _
                    Right(strDateTimeOut, 6) & "','','" & Session("EmpID").ToString & "'"
            mySQL.ExecuteSQL(sql, Session("Company").ToString, Session("EmpID").ToString)

            'sql = "Exec sp_tms_calEmpOTLate '" & strEmpID & "','" & _
            '    strShift & "','" & Left(strDateTimeIn, 8) & "000000" & "','" & _
            '    Right(strDateTimeIn, 6) & "','" & Left(strDateTimeOut, 8) & "000000" & "','" & _
            '    Right(strDateTimeOut, 6) & "','',1,'" & strReason & "',0"

            sql = "Exec sp_tms_calEmpOTLate '" & GetStoredProcParameter("EMPLOYEE_PROFILE_ID").Replace("'", "''") & "','" & _
                            GetStoredProcParameter("OCP_ID_SHIFT") & "','" & Left(GetStoredProcParameter("CLOCK_IN"), 8) & "000000" & "','" & _
                            Right(GetStoredProcParameter("CLOCK_IN"), 6) & "','" & Left(GetStoredProcParameter("CLOCK_OUT"), 8) & "000000" & "','" & _
                            Right(GetStoredProcParameter("CLOCK_OUT"), 6) & "','',1,'" & GetStoredProcParameter("REASON") & "',0"
            myDS = mySQL.ExecuteSQL(sql, Session("Company").ToString, Session("EmpID").ToString)
            If Not myDS Is Nothing Then
                If myDS.Tables.Count > 0 Then
                    If myDS.Tables(0).Rows.Count > 0 Then
                        'sql = "Exec sp_tms_calEmpOTLate '" & GetStoredProcParameter("EMPLOYEE_PROFILE_ID") & "','" & _
                        '    GetStoredProcParameter("OCP_ID_SHIFT") & "','" & Left(GetStoredProcParameter("DATE_TIME_IN"), 8) & "000000" & "','" & _
                        '    Right(GetStoredProcParameter("DATE_TIME_IN"), 6) & "','" & Left(GetStoredProcParameter("DATE_TIME_OUT"), 8) & "000000" & "','" & _
                        '    Right(GetStoredProcParameter("DATE_TIME_OUT"), 6) & "','',1,'" & GetStoredProcParameter("REASON") & "',0"
                        'mySQL.ExecuteSQL(ssql)
                        Select Case myDS.Tables(0).Rows(0).Item(0).ToString
                            Case "1"
                                lblresult2.Text = "Inter Department Transfer Record Not Found !!"
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnAdd.Click
        ...
        If CountRecord = 0 Then
            ...
            Dim op As Integer = 3
            Dim dv As Integer = 4
            'ssql = "exec sp_sa_get_fields_default_value '" & Form.ID & "'"
                ...
                If chkEdit.Checked Then
                    ...
                    For Me.j = 0 To myDS.Tables(0).Rows.Count - 1
                        For Me.intColumn = 1 To gvHistory.HeaderRow.Cells.Count - 1
                            If gvHistory.HeaderRow.Cells(intColumn).Text.ToString.ToUpper = myDS.Tables(0).Rows(j).Item(2).ToString.ToUpper Then
                                Select Case myDS.Tables(0).Rows(j).Item(1).ToString.Trim
                                    Case "OPTION"
                                        ...
                                        mySetting.ArrangeDDLSelectedIndex(myDDL, clsGlobalSetting.DDLSelection.SelectedText, Replace(Replace(gvHistory.Rows(i).Cells(intColumn).Text.ToString.Trim, "&nbsp;", " "), "&amp;", "&"))
                                        myDDL = Nothing
                                    Case Else
                                        ...
                                        If gvHistory.Rows(i).Cells(j + 1).Text.Trim = "&nbsp;" Then
                                            myTXT.Text = ""
                                        Else
                                            myTXT.Text = Replace(Replace(gvHistory.Rows(i).Cells(intColumn).Text.ToString.Trim, "&nbsp;", " "), "&amp;", "&")
                                        End If
                                        myTXT = Nothing
                                End Select
                                htb.Add(myDS.Tables(0).Rows(j).Item(0).ToString.Trim, Replace(Replace(gvHistory.Rows(i).Cells(intColumn).Text.ToString.Trim, "&nbsp;", " "), "&amp;", "&"))
                            End If
                        Next
                    Next
                    myDS = Nothing
    ...
    Protected Sub imgBtnDelete_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnDelete.Click
        Dim strParamEmp As String, strParamDate As String
        Dim strEmpID As String = "", strDate As String = ""
        'sp_sa_chkTransactionLockDate
        'sp_tms_DelAttendance

        strParamEmp = RetrieveParameter("EMPLOYEE_PROFILE_ID")
        strParamDate = RetrieveParameter("DATE")
        If ActionValidateDelete() Then
            Dim htb As New Hashtable
            For Me.i = 0 To myGridView.Rows.Count - 1
                Dim chkDelete As CheckBox = myGridView.Rows(i).Cells(0).Controls(1)
                If chkDelete.Checked Then
                    ssql = "Exec sp_sa_chkTransactionLockDate N'" & Session("Company").ToString & "',N'" & Session("EmpID").ToString & "',N'" & myGridView.Rows(i).Cells(3).Text.ToString.Replace("&amp;", "&") & "','1','0'"
                    myDS = mySQL.ExecuteSQL(ssql)
                    If Not myDS Is Nothing Then
                        If myDS.Tables(0).Rows(0).Item(0).ToString.Trim <> "" Then
                            lblresult.Text = "Transaction Failed! The following date already locked !"
                        Else
                            'ssql = "Exec sp_tms_delattendance '" & Session("Company").ToString & "','" & _
                            '        "dbo.fn_ReturnEmpIDByCodeName(N'" & Session("Company").ToString & "',N'" & GetParameter("EMPLOYEE_PROFILE_ID", i) & "')" & "','" & _
                            '        Left(mySetting.UnDisplayDateTime(GetParameter("CLOCK_IN", i), Session("Company").ToString, "ROSTER"), 8) & "000000" & "','" & _
                            '        Right(mySetting.UnDisplayDateTime(GetParameter("CLOCK_IN", i), Session("Company").ToString, "ROSTER"), 6) & "','" & _
                            '        Left(mySetting.UnDisplayDateTime(GetParameter("CLOCK_OUT", i), Session("Company").ToString, "ROSTER"), 8) & "000000" & "','" & _
                            '        Right(mySetting.UnDisplayDateTime(GetParameter("CLOCK_OUT", i), Session("Company").ToString, "ROSTER"), 6) & "','','" & Session("EmpID").ToString & "'"
                            strEmpID = ""
                            strEmpID = mySetting.GetEmployeeIDbyCodeName_ReturnString(Session("Company").ToString, GetParameter("EMPLOYEE_PROFILE_ID", i).Replace("'", "''"))

                            If GetParameter("CLOCK_IN", i) = "" Then
                                ssql = "Exec sp_tms_delattendance N'" & Session("Company").ToString & "',N'" & _
                                    strEmpID & "','" & _
                                    "','','"
                            Else
                                ssql = "Exec sp_tms_delattendance '" & Session("Company").ToString & "',N'" & _
                                    strEmpID & "','" & _
                                    Left(mySetting.UnDisplayDateTime(GetParameter("CLOCK_IN", i), Session("Company").ToString, "ROSTER"), 8) & "000000" & "','" & _
                                    Right(mySetting.UnDisplayDateTime(GetParameter("CLOCK_IN", i), Session("Company").ToString, "ROSTER"), 6) & "','"
                            End If
                            If GetParameter("CLOCK_OUT", i) = "" Then
                                ssql &= "','','','" & Session("EmpID").ToString & "'"
                            Else
                                ssql &= Left(mySetting.UnDisplayDateTime(GetParameter("CLOCK_OUT", i), Session("Company").ToString, "ROSTER"), 8) & "000000" & "','" & _
                                            Right(mySetting.UnDisplayDateTime(GetParameter("CLOCK_OUT", i), Session("Company").ToString, "ROSTER"), 6) & "','','" & Session("EmpID").ToString & "'"
                            End If
                            'mySQL.ExecuteSQL(ssql)
                            htb.Add("ssql" & i.ToString, ssql)
                        End If
                    End If
                    chkDelete.Checked = False
                End If
            Next
            mySQL.ExecuteSQLTransactionByHashtable(htb, "Delete Attendance", Session("Company").ToString, Session("EmpID"))
            BindGrid()
        End If
    End Sub
    Private Function RetrieveParameter(ByVal strCode As String) As String
        Dim ds As New DataSet, strOutput As String = ""
        ds = mySQL.ExecuteSQL("Select Code,Name From Table_Field Where Table_Profile_Code='" & Form.ID & "' Order By Sequence_No")
        If Not ds Is Nothing Then
            For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                If ds.Tables(0).Rows(i).Item(0).ToString.ToUpper = strCode Then
                    strOutput = ds.Tables(0).Rows(i).Item(1).ToString
                End If
            Next
        End If
        Return strOutput
...
#Region "Sub & Function"
                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                If IsNumeric(mySetting.ConvertDateToDecimal(myTextBox.Text, Session("Company").ToString, Session("Module").ToString)) = True Then
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                            ...
                                            htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "'),'0')")
                                        Else
                                            ssql2 = ssql2 & "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "),'0'),"
                                            htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "),'0')")
                                        End If
                                    Else
                                        ssql2 = ssql2 & "'" & mySetting.ConvertDateToDecimal(Trim(myTextBox.Text), Session("Company").ToString, Session("Module").ToString) & "',"
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & mySetting.ConvertDateToDecimal(Trim(myTextBox.Text), Session("Company").ToString, Session("Module").ToString) & "'")
                                    End If
                                ...
                                Else
                                    ...
                                    Else
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & myTextBox.Text & "'")
                                    End If
                                End If
                            Else
                                If myDS.Tables(0).Rows(i).Item(3).ToString = "YES" Then
                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                If IsNumeric(mySetting.UnDisplayDateTime(myTextBox.Text, Session("Company").ToString, Session("Module").ToString)) = True Then
                                    ...
                                    Else
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & mySetting.UnDisplayDateTime(Trim(myTextBox.Text), Session("Company").ToString, Session("Module").ToString) & "'")
                                    End If
                                    myDST = Nothing
                                    If myDS.Tables(0).Rows(i).Item(6).ToString = "YES" Then
                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                If IsNumeric(mySetting.UnDisplayTime(myTextBox.Text.ToString, Session("Company").ToString, Session("Module").ToString)) = True Then
                                    ...
                                    Else
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & mySetting.UnDisplayTime(Trim(myTextBox.Text), Session("Company").ToString, Session("Module").ToString) & "'")
                                    End If
                                    myDST = Nothing
                                    If myDS.Tables(0).Rows(i).Item(6).ToString = "YES" Then
                        ...
                        If myDropdownlist.Visible = True Then
                            If mySetting.CheckTextNull(myDropdownlist.SelectedValue) = True Then
                                If mySetting.ValidateInput(myDropdownlist, myDS.Tables(0).Rows(i).Item(1).ToString) = True Then
                                    ...
                                    htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & Trim(myDropdownlist.SelectedValue) & "'")
                                    If myDS.Tables(0).Rows(i).Item(6).ToString = "YES" Then
                        ...
                        If myTextBox.Visible = True Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                If IsNumeric(myTextBox.Text) = True Then
                                    ...
                                    htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & Trim(myTextBox.Text) & "'")
                                    If myDS.Tables(0).Rows(i).Item(6).ToString = "YES" Then
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                            ...
                                            htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "'),'')")
                                        Else
                                            ...
                                            htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "'),'')")
                                        End If
                                        If myDS.Tables(0).Rows(i).Item(6).ToString = "YES" Then
                                            If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                            ...
                            Select Case DefaultDR(1).ToString
                                Case "DATE"
                                    If DefaultDR("Default_Value_Date").ToString.Trim <> "" Then
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & DefaultDR("Default_Value_Date").ToString.Trim & "'")
                                    ...
                                    Else
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "dbo.fn_GetCurrentDate(GetDate())")
                                        If DefaultDR(8).ToString = "YES" Then
                                ...
                                Case "DATETIME"
                                    If DefaultDR("Default_Value_DateTime").ToString.Trim <> "" Then
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & DefaultDR("Default_Value_DateTime").ToString.Trim & "'")
                                        If DefaultDR(8).ToString = "YES" Then
                                    ...
                                    Else
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "dbo.fn_GetCurrentDateTime(GetDate())")
                                        If DefaultDR(8).ToString = "YES" Then
                                ...
                                Case "TIME"
                                    If DefaultDR("Default_Value_Time").ToString.Trim <> "" Then
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & DefaultDR("Default_Value_Time").ToString.Trim & "'")
                                        If DefaultDR(8).ToString = "YES" Then
                                    ...
                                    Else
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "dbo.fn_GetCurrentTime(GetDate())")
                                        If DefaultDR(8).ToString = "YES" Then
                                ...
                                Case "CHARACTER"
                                    If DefaultDR("Default_Value_Character").ToString.Trim <> "" Then
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & DefaultDR("Default_Value_Character").ToString.Trim & "'")
                                        If DefaultDR(8).ToString = "YES" Then
                                    ...
                                    Else
                                        ssql = ssql & DefaultDR(0).ToString & ","
                                        ssql2 = ssql2 & "'',"
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "''")
                                        If DefaultDR(8).ToString = "YES" Then
                                ...
                                Case "INTEGER"
                                    If DefaultDR("Default_Value_Integer").ToString.Trim <> "" Then
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & DefaultDR("Default_Value_Integer").ToString.Trim & "'")
                                        If DefaultDR(8).ToString = "YES" Then
                                    ...
                                    Else
                                        ssql = ssql & DefaultDR(0).ToString & ","
                                        ssql2 = ssql2 & "'0',"
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'0'")
                                        If DefaultDR(8).ToString = "YES" Then
                                ...
                                Case "DECIMAL"
                                    If DefaultDR("Default_Value_Decimal").ToString.Trim <> "" Then
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & DefaultDR("Default_Value_Decimal").ToString.Trim & "'")
                                        If DefaultDR(8).ToString = "YES" Then
                                    ...
                                    Else
                                        ssql = ssql & DefaultDR(0).ToString & ","
                                        ssql2 = ssql2 & "'0.00',"
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'0.00'")
                                        If DefaultDR(8).ToString = "YES" Then
    ...
    Private Function ValidateUpdate() As Boolean
                        ...
                        If myTextBox.Visible = True Then
                                ...
                                If IsNumeric(mySetting.ConvertDateToDecimal(myTextBox.Text, Session("Company").ToString, Session("Module").ToString)) = True Then
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                            ...
                                            htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & mySetting.ConvertDateToDecimal(myTextBox.Text, Session("Company").ToString, Session("Module").ToString) & "'),'0')")
                                        Else
                                    ...
                                    Else
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & mySetting.ConvertDateToDecimal(myTextBox.Text, Session("Company").ToString, Session("Module").ToString) & "'")
                                    End If
                                    myDST = Nothing
                                Else
                                    lblresult2.Text = "Invalid Selection For " & Trim(myDS.Tables(0).Rows(i).Item(0)) & " !"
                            ...
                            Else
                                ...
                                Else
                                    ...
                                    htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & myTextBox.Text.ToString.Trim & "'")
                                End If
                            End If
                        End If
                        myTextBox = Nothing
                    Case "DATETIME"
                        ...
                        If myTextBox.Visible = True Then
                                ...
                                If IsNumeric(mySetting.UnDisplayDateTime(myTextBox.Text, Session("Company").ToString, Session("Module").ToString)) = True Then
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                            ...
                                            htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & mySetting.UnDisplayDateTime(myTextBox.Text, Session("Company").ToString, Session("Module").ToString) & "'),'0')")
                                        Else
                                            ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "),'0'),"
                                            htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "),'0')")
                                        End If
                                    Else
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & mySetting.UnDisplayDateTime(myTextBox.Text, Session("Company").ToString, Session("Module").ToString) & "'")
                                    End If
                                    myDST = Nothing
                                Else
                                    lblresult2.Text = "Invalid Selection For " & Trim(myDS.Tables(0).Rows(i).Item(0)) & " !"
                            ...
                            Else
                                ...
                                Else
                                    ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "='" & myTextBox.Text.ToString.Trim & "',"
                                    htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & myTextBox.Text.ToString & "'")
                                End If
                            End If
                        End If
                        myTextBox = Nothing
                                ...
                                If IsNumeric(mySetting.UnDisplayTime(myTextBox.Text, Session("Company").ToString, Session("Module").ToString)) = True Then
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                            ...
                                            htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & mySetting.UnDisplayTime(myTextBox.Text, Session("Company").ToString, Session("Module").ToString) & "'),'0')")
                                        Else
                                            ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "),'0'),"
                                            htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "),'0')")
                                        End If
                                    Else
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & mySetting.UnDisplayTime(myTextBox.Text, Session("Company").ToString, Session("Module").ToString) & "'")
                                    End If
                                    myDST = Nothing
                                Else
                                    lblresult2.Text = "Invalid Selection For " & Trim(myDS.Tables(0).Rows(i).Item(0)) & " !"
                        ...
                        If myTextBox.Visible = True Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "EMPLOYEE_PROFILE_ID" Then
                                    ...
                                    If myUpdate.Tables(0).Rows.Count > 0 Then
                                        ...
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(dbo.fn_ReturnEmpIDByCodeName(N'" & Session("Company").ToString & "',N'" & myTextBox.Text.ToString & "'),'')")
                                    Else
                                        ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "='' AND "
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(dbo.fn_ReturnEmpIDByCodeName(N'" & Session("Company").ToString & "',N'" & myTextBox.Text.ToString & "'),'')")
                                    End If
                                    myUpdate = Nothing
                                ...
                                Else
                                    ...
                                    Else
                                        ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(N'" & myTextBox.Text.ToString & "',''),"
                                        htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(N'" & myTextBox.Text.ToString & "','')")
                                    End If
                                    myDST = Nothing
                                End If
                                'Dim myDST As New DataSet
                            ...
                            Else
                                ...
                                Else
                                    ...
                                    htb.Add(myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(N'" & myTextBox.Text.ToString.Trim & "','')")
                                End If
                            End If
                        End If
                        myTextBox = Nothing
                ...
                For Me.i = 0 To myDS2.Tables(0).Rows.Count - 1
                    Select Case myDS2.Tables(0).Rows(i).Item(2).ToString
                            ...
                            If myDropdownlist.Visible = True Then
                                If mySetting.CheckTextNull(myDropdownlist.SelectedValue) = True Then
                                    If mySetting.ValidateInput(myDropdownlist, myDS2.Tables(0).Rows(i).Item(1).ToString) = True Then
                                        ...
                                        htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & myDropdownlist.SelectedValue & "'")
                                    Else
                                    ...
                                    If IsNumeric(mySetting.ConvertDateToDecimal(myTextBox.Text, Session("Company").ToString, Session("Module").ToString)) = True Then
                                        ...
                                        If myDST2.Tables(0).Rows.Count > 0 Then
                                            If myDST2.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                                ...
                                                htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST2.Tables(1).Rows(0).Item(0).ToString & "(N'" & mySetting.ConvertDateToDecimal(myTextBox.Text, Session("Company").ToString, Session("Module").ToString) & "'),'')")
                                            Else
                                                ...
                                                htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST2.Tables(1).Rows(0).Item(0).ToString & "(" & myDST2.Tables(0).Rows(0).Item(1).ToString.Trim & "),'')")
                                            End If
                                        Else
                                            ...
                                            htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & mySetting.ConvertDateToDecimal(myTextBox.Text, Session("Company").ToString, Session("Module").ToString) & "'")
                                        End If
                                        myDST2 = Nothing
                                    Else
                                        lblresult2.Text = "Invalid Selection For " & Trim(myDS2.Tables(0).Rows(i).Item(0)) & " !"
                                    ...
                                    If IsNumeric(mySetting.UnDisplayDateTime(myTextBox.Text, Session("Company").ToString, Session("Module").ToString)) = True Then
                                        ...
                                        If myDST2.Tables(0).Rows.Count > 0 Then
                                            If myDST2.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                                ...
                                                htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST2.Tables(1).Rows(0).Item(0).ToString & "(N'" & mySetting.UnDisplayDateTime(myTextBox.Text, Session("Company").ToString, Session("Module").ToString) & "'),'')")
                                            Else
                                                ssql = ssql & myDS2.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST2.Tables(1).Rows(0).Item(0).ToString & "(" & myDST2.Tables(0).Rows(0).Item(1).ToString.Trim & "),'') And "
                                                htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST2.Tables(1).Rows(0).Item(0).ToString & "(" & myDST2.Tables(0).Rows(0).Item(1).ToString.Trim & "),'')")
                                            End If
                                        Else
                                            ...
                                            htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & mySetting.UnDisplayDateTime(myTextBox.Text, Session("Company").ToString, Session("Module").ToString) & "'")
                                        End If
                                        myDST2 = Nothing
                                    Else
                                        lblresult2.Text = "Invalid Selection For " & Trim(myDS2.Tables(0).Rows(i).Item(0)) & " !"
                                    ...
                                    If IsNumeric(mySetting.UnDisplayTime(myTextBox.Text, Session("Company").ToString, Session("Module").ToString)) = True Then
                                        ...
                                        If myDST2.Tables(0).Rows.Count > 0 Then
                                            If myDST2.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                                ...
                                                htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST2.Tables(1).Rows(0).Item(0).ToString & "(N'" & mySetting.UnDisplayTime(myTextBox.Text, Session("Company").ToString, Session("Module").ToString) & "'),'')")
                                            Else
                                                ssql = ssql & myDS2.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST2.Tables(1).Rows(0).Item(0).ToString & "(" & myDST2.Tables(0).Rows(0).Item(1).ToString.Trim & "),'') And "
                                                htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST2.Tables(1).Rows(0).Item(0).ToString & "(" & myDST2.Tables(0).Rows(0).Item(1).ToString.Trim & "),'')")
                                            End If
                                        Else
                                            ...
                                            htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & mySetting.UnDisplayTime(myTextBox.Text, Session("Company").ToString, Session("Module").ToString) & "'")
                                        End If
                                        myDST2 = Nothing
                                    Else
                                        lblresult2.Text = "Invalid Selection For " & Trim(myDS2.Tables(0).Rows(i).Item(0)) & " !"
                        ...
                        Case "DECIMAL", "INTEGER"
                            ...
                            If IsNumeric(myTextBox.Text.ToString) Then
                                ssql = ssql & myDS2.Tables(0).Rows(i).Item(0) & "=N'" & myTextBox.Text.ToString & "' And "
                                htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "'" & myTextBox.Text.ToString & "'")
                            Else
                                lblresult2.Text = "Invalid Input Format For " & myDS2.Tables(0).Rows(i).Item(1).ToString
                                Return False
                            End If
                            ...
                            If myTextBox.Visible = True Then
                                If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                    If myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper = "EMPLOYEE_PROFILE_ID" Then
                                        ...
                                        htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(dbo.fn_ReturnEmpIDByCodeName(N'" & Session("Company").ToString & "',N'" & myTextBox.Text.ToString & "'),'')")
                                    Else
                                        Dim myDST2 As New DataSet
                                        myDST2 = mySQL.ExecuteSQL("Select Function_Name,Default_Value,Default_Value2 From User_Define_Function Where Company_Profile_Code='" & Session("Company").ToString & "' And Module_Profile_Code='" & Session("Module").ToString & "' And Table_Profile_Code='" & Form.ID & "' And Table_Field_Code='" & myDS2.Tables(0).Rows(i).Item(0).ToString & "' And Query_Action='UPDATE'")
                                        If myDST2.Tables(0).Rows.Count > 0 Then
                                            If myDST2.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                                ...
                                                htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST2.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "'),'')")
                                            Else
                                                ...
                                                htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(" & myDST2.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST2.Tables(0).Rows(0).Item(1).ToString.Trim & "'),'')")
                                            End If
                                        Else
                                            ssql = ssql & myDS2.Tables(0).Rows(i).Item(0) & "=ISNULL(N'" & myTextBox.Text.ToString & "','') And "
                                            htb.Add(myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper, "ISNULL(N'" & myTextBox.Text.ToString & "','')")
                                        End If
                                        myDST2 = Nothing
                                    End If
                                    'Dim myDST2 As New DataSet
        ...
        DiffMin = mySQL.fn_DateDiff("minute", mySetting.UnDisplayDateTime(txtCLOCK_IN.Text, Session("Company"), Session("Module")), mySetting.UnDisplayDateTime(txtCLOCK_OUT.Text, Session("Company"), Session("Module")))

        If DiffMin < 1 Then
            lblresult2.Text = "Time Out Must Bigger Than Time In!"
            txtCLOCK_OUT.Focus()
            Return False
        ElseIf DiffMin > 1440 Then
            lblresult2.Text = "Different between Time In and Time Out Cannot more than 24 Hour!"
            txtCLOCK_OUT.Focus()
            Return False
        End If
        Return True
