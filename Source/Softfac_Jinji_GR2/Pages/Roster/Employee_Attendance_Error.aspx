<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Attendance_Error.aspx.vb" Inherits="Pages_Roster_Employee_Attendance_Error" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Roster - Employee Attendance Error Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="EMPLOYEE_ATTENDANCE_ERROR" runat="server">
    <div>
    ...
    <!--// 5 //-->
    <asp:imagebutton id="imgKeyOCP_ID_SHIFT_IN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOCP_ID_SHIFT_IN" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_SHIFT_IN" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_SHIFT_IN" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 6 //-->
    <asp:imagebutton id="imgKeyOCP_ID_SHIFT_OUT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOCP_ID_SHIFT_OUT" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_SHIFT_OUT" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_SHIFT_OUT" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 7 //-->
    ...
    <!--// 11 //-->
    <asp:imagebutton id="imgKeyOPTION_ERROR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_ERROR" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_ERROR" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_ERROR" runat="server" Height="21px" ></asp:imagebutton>
