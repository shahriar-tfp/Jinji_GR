...
Partial Class PAGES_HOSTEL_HR_EST_BUS_ROUTE
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        mySetting.GetImgBtnUrl(imgbtnOCP_ID_ROUTE2, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
                ...
                For Me.i = 0 To myDT2.Rows.Count - 1
                    ...
                    Select Case myDT2.Rows(i).Item(6).ToString
                        Case "OPTION"
                            ...
                            myDDL = Nothing
                        Case "LOOKUP"
                            If myDT2.Rows(i).Item(2).ToString.ToUpper = "OCP_ID_ZONE" Then
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnAdd.Click
        ...
        If ActionValidateEdit(False) = True Then
            For Me.i = 0 To myGridView.Rows.Count - 1
                ...
                If chkEdit.Checked Then
                    ...
                    Dim dt As Integer = 3, myDS1 As New DataSet
        ...
        Else
            ...
            Dim dt As Integer = 2
            Dim op As Integer = 3
            Dim dv As Integer = 4, myDSDefault As New DataSet
            lblresult.Text = ""
        ...
        'imgbtnOCP_ID_ROUTE.Visible = False
        'imgbtnOCP_ID_ROUTE2.Visible = True
    ...
    Protected Sub imgBtnEdit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnEdit.Click
        If ActionValidateEdit() Then
            ...
            lstleft.Items.Clear()
            lstright.Items.Clear()
            Session("action_edit") = "OCP_ID_ROUTE"
            AutoAdjustPosition("2")
            'LoadKeyImage()
            ...
            For Me.i = 0 To myGridView.Rows.Count - 1
                ...
                If chkEdit.Checked Then
                    ...
                    myDS = Nothing
                    chkEdit = Nothing
                    ssql = "Exec sp_sa_getListBoxValue 'ZONE_ROUTE','" & Session("Company") & "','" & txtOCP_ID_ZONE.Text & "','','','','',''"
                    myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
                    If myDS.Tables(0).Rows.Count > 0 Then
    ...
    Protected Sub imgBtnFilter_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnFilter.Click
        ...
        If autonum = 0 Then
            ...
            Exit Sub
        End If
        imgKeyOCP_ID_ZONE.Visible = False
        imgKeyOCP_ID_ROUTE.Visible = False
        imgBtnCancel.CssClass = buttonPosition3
        imgBtnClear.CssClass = buttonPosition2
...
#Region "Sub & Function"
    Private Function ActionValidateDelete() As Boolean
        ...
        End If
    End Function
    Private Function ActionValidateEdit(Optional ByVal booShowMessage As Boolean = True) As Boolean
        RecFound = False
        CountRecord = 0
        For Me.i = 0 To myGridView.Rows.Count - 1
            Dim chkEdit As CheckBox = myGridView.Rows(i).Cells(0).Controls(1)
    ...
    Sub disableTxt()
        txtOCP_ID_ZONE.Enabled = False
        txtOCP_ID_ROUTE.Enabled = False
    End Sub
    ...
    Private Function ValidateInsertUpdate() As Boolean
        Dim ssql1 As String = "", ssql5 As String = "", ssql6 As String = "", logic As Boolean
        Try
                    ...
                    Select Case myDS.Tables(0).Rows(i).Item(1).ToString
                        ...
                        Case Else 'character & lookup
                            ...
                            If i = myDS.Tables(0).Rows.Count - 1 Then
                                Dim myImg2 As Image = Page.FindControl("imgbtn" & Trim(myDS.Tables(0).Rows(i).Item(0)))
                            ...
                            'for non last field
                            Dim myTextBox As TextBox = Page.FindControl("txt" & Trim(myDS.Tables(0).Rows(i).Item(0)))
                            Dim myImg As Image = Page.FindControl("imgbtn" & Trim(myDS.Tables(0).Rows(i).Item(0)))
                            If myImg.Visible = True Then
                                If mySetting.CheckTextNull(myTextBox.Text) = True Then
                                    logic = True
                                Else
...
#End Region
    ...
    Protected Sub imgbtnOCP_ID_ZONE_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnOCP_ID_ZONE.Click
        disableLst()
        disableTxt()
        txtOCP_ID_ZONE.Enabled = True
        lstleft.Items.Clear()
        lstright.Items.Clear()
        lblresult2.Text = ""
    End Sub
    ...
    Protected Sub imgbtnOCP_ID_ROUTE_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnOCP_ID_ROUTE.Click

        If ActionValidateFieldJobGrade() = False Then
            lblresult2.Visible = True
            lblresult2.Text = lblOCP_ID_ROUTE.Text & " field is required..."
            Exit Sub
        End If
        visibleLst()
        lstleft.Items.Clear()
        lstright.Items.Clear()
        txtOCP_ID_ROUTE.Text = ""
        Session("action_edit") = "OCP_ID_ROUTE"
        AutoAdjustPosition("2")
        imgBtnCancel.CssClass = buttonPosition3
        imgBtnClear.CssClass = buttonPosition2
    ...
    Protected Sub imgbtnOCP_ID_ROUTE2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnOCP_ID_ROUTE2.Click
        lstleft.Items.Clear()
        lstright.Items.Clear()
        ssql = "Exec sp_sa_getListBoxValue 'ZONE_ROUTE','" & Session("Company") & "','" & txtOCP_ID_ZONE.Text & "','','','','',''"
        myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
