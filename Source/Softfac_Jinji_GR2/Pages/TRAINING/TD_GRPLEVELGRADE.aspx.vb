...
Partial Class PAGES_TRAINING_TD_GRPLEVELGRADE
...
#Region "Private Declaration"
    ...
    Dim ssql2 As String, ssql3 As String, ssql4 As String, ssql1 As String, ssql6 As String, ssql7 As String, ssql5 As String
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        mySetting.GetImgBtnUrl(imgbtnGROUP_ID2, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
        'label for list box
        ...
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "JOBLEVEL_CODE" & """," & """" & """," & """" & Session("EmpID").ToString & """"
        mySetting.GetLookupValue_ImageButton(imgbtnJOBLEVEL_CODE, Form.ID, "txtJOBLEVEL_CODE", "CodeName", ssql)
...
#Region "Sub & Function"
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        imgbtnGROUP_ID2.Visible = False
        imgbtnGROUP_ID.Visible = True
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "JOBLEVEL_CODE" Then
                    If lblJOBLEVEL_CODE.Visible = True And txtJOBLEVEL_CODE.Visible = True Then
                        autonum += 1
                        imgKeyJOBLEVEL_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyJOBLEVEL_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyJOBLEVEL_CODE.Style.Add("position", "absolute")
                        autonum += 1
                        lblJOBLEVEL_CODE.CssClass = "wordstyle12"
                        lblJOBLEVEL_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblJOBLEVEL_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblJOBLEVEL_CODE.Style.Add("position", "absolute")
                        autonum += 1
                        txtJOBLEVEL_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtJOBLEVEL_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtJOBLEVEL_CODE.Style.Add("position", "absolute")
                        txtJOBLEVEL_CODE.Width = txtWidth
                        autonum += 1
                        imgbtnJOBLEVEL_CODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnJOBLEVEL_CODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnJOBLEVEL_CODE.Style.Add("position", "absolute")
                    End If
                End If

                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "GROUPBY" Then
                    If lblGROUPBY.Visible = True And ddlGROUPBY.Visible = True Then
                        autonum += 1
                        imgKeyGROUPBY.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyGROUPBY.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyGROUPBY.Style.Add("position", "absolute")
                        autonum += 1
                        lblGROUPBY.CssClass = "wordstyle12"
                        lblGROUPBY.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblGROUPBY.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblGROUPBY.Style.Add("position", "absolute")
                        autonum += 1
                        ddlGROUPBY.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        ddlGROUPBY.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        ddlGROUPBY.Style.Add("position", "absolute")
                        ddlGROUPBY.Width = txtWidth
                        autonum += 1
                        imgbtnGROUPBY.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnGROUPBY.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnGROUPBY.Style.Add("position", "absolute")
                    End If
                End If


                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "GROUP_ID" Then
                    If Session("action_edit") = "value" Then
                        ...
                        imgKeyGROUP_ID.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyGROUP_ID.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyGROUP_ID.Style.Add("position", "absolute")
                        autonum += 1
                        lblGROUP_ID.CssClass = "wordstyle12"
                        lblGROUP_ID.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblGROUP_ID.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblGROUP_ID.Style.Add("position", "absolute")
                        autonum += 1

                        txtGROUP_ID.Visible = False
                        ...
                        imgbtnGROUP_ID2.Visible = True
                        imgbtnGROUP_ID.Visible = False
                        imgbtnGROUP_ID2.Style.Add("left", mySetting.GetObjPositionRL(EctWidth, 6, "X"))
                        imgbtnGROUP_ID2.Style.Add("top", mySetting.GetObjPositionRL(6, autonum2, "Y"))
                        imgbtnGROUP_ID2.Style.Add("position", "absolute")
                        autonum += 44
                    Else
                        If lblGROUP_ID.Visible = True Then
                            autonum += 1
                            imgKeyGROUP_ID.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgKeyGROUP_ID.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgKeyGROUP_ID.Style.Add("position", "absolute")
                            ...
                            lblGROUP_ID.Style.Add("position", "absolute")
                            autonum += 1
                            txtGROUP_ID.Visible = True
                            txtGROUP_ID.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            txtGROUP_ID.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            txtGROUP_ID.Style.Add("position", "absolute")
                            txtGROUP_ID.Width = txtWidth
                            autonum += 1
                            imgbtnGROUP_ID.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                            imgbtnGROUP_ID.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                            imgbtnGROUP_ID.Style.Add("position", "absolute")
                        End If
                    End If
                End If
...
#End Region
    ...
    Protected Sub imgbtnGROUP_ID_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnGROUP_ID.Click
        If txtCOMPANY_PROFILE_CODE.Text = "" Then
            lblresult2.Text = lblCOMPANY_PROFILE_CODE.Text & " field is required..."
            Exit Sub
        End If
        If txtJOBLEVEL_CODE.Text = "" Then
            lblresult2.Text = lblJOBLEVEL_CODE.Text & " field is required..."
            Exit Sub
        End If
        If ddlGROUPBY.SelectedValue = "" Then
            lblresult2.Text = lblGROUPBY.Text & " field is required..."
            Exit Sub
        End If
        visibleLst()
        lstleft.Items.Clear()
        ...
        imgBtnClear.CssClass = buttonPosition2
        imgBtnSubmit.CssClass = buttonPosition1
        'imgtop.ImageUrl = "../../Images/Default/gif/imgtop_edit.gif"
        'imgbottom.ImageUrl = "../../Images/Default/gif/imgbottom.gif"
        lblresult2.Text = ""

    End Sub

    Protected Sub imgbtnGROUP_ID2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnGROUP_ID2.Click
        lstleft.Items.Clear()
        lstright.Items.Clear()
        ssql2 = "select dbo.fn_getcode_td_joblevel_vw(N'" & txtJOBLEVEL_CODE.Text & "')"
        myDS2 = mySQL.ExecuteSQL(ssql2)
        If myDS2.Tables(0).Rows.Count > 0 Then
            ssql = "Exec sp_sa_getListBoxValue 'GrpLevelGrade','" & Session("Company") & "','" & ddlGROUPBY.SelectedValue & "','" & myDS2.Tables(0).Rows(0).Item(0).ToString & "','','','',''"
            myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
            If myDS.Tables(0).Rows.Count > 0 Then
            ...
            lblresult2.Text = ""
        Else
            lblresult2.Text = "Invalid Joblevel_code."
        End If
                ...
                For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                    Select Case myDS.Tables(0).Rows(i).Item(1).ToString
                        Case "OPTION"
                            logic = False
                            Dim myDropdownlist As DropDownList = Page.FindControl("ddl" & Trim(myDS.Tables(0).Rows(i).Item(0)))
                            Dim myImg As Image = Page.FindControl("imgKey" & Trim(myDS.Tables(0).Rows(i).Item(0)))
                                ...
                                If mySetting.ValidateInput(myTextBox, myDS.Tables(0).Rows(i).Item(1).ToString) = True Then
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        ElseIf myDST.Tables(0).Rows(0).Item(1).ToString.Trim <> "" Then
                                            If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "COMPANY" Then
                                                ssql2 = ssql2 & "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & Session("Company").ToString & "'),''),"
                                                ssql3 = ssql3 & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & Session("Company").ToString & "'),'') And "
                                                ssql4 = ssql4 & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & Session("Company").ToString & "'),''),"
                                            Else
