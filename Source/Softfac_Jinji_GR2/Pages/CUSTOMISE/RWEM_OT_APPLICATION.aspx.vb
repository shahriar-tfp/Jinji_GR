...
Partial Class PAGES_CUSTOMISE_RWEM_OT_APPLICATION
    Inherits System.Web.UI.Page
#Region "Public Declaration"
    Private WithEvents mySQL As New clsSQL, myDS, myDS1 As New DataSet, myDS2, tmpDS2 As New DataSet, mySetting As New clsGlobalSetting
    ...
    Public ssql, ssql1 As String, i As Integer, j As Integer, SearchByPage As Boolean, RecFound As Boolean, CountRecord As Integer
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        mySetting.GetImgBtnUrl(imgbtnAdjustPreFromTime, clsGlobalSetting.ImageType._DATETIME, Session("Company").ToString)
        mySetting.DateTimePicker_ImageButton(imgbtnAdjustPreFromTime, Form.ID, "txtAdjustPreFromTime")
        mySetting.GetImgBtnUrl(imgbtnAdjustPreToTime, clsGlobalSetting.ImageType._DATETIME, Session("Company").ToString)
        mySetting.DateTimePicker_ImageButton(imgbtnAdjustPreToTime, Form.ID, "txtAdjustPreToTime")
        mySetting.GetImgBtnUrl(imgbtnAdjustActFromTime, clsGlobalSetting.ImageType._DATETIME, Session("Company").ToString)
        mySetting.DateTimePicker_ImageButton(imgbtnAdjustActFromTime, Form.ID, "txtAdjustActFromTime")
        mySetting.GetImgBtnUrl(imgbtnAdjustActToTime, clsGlobalSetting.ImageType._DATETIME, Session("Company").ToString)
        mySetting.DateTimePicker_ImageButton(imgbtnAdjustActToTime, Form.ID, "txtAdjustActToTime")
        ...
        If myDS.Tables.Count > 1 Then
            ...
            If myDT2.Rows.Count > 0 Then
                For Me.i = 0 To myDT2.Rows.Count - 1
                    ...
                    If myLabel.ID = "lblPRE_FROM_TIME" Then
                        lblAdjustPreFromTime.Text = myLabel.Text
                        lblAdjustPreFromTime.CssClass = "wordstyle12"
                    End If
                    If myLabel.ID = "lblPRE_TO_TIME" Then
                        lblAdjustPreToTime.Text = myLabel.Text
                        lblAdjustPreToTime.CssClass = "wordstyle12"
                    End If
                    If myLabel.ID = "lblACTUAL_FROM_TIME" Then
                        lblAdjustActFromTime.Text = myLabel.Text
                        lblAdjustActFromTime.CssClass = "wordstyle12"
                    End If
                    If myLabel.ID = "lblACTUAL_TO_TIME" Then
                        lblAdjustActToTime.Text = myLabel.Text
                        lblAdjustActToTime.CssClass = "wordstyle12"
                    End If
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnAdd.Click
        ...
        txtAdjustPreFromTime.Visible = True
        txtAdjustPreToTime.Visible = True
        txtAdjustActFromTime.Visible = True
        txtAdjustActToTime.Visible = True
        lblAdjustPreFromTime.Visible = True
        lblAdjustPreToTime.Visible = True
        lblAdjustActFromTime.Visible = True
        lblAdjustActToTime.Visible = True
        CountRecord = 0
        ClearText()
        ...
        ssql = "Exec sp_tms_AutoGenID '" & Session("Company") & "'"
        myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)

        If myDS.Tables.Count > 0 Then
            If myDS.Tables(0).Rows.Count > 0 Then
                txtFORMID.Text = myDS.Tables(0).Rows(0).Item(0).ToString
            End If
        End If
    ...
    Protected Sub imgBtnFilter_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnFilter.Click
        ...
        txtAdjustPreFromTime.Visible = False
        txtAdjustPreToTime.Visible = False
        txtAdjustActFromTime.Visible = False
        txtAdjustActToTime.Visible = False
        lblAdjustPreFromTime.Visible = False
        lblAdjustPreToTime.Visible = False
        lblAdjustActFromTime.Visible = False
        lblAdjustActToTime.Visible = False
        pnlEdit.Visible = True
        pnldescription.Visible = True
        pnlMain.Visible = False
        imgBtnSubmit.Visible = False
...
#Region "Sub & Function"
    ...
    Public Sub ValueChange()
        If txtAction.Value = "ADD" Then
            RetrieveShift()
            RetrieveDetail()
            AutoAdjustPosition("2")
            ...
            imgBtnClear.CssClass = buttonPosition2
            imgBtnSubmit.CssClass = buttonPosition1
        ElseIf txtAction.Value = "EDIT" Then
            RetrieveDetail()
            AutoAdjustPosition("3")
    ...
    Public Sub RetrieveShift()
        If txtCOMPANY_PROFILE_CODE.Text <> "" And txtDATE.Text <> "" And txtOCP_ID_TMS.Text <> "" Then
            ssql1 = "select dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),dbo.fn_GetOCPIDByCodeName('" & txtOCP_ID_TMS.Text & "','TMS'),dbo.fn_undisplaydate('" & txtDATE.Text & "','" & Session("Company") & "','" & Session("Module") & "')"
            myDS1 = mySQL.ExecuteSQL(ssql1)

            If myDS1.Tables.Count > 0 Then
                If myDS1.Tables(0).Rows.Count > 0 Then
                    ssql = "Exec sp_tms_GetShiftDayType '" & myDS1.Tables(0).Rows(0).Item(0).ToString & "','" & myDS1.Tables(0).Rows(0).Item(1).ToString & "','" & myDS1.Tables(0).Rows(0).Item(2).ToString & "'"
                    myDS = mySQL.ExecuteSQL(ssql)

                    If myDS.Tables.Count > 0 Then
                        If myDS.Tables(0).Rows.Count > 0 Then
                            txtOCP_ID_DAY_TYPE.Text = myDS.Tables(0).Rows(0).Item(0).ToString
                            txtOCP_ID_SHIFT.Text = myDS.Tables(0).Rows(0).Item(1).ToString
                        End If
                    End If
                    ssql = Nothing
                    myDS = Nothing
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        Try
            ...
            autonum2 = autonum + (autonum Mod 8)
            autonum = autonum / 4
            ...
            If pnlgridview1.Visible = True Then
                Dim rowCount As Integer
                Dim EditRowCount As Integer
                rowCount = myGridView1.Rows.Count
                EditRowCount = rowCount * 8

                pnlgridview1.CssClass = panelPosition & autonum
                autonum2 = autonum2 + 18 + EditRowCount
                lblAdjustPreFromTime.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                lblAdjustPreFromTime.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                lblAdjustPreFromTime.Style.Add("position", "absolute")
                autonum2 = autonum2 + 1
                txtAdjustPreFromTime.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                txtAdjustPreFromTime.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                txtAdjustPreFromTime.Style.Add("position", "absolute")
                txtAdjustPreFromTime.Width = txtWidth
                autonum2 = autonum2 + 1
                imgbtnAdjustPreFromTime.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                imgbtnAdjustPreFromTime.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                imgbtnAdjustPreFromTime.Style.Add("position", "absolute")
                autonum2 = autonum2 + 2
                lblAdjustPreToTime.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                lblAdjustPreToTime.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                lblAdjustPreToTime.Style.Add("position", "absolute")
                autonum2 = autonum2 + 1
                txtAdjustPreToTime.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                txtAdjustPreToTime.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                txtAdjustPreToTime.Style.Add("position", "absolute")
                txtAdjustPreToTime.Width = txtWidth
                autonum2 = autonum2 + 1
                imgbtnAdjustPreToTime.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                imgbtnAdjustPreToTime.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                imgbtnAdjustPreToTime.Style.Add("position", "absolute")

                autonum2 = autonum2 + 2
                lblAdjustActFromTime.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                lblAdjustActFromTime.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                lblAdjustActFromTime.Style.Add("position", "absolute")
                autonum2 = autonum2 + 1
                txtAdjustActFromTime.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                txtAdjustActFromTime.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                txtAdjustActFromTime.Style.Add("position", "absolute")
                txtAdjustActFromTime.Width = txtWidth
                autonum2 = autonum2 + 1
                imgbtnAdjustActFromTime.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                imgbtnAdjustActFromTime.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                imgbtnAdjustActFromTime.Style.Add("position", "absolute")
                autonum2 = autonum2 + 2
                lblAdjustActToTime.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                lblAdjustActToTime.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                lblAdjustActToTime.Style.Add("position", "absolute")
                autonum2 = autonum2 + 1
                txtAdjustActToTime.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                txtAdjustActToTime.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                txtAdjustActToTime.Style.Add("position", "absolute")
                txtAdjustActToTime.Width = txtWidth
                autonum2 = autonum2 + 1
                imgbtnAdjustActToTime.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                imgbtnAdjustActToTime.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                imgbtnAdjustActToTime.Style.Add("position", "absolute")

                autonum2 = autonum2 + 1
                buttonPosition1 = buttonPosition1 & autonum + rowCount + 3
                buttonPosition2 = buttonPosition2 & autonum + rowCount + 3
                buttonPosition3 = buttonPosition3 & autonum + rowCount + 3

                labelPosition1 = labelPosition1 & autonum + rowCount + 3
...
#End Region
    ...
    Protected Sub txtCOMPANY_PROFILE_CODE_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCOMPANY_PROFILE_CODE.TextChanged
        ValueChange()
    End Sub

    Protected Sub txtOCP_ID_TMS_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtOCP_ID_TMS.TextChanged
        ValueChange()
    End Sub

    Protected Sub txtOCP_ID_SHIFT_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtOCP_ID_SHIFT.TextChanged
        ValueChange()

    End Sub

    Protected Sub txtOCP_ID_DAY_TYPE_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtOCP_ID_DAY_TYPE.TextChanged
        ValueChange()

    End Sub
    Public Sub RetrieveDetail()
        If txtCOMPANY_PROFILE_CODE.Text <> "" And txtOCP_ID_TMS.Text <> "" And txtDATE.Text <> "" Then

            ssql1 = "select dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),dbo.fn_GetOCPIDByCodeName('" & txtOCP_ID_TMS.Text & "','TMS'),dbo.fn_GetOCPIDByCodeName('" & txtOCP_ID_SHIFT.Text & "','Shift'),dbo.fn_GetOCPIDByCodeName('" & txtOCP_ID_DAY_TYPE.Text & "','Day_Type'),dbo.fn_undisplaydate('" & txtDATE.Text & "','" & Session("Company") & "','" & Session("Module") & "')"
        Else
            ssql1 = ""
        End If
        ...
        If myDS1.Tables.Count > 0 Then
            If myDS1.Tables(0).Rows.Count = 1 Then
                ssql = "exec sp_tms_CalOTApplication '" & myDS1.Tables(0).Rows(0).Item(0).ToString & "','" & ddlOCP_ID_DIVISION.SelectedValue & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue & "','" & myDS1.Tables(0).Rows(0).Item(1).ToString & "','" & myDS1.Tables(0).Rows(0).Item(2).ToString & "','" & myDS1.Tables(0).Rows(0).Item(3).ToString & "','" & myDS1.Tables(0).Rows(0).Item(4).ToString & "','" & txtFORMID.Text & "','OT',''"
            Else
                ssql = "exec sp_tms_CalOTApplication '','','','','','','','','OT',''"
            End If
        Else
            ssql = "exec sp_tms_CalOTApplication '','','','','','','','','OT',''"
        End If
    ...
    Private Sub insupdOTForm()
        ssql = "exec sp_tms_insupddelOTApplication """ & txtCOMPANY_PROFILE_CODE.Text & """,""" & txtFORMID.Text & """,""" & txtEMPLOYEE_PROFILE_ID.Text & """,""" & _
        txtDATE.Text & """,""" & ddlOCP_ID_DIVISION.SelectedValue & """,""" & ddlOCP_ID_DEPARTMENT.SelectedValue & """,""" & txtOCP_ID_TMS.Text & """,""" & _
        txtOCP_ID_SHIFT.Text & """,""" & txtOCP_ID_DAY_TYPE.Text & """,""" & txtPRE_FROM_TIME.Text & """,""" & txtPRE_TO_TIME.Text & """,""" & _
        txtACTUAL_FROM_TIME.Text & """,""" & txtACTUAL_TO_TIME.Text & """,""" & txtWORKING_HOUR.Text & """,""" & txtREASON.Text & """,'ADD'"
        mySQL.ExecuteSQL(ssql, Session("Company"), Session("EmpID"))
    End Sub
End Class