...
Partial Class Pages_Leave_Leave_Entitlement
...
#Region "Public Declaration"
    ...
    Private WithEvents myDR As DataRow
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        'get option_ocp_type
        ssql = "select string_value1 from parameter where company_profile_code = '" & Session("Company") & "' and module_profile_code = 'leave' and code = 'option_ocp_type'"
        myDR = mySQL.ExecuteSQLByReturnRow(ssql)
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID" & """," & """""," & """" & Session("EmpID").ToString & """,""" & myDR(0).ToString() & """"
        mySetting.GetLookupValue_ImageButton(imgBtnOCP_ID, Form.ID, "txtOCP_ID", "CodeName", ssql)
    ...
    Private Function ValidateInsert() As Boolean
        ...
        Try
            ...
            If myDSInsert.Tables(0).Rows.Count > 0 Then
                ...
                If CDec(txtYear_From.Text) > CDec(txtYear_To.Text) Then
                    lblresult2.Text = "Value of " & lblYear_From.Text & " should NOT be greater then " & lblYear_To.Text & "..."
                    Return False
                End If
            End If
