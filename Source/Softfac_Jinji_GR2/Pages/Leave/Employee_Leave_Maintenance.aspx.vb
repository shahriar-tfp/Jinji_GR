...
Partial Class Pages_Leave_Employee_Leave_Maintenance
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        'lookup field seting
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "EMPLOYEE_PROFILE_ID" & """," & """" & """," & """" & Session("EmpID").ToString & """"
        mySetting.GetLookupValue_ImageButton(imgBtnEMPLOYEE_PROFILE_ID, Form.ID, "txtEMPLOYEE_PROFILE_ID", "CodeName", ssql)
        ...
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "USER_PROFILE_CODE_CREATE" & """," & """" & """," & """" & Session("EmpID").ToString & """"
        mySetting.GetLookupValue_ImageButton(imgBtnUSER_PROFILE_CODE_CREATE, Form.ID, "txtUSER_PROFILE_CODE_CREATE", "CodeName", ssql)
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "USER_PROFILE_CODE_MODIFY" & """," & """" & """," & """" & Session("EmpID").ToString & """"
        mySetting.GetLookupValue_ImageButton(imgBtnUSER_PROFILE_CODE_MODIFY, Form.ID, "txtUSER_PROFILE_CODE_MODIFY", "CodeName", ssql)
...
#Region "Panel Edit"
    ...
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        If txtPOH.Text = "##" Or txtPOH.Text = "" Then
            txtPOH.Text = "0"
        End If
        If txtAOH.Text = "##" Or txtAOH.Text = "" Then
            txtAOH.Text = "0"
        End If
        If ValidateInsert() = True Then
            If ValidateInsert2() = True Then
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnAdd.Click
        ...
        Dim DayMin, BaseOnMin As Double
        DayMin = DaybyMin()
        BaseOnMin = BaseMin()
                        ...
                        For Me.j = 0 To myDS1.Tables(0).Rows.Count - 1
                            ...
                            Select Case UCase(Trim(myDS1.Tables(0).Rows(j).Item(dt).ToString))
                                ...
                                Case Else
                                    ...
                                    End If
                                    If Trim(myDS1.Tables(0).Rows(j).Item(code)) = "DAYS" Then
                                        Dim days As String, day(1) As String
                                        days = myTextBox.Text
                                        day = days.Split(".")
                                        myTextBox.Text = day(0)
                                        txtPOH.Text = ((CDbl("0." + day(1)) * DayMin) - (CDbl("0." + day(1)) * DayMin) Mod 60) / 60
                                        txtAOH.Text = ((Math.Round((CDbl("0." + day(1)) / (BaseOnMin / DayMin)), 0, MidpointRounding.AwayFromZero) * (BaseOnMin / DayMin)) * DayMin) Mod 60
                                        'txtAOH.Text = ((CDbl("0." + day(1)) * DaybyMin()) Mod 60) - (((CDbl("0." + day(1)) * DaybyMin()) Mod 60) Mod BaseMin())
                                    End If
                            End Select
                            ...
                            Select Case UCase(Trim(myDS1.Tables(0).Rows(j).Item(dt).ToString))
                                ...
                                Case Else
                                    ...
                                    If Trim(myDS1.Tables(0).Rows(j).Item(code)) = "DAYS" Then
                                        ...
                                        txtPOH.Text = ((CDbl("0." + day(1)) * DayMin) - (CDbl("0." + day(1)) * DayMin) Mod 60) / 60
                                        txtAOH.Text = ((Math.Round((CDbl("0." + day(1)) / (BaseOnMin / DayMin)), 0, MidpointRounding.AwayFromZero) * (BaseOnMin / DayMin)) * DayMin) Mod 60
                                        'txtAOH.Text = ((CDbl("0." + day(1)) * DayMin) Mod 60) - (((CDbl("0." + day(1)) * DayMin) Mod 60) Mod BaseOnMin)
                                    End If
                            End Select
    ...
    Protected Sub imgBtnFilter_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnFilter.Click
        ...
        imgBtnUpdate.Visible = False
        pnldescription.Visible = True
        txtPOH.Visible = False
        txtAOH.Visible = False
...
#Region "Sub & Function"
                ...
                For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                    ...
                    Select Case UCase(Trim(myDS.Tables(0).Rows(i).Item(dt).ToString))
                        ...
                        Case Else
                            ...
                            Select Case UCase(Trim(myDS.Tables(0).Rows(i).Item(posType).ToString))
                                Case "0"
                                    If myLabel.Visible = True And myTextBox.Visible = True And Trim(myDS.Tables(0).Rows(i).Item(code)) = "DAYS" Then
                                        autonum = autonum + 1
                                        myImage.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                                        myImage.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                                        myImage.Style.Add("position", "absolute")
                                        ...
                                        If txtPOH.Visible = True And lblTime.Visible = True And txtAOH.Visible = True Then
                                            myTextBox.Width = txtWidth - 70
                                            txtPOH.Style.Add("left", CStr(CInt(Replace(mySetting.GetObjPosition(EctWidth, autonum, "X"), "px", "")) + txtWidth - 60) + "px")
                                            txtPOH.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                                            txtPOH.Style.Add("position", "absolute")
                                            txtPOH.Width = 20
                                            txtPOH.MaxLength = 2
                                            lblTime.Style.Add("left", CStr(CInt(Replace(mySetting.GetObjPosition(EctWidth, autonum, "X"), "px", "")) + txtWidth - 30) + "px")
                                            lblTime.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                                            lblTime.Style.Add("position", "absolute")
                                            lblTime.Width = 10
                                            txtAOH.Style.Add("left", CStr(CInt(Replace(mySetting.GetObjPosition(EctWidth, autonum, "X"), "px", "")) + txtWidth - 20) + "px")
                                            txtAOH.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                                            txtAOH.Style.Add("position", "absolute")
                                            txtAOH.Width = 20
                                            txtAOH.MaxLength = 2
                                        Else
                                        ...
                                        myImageButton.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                                        myImageButton.Style.Add("position", "absolute")
                                    ElseIf myLabel.Visible = True And myTextBox.Visible = True Then
                                        autonum = autonum + 1
                                        myImage.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                                        myImage.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                                        myImage.Style.Add("position", "absolute")
    ...
    Private Function ValidateUpdate() As Boolean
        ...
        Try
            Dim BaseOnMin, DayMin As Double
            Dim Round As String
            BaseOnMin = BaseMin()
            DayMin = DaybyMin()
            Round = Rounding()
                            ...
                            If logic = True Then
                                If myTextBox.Text <> "" Then
                                    If IsNumeric(myTextBox.Text) Then
                                        If myDS.Tables(0).Rows(i).Item(0) = "DAYS" Then
                                            If IsNumeric(txtPOH.Text) And IsNumeric(txtAOH.Text) Then
                                                myTextBox.Text = CDbl(myTextBox.Text) + ((CDbl(txtPOH.Text) * 60 + CDbl(txtAOH.Text)) / DayMin)
                                                myTextBox.Text = CDbl(myTextBox.Text) * DayMin
                                                If Round = "UP" Then
                                                    If CDbl(myTextBox.Text) Mod BaseOnMin = 0 Then
                                                        myTextBox.Text = CDbl(myTextBox.Text) + (CDbl(myTextBox.Text) Mod BaseOnMin)
                                                    Else
                                                        myTextBox.Text = CDbl(myTextBox.Text) + (BaseOnMin - (CDbl(myTextBox.Text) Mod BaseOnMin))
                                                    End If
                                                Else
                                                    myTextBox.Text = CDbl(myTextBox.Text) - (CDbl(myTextBox.Text) Mod BaseOnMin)
                                                End If
    ...
    Private Function ValidateInsert() As Boolean
        ...
        Try
            ...
            DayMin = DaybyMin()
            BaseOnMin = BaseMin()
            ssql = "exec sp_sa_get_insert_statement '" & Session("Company") & "','" & Session("Module") & "','" & Form.ID & "','" & Session("EmpID") & "'"
            ...
            If myDSInsert.Tables(0).Rows.Count > 0 Then
                For Me.i = 0 To myDSInsert.Tables(0).Rows.Count - 1
                    ...
                    If UCase(Trim(myDSInsert.Tables(0).Rows(i).Item(ovc).ToString)) = "YES" Then
                        ...
                        Select Case UCase(myDSInsert.Tables(0).Rows(i).Item(odt).ToString)
                            ...
                            Case "DATETIME"
                                ...
                                If logic = True Then
                                    If myTextBox.Text <> "" Then
                                        Dim strDateTime As String = Trim(myTextBox.Text)
                            ...
                            Case "DECIMAL", "INTEGER"
                                ...
                                If logic = True Then
                                    If myTextBox.Text <> "" Then
                                        If IsNumeric(myTextBox.Text) Then
                                            ssql = ssql & myDSInsert.Tables(0).Rows(i).Item(code) & ","
                                            If myDSInsert.Tables(0).Rows(i).Item(code) = "DAYS" Then
                                                If IsNumeric(txtPOH.Text) And IsNumeric(txtAOH.Text) Then
                                                    myTextBox.Text = CDbl(myTextBox.Text) + ((CDbl(txtPOH.Text) * 60 + CDbl(txtAOH.Text)) / DayMin)
                                                    myTextBox.Text = CDbl(myTextBox.Text) * DayMin
                                                    If Round = "UP" Then
    ...
    Private Function ValidateInsert2() As Boolean
        ...
        Dim strEffectiveDate, strExpiryDate As String
        strEffectiveDate = mySetting.ConvertDateToDecimal(Trim(txtEffective_Date.Text), Session("Company"), Session("Module"))
        strExpiryDate = mySetting.ConvertDateToDecimal(Trim(txtExpiry_Date.Text), Session("Company"), Session("Module"))

        'Checking record if available
        ssql5 = "Exec sp_ls_validateDateInRange '" & Session("Company") & "','" & Session("Module") & "','" & Trim(txtEMPLOYEE_PROFILE_ID.Text) & _
                   "','" & Trim(txtOCP_ID_LEAVE.Text) & "','" & Form.ID & "','" & strEffectiveDate & "','" & strExpiryDate & "'"
        myDS5 = mySQL.ExecuteSQL(ssql5, Session("Company").ToString, Session("EmpID").ToString)
        If myDS5.Tables(0).Rows.Count > 0 Then
            If UCase(myDS5.Tables(0).Rows(0).Item(0).ToString) <> "TRUE" Then
                If UCase(myDS5.Tables(0).Rows(0).Item(0).ToString) = "FALSE" Then
                    lblresult2.Text = "Date selected not available/allow!"
                Else
                    lblresult2.Text = myDS5.Tables(0).Rows(0).Item(0).ToString
                End If
                myDS5 = Nothing
                Return False
            End If
    ...
    Private Function DaybyMin() As Integer
        ssql1 = "Select decimal_value1 from parameter where Company_profile_Code = '" & Session("company").ToString & "' and Code = 'LEAVEMIN'"
        myDS = mySQL.ExecuteSQL(ssql1)
        If myDS.Tables(0).Rows.Count > 0 Then
            DaybyMin = myDS.Tables(0).Rows(0).Item(0).ToString
        Else
            DaybyMin = 1
        End If
        ssql1 = Nothing
        myDS = Nothing
    End Function
    Private Function BaseMin() As Integer
        ssql1 = "Select decimal_value1 from parameter where Company_profile_Code = '" & Session("company").ToString & "' and Code = 'LEAVEBASE'"
        myDS = mySQL.ExecuteSQL(ssql1)
        If myDS.Tables(0).Rows.Count > 0 Then
            BaseMin = myDS.Tables(0).Rows(0).Item(0).ToString
        Else
            BaseMin = 1
        End If
        ssql1 = Nothing
        myDS = Nothing
    End Function
    Private Function Rounding() As String
        ssql1 = "Select String_value1 from parameter where Company_profile_Code = '" & Session("company").ToString & "' and Code = 'LEAVEROUND'"
        myDS = mySQL.ExecuteSQL(ssql1)
        If myDS.Tables(0).Rows.Count > 0 Then
            Rounding = myDS.Tables(0).Rows(0).Item(0).ToString
        Else
            Rounding = "DOWN"
        End If
        ssql1 = Nothing
