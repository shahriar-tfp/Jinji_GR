					    ...
					    <td>
					        ...
					        <table cellspacing="0" cellpadding="0" border="0" runat="server">
					            ...
					            <tr>
					                ...
					                <td>
					                    <asp:LinkButton id="lnkBtnViewCancellation" runat="server" CssClass="wordstyle" Text="[ Leave Cancellation ]" Enabled="false" ></asp:LinkButton>
					                    <asp:LinkButton id="lnkBtnCloseCancellation" runat="server" CssClass="wordstyle11" Text="[ Leave Cancellation ]" Visible="false" ></asp:LinkButton>
					                </td>
					            </tr>
					        </table> 
					    </td> 
