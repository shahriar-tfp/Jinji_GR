...
Partial Class Pages_Leave_Leave_Profile
...
#Region "Panel Action"
    ...
    Protected Sub ddlOption_Entitlement_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOption_Entitlement.SelectedIndexChanged
        If ddlOption_Entitlement.SelectedValue = "YES" Then
            ddlOption_Maintenance.SelectedValue = "NO"
            'ddlOption_Maintenance.Enabled = False
            'ddlOption_Entitlement.Enabled = True
            'Else
            '    ddlOption_Maintenance.SelectedValue = "YES"
            '    ddlOption_Maintenance.Enabled = True
            '    ddlOption_Entitlement.Enabled = False
        End If
    End Sub

    Protected Sub ddlOption_Maintenance_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOption_Maintenance.SelectedIndexChanged
        If ddlOption_Maintenance.SelectedValue = "YES" Then
            ddlOption_Entitlement.SelectedValue = "NO"
            'ddlOption_Maintenance.Enabled = True
            'ddlOption_Entitlement.Enabled = False
            'Else
            '    ddlOption_Entitlement.SelectedValue = "YES"
            '    ddlOption_Maintenance.Enabled = False
            '    ddlOption_Entitlement.Enabled = True
        End If
    End Sub
    ...
    Private Function ValidateInsert() As Boolean
        ...
        Try
            ...
            If myDSInsert.Tables(0).Rows.Count > 0 Then
                ...
                If CDec(txtMin_Leave.Text) > CDec(txtMax_Leave.Text) Then
                    lblresult2.Text = "Value of " & lblMin_Leave.Text & " should NOT be greater then " & lblMax_Leave.Text & " value..."
                    Return False
                End If
