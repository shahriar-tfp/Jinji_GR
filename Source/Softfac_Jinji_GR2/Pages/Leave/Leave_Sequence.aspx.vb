...
Partial Class Pages_Leave_Leave_Sequence
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        'lookup field seting
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID_LEAVE" & """," & """" & """"
        mySetting.GetLookupValue_ImageButton(imgBtnOCP_ID_LEAVE, Form.ID, "txtOCP_ID_LEAVE", "CodeName", ssql)
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID_LEAVE_APPLIED" & """," & """" & """"
        mySetting.GetLookupValue_ImageButton(imgBtnOCP_ID_LEAVE_APPLIED, Form.ID, "txtOCP_ID_LEAVE_APPLIED", "CodeName", ssql)
