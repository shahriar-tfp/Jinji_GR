    ...
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        ...
        Try
            ...
            ssql = "Exec sp_ls_GetEmpLeaveData '" & Session("Company") & "','" & Session("Module") & _
                    "','" & Trim(txtEmployeeCode.Text) & "','" & strLeaveType & "'"
            myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
            If myDS.Tables(0).Rows.Count > 0 Then
            ...
            ssql = "Exec sp_is_chkResignStatus '" & Session("Company") & "','" _
                   & Session("curLeaveEmpID") & "','" & Session("CurSysDate") & "'"
            myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
    ...
    Protected Sub imgBtnApply_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnApply.Click
        ...
        Try
            ...
            If ActionValidateDelete3() Then
                ...
                For Me.i = 0 To myGridview3.Rows.Count - 1
...
#Region "Sub & Function"
    ...
    Sub LnkBtnViewRecord_Action()
        ...
        Try
            ...
            ssql = "exec sp_sa_getTableRecords2 '" & Session("Company") & "','" & Session("Module") & "','Employee_Leave_Balance','" & myGridview2.PageSize & "','" & Session("currentpage2") & "','[" & EmployeeCodeField & "]','" & EmployeeCode & "'"
            myDS2 = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
            lblresult.Text = ""
            If myDS2.Tables(0).Rows.Count > 0 Then
    ...
    Sub BindGridInfo()
        ...
        Try
            If Trim(txtEmployee_Profile_ID.Text) <> "Employee Code" And Trim(txtEmployee_Name.Text) <> "Employee Name" Then
                ssql = "exec sp_Generate_Query_Filter '" & Session("Company") & "','" & Session("Module") & "','Employee_Personal_CodeName_Vw@@Employee_Personal_CodeName_Vw','code@@Name','" & Trim(txtEmployee_Profile_ID.Text) & "@@" & Trim(txtEmployee_Name.Text) & "','" & myGridView1.PageSize & "','" & Session("currentpage1") & "','" & Session("EmpID") & "'"
            ...
            ElseIf Trim(txtEmployee_Name.Text) <> "Employee Name" Then
                ssql = "exec sp_Generate_Query_Filter '" & Session("Company") & "','" & Session("Module") & "','Employee_Personal_CodeName_Vw','name','" & Trim(txtEmployee_Name.Text) & "','" & myGridView1.PageSize & "','" & Session("currentpage1") & "','" & Session("EmpID") & "'"
            End If
