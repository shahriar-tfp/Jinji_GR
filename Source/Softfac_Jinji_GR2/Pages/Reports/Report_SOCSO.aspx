<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_SOCSO.aspx.vb" Inherits="Pages_Reports_Report_SOCSO" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Report - SOCSO Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="Report_SOCSO" runat="server">
    <div>
    <asp:Panel ID="pnlSOCSO" runat="server">
    ...
    <asp:ImageButton ID="imgKeyOPTION_SOCSO_TYPE" runat="server" Width="21px" Height="21px"/>
    <asp:Label ID="lblOPTION_SOCSO_TYPE" runat="server" Width="120px"></asp:Label>
    <asp:dropdownlist ID="ddlOPTION_SOCSO_TYPE" runat="server" Width="150px"></asp:dropdownlist>
    <asp:ImageButton ID="imgbtnOPTION_SOCSO_TYPE" runat="server" Width="21px" Height="21px"/>
    ...
    <asp:imagebutton id="imgBtnPrintSOCSOA" runat="server" Width="74" Height="21" OnClientClick="return confirm('Confirmation! Print Socso Lampiran A Report. ?')"></asp:imagebutton>
