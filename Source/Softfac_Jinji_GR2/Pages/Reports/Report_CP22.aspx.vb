...
Partial Class Pages_Reports_Report_CP22
...
#End Region
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        ...
        ssql = "select dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),dbo.fn_ReturnEmpIDByCodeName( dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'), N'" & "'),@@spid"
        ...
        If ValidatePrint(myDS) = True Then
            If myDS.Tables(0).Rows.Count = 1 Then
                For k = 0 To itemCount - 1
                    ...
                    ssql1 = Nothing
                Next
                myTargetURL = myTargetURL & "&RegNo=" & myDS.Tables(0).Rows(0).Item(0).ToString & "&PIC=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&SPID=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&rdTemplate=pr_CP22"
