...
Partial Class Pages_Reports_Report_BankList
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "PAY_DATE" Then
                    If lblPay_Date.Visible = True And txtPay_Date.Visible = True Then
                        autonum += 1
                        imgKeyPay_Date.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyPay_Date.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyPay_Date.Style.Add("position", "absolute")
                        autonum += 1
                        lblPay_Date.CssClass = "wordstyle12"
                        lblPay_Date.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblPay_Date.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblPay_Date.Style.Add("position", "absolute")
                        autonum += 1
                        txtPay_Date.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtPay_Date.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtPay_Date.Style.Add("position", "absolute")
                        txtPay_Date.Width = txtWidth
                        autonum += 1
                        imgbtnPay_Date.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnPay_Date.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnPay_Date.Style.Add("position", "absolute")
                    End If
                End If


                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "CHEQUE" Then
                    If lblCheque.Visible = True And txtCheque.Visible = True Then
                        autonum += 1
                        imgKeyCheque.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyCheque.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyCheque.Style.Add("position", "absolute")
                        autonum += 1
                        lblCheque.CssClass = "wordstyle12"
                        lblCheque.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblCheque.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblCheque.Style.Add("position", "absolute")
                        autonum += 1
                        txtCheque.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtCheque.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtCheque.Style.Add("position", "absolute")
                        txtCheque.Width = txtWidth
                        autonum += 1
                        imgbtnCheque.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnCheque.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnCheque.Style.Add("position", "absolute")
                    End If
                End If

                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "COMPANY_PAY_BANK" Then
                    If lblCompany_Pay_Bank.Visible = True And txtCompany_Pay_Bank.Visible = True Then
                        autonum += 1
                        imgKeyCompany_Pay_Bank.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyCompany_Pay_Bank.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyCompany_Pay_Bank.Style.Add("position", "absolute")
                        autonum += 1
                        lblCompany_Pay_Bank.CssClass = "wordstyle12"
                        lblCompany_Pay_Bank.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblCompany_Pay_Bank.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblCompany_Pay_Bank.Style.Add("position", "absolute")
                        autonum += 1
                        txtCompany_Pay_Bank.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtCompany_Pay_Bank.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtCompany_Pay_Bank.Style.Add("position", "absolute")
                        txtCompany_Pay_Bank.Width = txtWidth
                        autonum += 1
                        imgbtnCompany_Pay_Bank.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnCOMPANY_PAY_BANK.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnCompany_Pay_Bank.Style.Add("position", "absolute")
                    End If
                End If

                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "EMPLOYEE_BANK" Then
                    If lblEmployee_Bank.Visible = True And txtEmployee_Bank.Visible = True Then
                        autonum += 1
                        imgKeyEmployee_Bank.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyEmployee_Bank.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyEmployee_Bank.Style.Add("position", "absolute")
                        autonum += 1
                        lblEmployee_Bank.CssClass = "wordstyle12"
                        lblEmployee_Bank.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblEmployee_Bank.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblEmployee_Bank.Style.Add("position", "absolute")
                        autonum += 1
                        txtEmployee_Bank.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtEmployee_Bank.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtEmployee_Bank.Style.Add("position", "absolute")
                        txtEmployee_Bank.Width = txtWidth
                        autonum += 1
                        imgbtnEmployee_Bank.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnEmployee_Bank.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnEmployee_Bank.Style.Add("position", "absolute")
                    End If
                End If
...
#End Region
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        Try
            ...
            ssql = "select dbo.fn_GetEmpID(N'" & Session("EmpID").ToString & "'),dbo.fn_datepart('month',dbo.fn_UnDisplayDate('" & txtYEAR_MONTH.Text & "',N'" & Session("Company").ToString & "','" & Session("Module").ToString & "')),dbo.fn_datepart('year',dbo.fn_UnDisplayDate('" & txtYEAR_MONTH.Text & "',N'" & Session("Company").ToString & "','" & Session("Module").ToString & "')),@@spid,dbo.fn_GetCode_Bank_Profile_Vw('" & txtCompany_Pay_Bank.Text & "','" & Session("Company").ToString & "'),dbo.fn_GetCode_Bank_Profile_Vw('" & txtEmployee_Bank.Text & "','" & Session("Company").ToString & "')"
            myDS = New DataSet()
            myDS = mySQL.ExecuteSQL(ssql)
            If ValidatePrint(myDS) = True Then
                If myDS.Tables(0).Rows.Count = 1 Then
                    'For k = 0 To itemCount - 1
                    ssql1 = "exec Sp_Rpt_InsDelReportControlTemp '" & Session("Company").ToString & "','','" & spid & "','ALL','" & Session("EmpID").ToString & "'"
                    myDS1 = New DataSet()
                    ...
                    ssql1 = Nothing
                    'Next
                    myTargetURL = myTargetURL & "&Company_Profile_Code=" & Session("Company").ToString & "&Month=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&Year=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&Spid=" & spid & "&Bank_Profile_Code=" & myDS.Tables(0).Rows(0).Item(4).ToString & "&Date=" & txtPAY_DATE.Text & "&Cheque=" & txtCHEQUE.Text & "&ByRpt=" & ddlOPTION_REPORT.SelectedValue & "&rdTemplate=pr_BankList"
    ...
    Private Function ValidatePrint(ByVal myds As DataSet) As Boolean
        If IsNumeric(mySetting.ConvertDateToDecimal(txtYEAR_MONTH.Text, Session("Company").ToString, Session("Module").ToString)) = False Then
