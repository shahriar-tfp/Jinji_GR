...
Partial Class Pages_Reports_Report_EA_Set
...
#Region "Panel Edit"
    ...
    Protected Sub imgbtnGROUP_CODE2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnGROUP_CODE2.Click
        ...
        lstleft.Items.Clear()
        lstright.Items.Clear()
        ssql = "Exec sp_sa_getListBoxValue 'ea_set','" & Session("Company") & "','" & ddlOPTION_FIELD.SelectedValue & "','" & ddlOPTION_CATEGORIZE.SelectedValue & "','" & """" & "','','',''"
