...
Partial Class Pages_Reports_Report_OT_TotalHour
            ...
            If ValidatePrint(myDS) = True Then
                If myDS.Tables(0).Rows.Count = 1 Then
                    ...
                    For k = 0 To itemCount - 1
                        ...
                        ssql1 = Nothing
                    Next
                    If ddlOPTION_TYPE.SelectedValue = "WOT" Then
                        myTargetURL = myTargetURL & "&Company_Profile_Code=" & Session("Company").ToString & "&spid=" & spid & "&FromDate=" & txtDATE_FROM.Text & "&ToDate=" & txtDATE_TO.Text & "&User_Profile_Code=" & Session("EmpID").ToString & "&By_type=" & ddlOPTION_GROUP.SelectedValue & "&Option_Report=" & ddlOPTION_TYPE.SelectedValue & "&rdTemplate=OT_TotalHour"
                    ElseIf ddlOPTION_TYPE.SelectedValue = "WOTS" Then
                        myTargetURL = myTargetURL & "&Company_Profile_Code=" & Session("Company").ToString & "&spid=" & spid & "&FromDate=" & txtDATE_FROM.Text & "&ToDate=" & txtDATE_TO.Text & "&User_Profile_Code=" & Session("EmpID").ToString & "&By_type=" & ddlOPTION_GROUP.SelectedValue & "&Option_Report=" & ddlOPTION_TYPE.SelectedValue & "&rdTemplate=OT_TotalHour_Summary"
                    Else
                        myTargetURL = myTargetURL & "&Company_Profile_Code=" & Session("Company").ToString & "&spid=" & spid & "&FromDate=" & txtDATE_FROM.Text & "&ToDate=" & txtDATE_TO.Text & "&User_Profile_Code=" & Session("EmpID").ToString & "&By_type=" & ddlOPTION_GROUP.SelectedValue & "&Option_Report=" & ddlOPTION_TYPE.SelectedValue & "&rdTemplate=OT_TotalHour"
                    End If
