...
Partial Class Pages_Reports_Report_Medical_Balance
...
#End Region
    ...
    Private Sub PagePreload()
        ...
        mySetting.GetImgUrl(imgKeyCLAIMTYPE, clsGlobalSetting.ImageType._KEY, Session("Company").ToString)
        ...
        mySetting.GetImgUrl(imgbtnCLAIMTYPE, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        ...
        ssql = "select dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),dbo.fn_GetCode_MEDICAL_CLAIMTYPE_Vw(N'" & txtCLAIMTYPE.Text & "'),@@spid"
        ...
        If ValidatePrint(myDS) = True Then
            If myDS.Tables(0).Rows.Count = 1 Then
                For k = 0 To itemCount - 1
                    ...
                    ssql1 = Nothing
                Next
                myTargetURL = myTargetURL & "&Company_Profile_Code=" & myDS.Tables(0).Rows(0).Item(0).ToString & "&ClaimType=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&Year=" & ddlOPTION_YEAR.SelectedValue & "&Report_ID=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&Type=" & ddlOPTION_GROUP.SelectedValue & "&User_Profile_Code=" & Session("EmpID") & "&rdTemplate=MedicalBalance"
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "CLAIMTYPE" Then
                    If lblCLAIMTYPE.Visible = True And txtCLAIMTYPE.Visible = True Then
                        autonum += 1
                        imgKeyCLAIMTYPE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyCLAIMTYPE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyCLAIMTYPE.Style.Add("position", "absolute")
                        autonum += 1
                        lblCLAIMTYPE.CssClass = "wordstyle12"
                        lblCLAIMTYPE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblCLAIMTYPE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblCLAIMTYPE.Style.Add("position", "absolute")
                        autonum += 1
                        txtCLAIMTYPE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtCLAIMTYPE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtCLAIMTYPE.Style.Add("position", "absolute")
                        txtCLAIMTYPE.Width = txtWidth
                        autonum += 1
                        imgbtnCLAIMTYPE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnCLAIMTYPE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnCLAIMTYPE.Style.Add("position", "absolute")
                    End If
                End If
