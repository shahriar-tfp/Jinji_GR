<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_Attendance_ByUser.aspx.vb" Inherits="Pages_Reports_Report_Attendance_ByUser" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Report - Attendance By Type Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="Report_Attendance_ByUser" runat="server">
    <div>
