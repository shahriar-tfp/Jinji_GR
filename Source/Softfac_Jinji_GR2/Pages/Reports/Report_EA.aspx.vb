...
Partial Class Pages_Reports_Report_EA
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        ...
        If ValidatePrint(myDS) = True Then
            If myDS.Tables(0).Rows.Count = 1 Then
                ...
                'myTargetURL = myTargetURL & "&RegNo=" & myDS.Tables(0).Rows(0).Item(0).ToString & "&Year=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&SpID=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&bonus1=" & txtBONUS1.Text & "&bonus2=" & txtBONUS2.Text & "&User_Profile_Code=" & Session("EmpID").ToString & "&rdTemplate=pr_GovEA"
                ...
                If myDS2.Tables.Count > 0 Then
                    ...
                    Else
                        myTargetURL = myTargetURL & "pr_GovEA"
                    End If
                Else
                    myTargetURL = myTargetURL & "pr_GovEA"
                End If
