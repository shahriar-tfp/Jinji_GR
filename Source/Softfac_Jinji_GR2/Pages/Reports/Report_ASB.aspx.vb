...
Partial Class Pages_Reports_Report_ASB
...
#End Region
            ...
            If myDT2.Rows.Count > 0 Then
                ...
                For Me.i = 0 To myDT2.Rows.Count - 1
                    ...
                    Catch ex As Exception
                        Response.Write(myDT2.Rows(i).Item(3).ToString)
                    End Try
                    myLabel = Nothing
                    myImageKey = Nothing
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        ...
        If ValidatePrint(myDS) = True Then
            If myDS.Tables(0).Rows.Count = 1 Then
                myTargetURL = myTargetURL & "&RegNo=" & myDS.Tables(0).Rows(0).Item(0).ToString & "&Month=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&Year=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&PIC=" & myDS.Tables(0).Rows(0).Item(3).ToString & "&Cheque=" & myDS.Tables(0).Rows(0).Item(4).ToString & "&rdTemplate=pr_ASB"
    ...
    Protected Sub imgBtnSaveAs_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSaveAs.Click
        ...
        If ValidatePrint(myDS) = True Then
            If myDS.Tables(0).Rows.Count = 1 Then
                ...
                ssql1 = "Exec sp_pr_SelDiskASB '" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "','" & txtCHEQUE.Text & "'"
                myDS1 = New DataSet
    ...
    Private Function ValidatePrint(ByVal myds As DataSet) As Boolean
        ...
        ElseIf txtCHEQUE.Text = "" Then
            lblresult2.Text = "[" & lblCHEQUE.Text & "] Is A Required Field!"
            txtCHEQUE.Focus()
            Return False
        Else
            Return True
