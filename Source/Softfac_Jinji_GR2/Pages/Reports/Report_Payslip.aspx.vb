...
Partial Class Pages_Reports_Report_Payslip
            ...
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OPTION_PAY_TYPE" Then
                    If lblOPTION_PAY_TYPE.Visible = True And ddlOPTION_PAY_TYPE.Visible = True Then
                        ...
                        ddlOPTION_PAY_TYPE.Width = ddlWidth
                        autonum += 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OPTION_PAY_MODE" Then
                    If lblOPTION_PAY_MODE.Visible = True And ddlOPTION_PAY_MODE.Visible = True Then
                        autonum += 1
                        imgKeyOPTION_PAY_MODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyOPTION_PAY_MODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyOPTION_PAY_MODE.Style.Add("position", "absolute")
                        autonum += 1
                        lblOPTION_PAY_MODE.CssClass = "wordstyle12"
                        lblOPTION_PAY_MODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOPTION_PAY_MODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOPTION_PAY_MODE.Style.Add("position", "absolute")
                        autonum += 1
                        ddlOPTION_PAY_MODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        ddlOPTION_PAY_MODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        ddlOPTION_PAY_MODE.Style.Add("position", "absolute")
                        ddlOPTION_PAY_MODE.Width = ddlWidth
                        autonum += 1
                        imgbtnOPTION_PAY_MODE.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnOPTION_PAY_MODE.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnOPTION_PAY_MODE.Style.Add("position", "absolute")
                    End If
                End If
...
#End Region
            ...
            If ValidatePrint(myDS) = True Then
                If myDS.Tables(0).Rows.Count = 1 Then
                    ...
                    For k = 0 To itemCount - 1
                        'If ddlOPTION_REPORT.SelectedValue = "PAYSLIP" Or ddlOPTION_REPORT.SelectedValue = "BONUS" Then
                        If ddlOPTION_REPORT.SelectedValue = "BONUS" Then
                            ssql1 = "exec sp_pr_InsUpdDelEmployeePayrollProcessTemp '" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & lstright.Items(k).Value & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" & ddlOPTION_PAY_CYCLE.SelectedValue & "'," & spid & ",'" & ddlOPTION_GROUP.SelectedValue & "','" & Session("EmpID").ToString & "'"
                            myDS1 = New DataSet()
                            myDS1 = mySQL.ExecuteSQL(ssql1)
                        ...
                        End If
                    Next
                    If ddlOPTION_REPORT.SelectedValue = "PAYSLIP" Then
                        myTargetURL = myTargetURL & "&Company_Profile_Code=" & Session("Company").ToString & "&Month=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&Year=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&spid=" & spid & "&User_Profile_Code=" & Session("EmpID").ToString & "&rdTemplate=pr_Payslip&Group=" & ddlOPTION_GROUP.SelectedValue
                    ElseIf ddlOPTION_REPORT.SelectedValue = "BONUS" Then
                        'myTargetURL = myTargetURL & "&OrganID=" & myDS.Tables(0).Rows(0).Item(0).ToString & "&month=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&year=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&SPID=" & myDS.Tables(0).Rows(0).Item(3).ToString & "&PayType=" & ddlOPTION_PAY_TYPE.SelectedValue & "&PayMode=" & ddlOPTION_PAY_MODE.SelectedValue & "&rdTemplate=pr_Bonuspayslip"
                        myTargetURL = myTargetURL & "&OrganID=" & myDS.Tables(0).Rows(0).Item(0).ToString & "&month=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&year=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&SPID=" & myDS.Tables(0).Rows(0).Item(3).ToString & "&PayType=" & ddlOPTION_PAY_TYPE.SelectedValue & "&PayMode=" & ddlOPTION_PAY_MODE.SelectedValue & "&rdTemplate=pr_Bonusslip"
                        'myTargetURL = myTargetURL & "&Company_Profile_Code=" & Session("Company").ToString & "&Month=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&Year=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&spid=" & spid & "&User_Profile_Code=" & Session("EmpID").ToString & "&rdTemplate=PR_EBonusPayslip"
                    Else
                        'myTargetURL = myTargetURL & "&OrganID=" & myDS.Tables(0).Rows(0).Item(0).ToString & "&month=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&year=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&SPID=" & myDS.Tables(0).Rows(0).Item(3).ToString & "&PayType=" & ddlOPTION_PAY_TYPE.SelectedValue & "&PayMode=" & ddlOPTION_PAY_MODE.SelectedValue & "&rdTemplate=pr_payslip"
                        myTargetURL = myTargetURL & "&Company_Profile_Code=" & Session("Company").ToString & "&Month=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&Year=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&spid=" & spid & "&User_Profile_Code=" & Session("EmpID").ToString & "&rdTemplate=pr_EPayslip&Group=" & ddlOPTION_GROUP.SelectedValue
                    End If
    ...
    Private Function ValidatePrint(ByVal myds As DataSet) As Boolean
        ...
        ElseIf ddlOPTION_PAY_TYPE.SelectedValue = "" Then
            ...
            Return False
        ElseIf ddlOPTION_PAY_MODE.SelectedValue = "" Then
            lblresult2.Text = "[" & lblOPTION_PAY_MODE.Text & "] Is A Required Field!"
            ddlOPTION_PAY_MODE.Focus()
            Return False
