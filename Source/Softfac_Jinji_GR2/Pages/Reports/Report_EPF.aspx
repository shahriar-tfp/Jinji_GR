<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_EPF.aspx.vb" Inherits="Pages_Reports_Report_EPF" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Report - EPF</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="Report_EPF" runat="server">
    <div>
    ...
    <asp:imagebutton id="imgBtnPrintBBCD" runat="server" Width="74" Height="21" OnClientClick="return confirm('Confirmation! Print BBCD Report. ?')"></asp:imagebutton>
