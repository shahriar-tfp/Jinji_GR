...
Partial Class PAGES_REPORTS_RPT_PIVOTABLE_ANALYSIS_PERSONAL
            ...
            For Me.i = 0 To myGridView.Rows.Count - 1
                ...
                If chkEdit.Checked Then
                    If Request.ServerVariables("SERVER_PORT") = "80" Then
                        If Request.ApplicationPath = "" Then
                            If Left(myGridView.Rows(i).Cells(6).Text, 22) = "rdPage.aspx?rdTemplate" Then
                                Url1 = "http://" + Request.ServerVariables("Server_Name") + "/" + myGridView.Rows(i).Cells(6).Text + "&Company_Profile_Code=" + Session("Company") + "&User_Profile_Code=" + Session("EmpID")
                            Else
                                Url1 = "http://" + Request.ServerVariables("Server_Name") + "/" + myGridView.Rows(i).Cells(6).Text
                            End If
                        Else
                            If Left(myGridView.Rows(i).Cells(6).Text, 22) = "rdPage.aspx?rdTemplate" Then
                                Url1 = "http://" + Request.ServerVariables("Server_Name") + Request.ApplicationPath + "/" + myGridView.Rows(i).Cells(6).Text + "&Company_Profile_Code=" + Session("Company") + "&User_Profile_Code=" + Session("EmpID")
                            Else
                    ...
                    Else
                        If Request.ApplicationPath = "" Then
                            If Left(myGridView.Rows(i).Cells(6).Text, 22) = "rdPage.aspx?rdTemplate" Then
                                Url1 = "http://" + Request.ServerVariables("Server_Name") + ":" + Request.ServerVariables("Server_Port") + "/" + myGridView.Rows(i).Cells(6).Text + "&Company_Profile_Code=" + Session("Company") + "&User_Profile_Code=" + Session("EmpID")
                            Else
                        ...
                        Else
                            If Left(myGridView.Rows(i).Cells(6).Text, 22) = "rdPage.aspx?rdTemplate" Then
                                Url1 = "http://" + Request.ServerVariables("Server_Name") + ":" + Request.ServerVariables("Server_Port") + Request.ApplicationPath + "/" + myGridView.Rows(i).Cells(6).Text + "&Company_Profile_Code=" + Session("Company") + "&User_Profile_Code=" + Session("EmpID")
                            Else
