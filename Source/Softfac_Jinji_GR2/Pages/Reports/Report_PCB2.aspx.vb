...
Partial Class Pages_Reports_Report_PCB2
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                ...
                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "YEAR" Then
                    If lblYEAR.Visible = True And txtYEAR.Visible = True Then
                        autonum += 1
                        imgKeyYEAR.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyYEAR.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyYEAR.Style.Add("position", "absolute")
                        autonum += 1
                        lblYEAR.CssClass = "wordstyle12"
                        lblYEAR.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblYEAR.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblYEAR.Style.Add("position", "absolute")
                        autonum += 1
                        txtYEAR.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        txtYEAR.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        txtYEAR.Style.Add("position", "absolute")
                        txtYEAR.Width = txtWidth
                        autonum += 1
                        imgbtnYEAR.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnYEAR.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnYEAR.Style.Add("position", "absolute")
                    End If
                End If

                If UCase(myDS.Tables(0).Rows(i).Item(1).ToString) = "OPTION_LOCATION" Then
                    If lblOPTION_LOCATION.Visible = True And ddlOPTION_LOCATION.Visible = True Then
                        autonum += 1
                        imgKeyOPTION_LOCATION.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgKeyOPTION_LOCATION.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgKeyOPTION_LOCATION.Style.Add("position", "absolute")
                        autonum += 1
                        lblOPTION_LOCATION.CssClass = "wordstyle12"
                        lblOPTION_LOCATION.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        lblOPTION_LOCATION.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        lblOPTION_LOCATION.Style.Add("position", "absolute")
                        autonum += 1
                        ddlOPTION_LOCATION.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        ddlOPTION_LOCATION.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        ddlOPTION_LOCATION.Style.Add("position", "absolute")
                        ddlOPTION_LOCATION.Width = ddlWidth
                        autonum += 1
                        imgbtnOPTION_LOCATION.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum, "X"))
                        imgbtnOPTION_LOCATION.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum, "Y"))
                        imgbtnOPTION_LOCATION.Style.Add("position", "absolute")
                    End If
                End If
...
#End Region
            ...
            If ValidatePrint(myDS) = True Then
                If myDS.Tables(0).Rows.Count = 1 Then
                    ...
                    For k = 0 To itemCount - 1
                        ...
                        ssql1 = Nothing
                    Next
                    myTargetURL = myTargetURL & "&Company_Profile_Code=" & Session("Company").ToString & "&Year=" & txtYEAR.Text & "&SpID=" & spid & "&Location=" & ddlOPTION_LOCATION.SelectedValue & "&Type=" & ddlOPTION_GROUP.SelectedValue & "&User_Profile_Code=" & Session("EmpID").ToString & "&rdTemplate=pr_GOVPCBII"
    ...
    Private Function ValidatePrint(ByVal myds As DataSet) As Boolean
        ...
        ElseIf txtYEAR.Text = "" Then
            lblresult2.Text = "[" & lblYEAR.Text & "] Is A Required Field!"
            txtYEAR.Focus()
            Return False
        ElseIf IsNumeric(txtYEAR.Text) = False Or Len(txtYEAR.Text) <> 4 Then
            lblresult2.Text = "Invalid Input Numeric Format For [" & lblYEAR.Text & "]!"
            txtYEAR.Focus()
            Return False
