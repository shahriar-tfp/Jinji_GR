<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_TabungHaji.aspx.vb" Inherits="Pages_Reports_Report_TabungHaji" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Report CP21</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="Report_TabungHaji" runat="server">
    <div>
   ...
   <asp:ImageButton ID="imgKeyYEAR_MONTH" runat="server" Width="21px" Height="21px"/>
    ...
    <asp:imagebutton id="imgKeyCHEQUE" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblCHEQUE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtCHEQUE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnCHEQUE" runat="server" Height="21px" Visible="false"></asp:imagebutton>
