...
Partial Class Pages_Reports_Report_CP22A_Set
...
#Region "Panel Edit"
    ...
    Protected Sub imgbtnGROUP_CODE2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnGROUP_CODE2.Click
        ...
        lstleft.Items.Clear()
        lstright.Items.Clear()
        ssql = "Exec sp_sa_getListBoxValue 'cp22a_set','" & Session("Company") & "','" & ddlOPTION_FIELD.SelectedValue & "','" & ddlOPTION_CATEGORIZE.SelectedValue & "','" & """" & "','','',''"
        ...
        If ((Session("Option1") = ddlOPTION_FIELD.SelectedValue) And (Session("Option2") = ddlOPTION_CATEGORIZE.SelectedValue)) Then
            ...
            If ValidatePrint(myDS) = True Then
                ...
                For k = 0 To itemCount - 1
                    ssql1 = "exec sp_pr_insReport_Field '" & Form.ID & "','" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & lstright.Items(k).Value & "','" & ddlOPTION_FIELD.SelectedValue & "','" & ddlOPTION_CATEGORIZE.SelectedValue() & "','ADD'"
                    myDS1 = New DataSet()
                    myDS1 = mySQL.ExecuteSQL(ssql1)
                    myDS1 = Nothing
                    ssql1 = Nothing
            ...
            Session.Remove("Option1")
            Session.Remove("Option2")
        Else
            lblresult2.Text = "Sorry, you can't update."
        End If
