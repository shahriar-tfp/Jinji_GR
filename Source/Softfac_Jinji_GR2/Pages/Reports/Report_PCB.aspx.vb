...
Partial Class Pages_Reports_Report_PCB
    ...
    Protected Sub imgBtnSaveAs_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSaveAs.Click
        ...
        If ValidatePrint(myDS) = True Then
            If myDS.Tables(0).Rows.Count = 1 Then
                ...
                If ddlOPTION_REPORT.SelectedValue = "PCB" Then
                    ssql1 = "Exec sp_pr_SelPCBDetail '" & myDS.Tables(0).Rows(0).Item(0).ToString & "'," & myDS.Tables(0).Rows(0).Item(1).ToString & "," & myDS.Tables(0).Rows(0).Item(2).ToString & ",'" & myDS.Tables(0).Rows(0).Item(4).ToString & "'"
                    myDS1 = New DataSet
                    ...
                    Str = Nothing
                ElseIf ddlOPTION_REPORT.SelectedValue = "CP39A" Then
                    ssql1 = "Exec sp_pr_SelCP39ADetail '" & myDS.Tables(0).Rows(0).Item(0).ToString & "'," & myDS.Tables(0).Rows(0).Item(1).ToString & "," & myDS.Tables(0).Rows(0).Item(2).ToString & ",'" & myDS.Tables(0).Rows(0).Item(4).ToString & "'"
                    myDS1 = New DataSet
                    myDS1 = mySQL.ExecuteSQL(ssql1)
                    Response.ContentType = "Text/plain"
                    Response.AppendHeader("Content-Disposition", "attachment; filename=FileName.txt")
