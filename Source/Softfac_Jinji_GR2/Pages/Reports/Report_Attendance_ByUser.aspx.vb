...
Partial Class Pages_Reports_Report_Attendance_ByUser
            ...
            If ValidatePrint(myDS) = True Then
                If myDS.Tables(0).Rows.Count = 1 Then
                    ...
                    For k = 0 To itemCount - 1
                        ...
                        ssql1 = Nothing
                    Next
                    myTargetURL = myTargetURL & "&Company_Profile_Code=" & myDS.Tables(0).Rows(0).Item(0).ToString & "&Date_From=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&Date_To=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&User_Profile_Code=" & Session("EmpID").ToString & "&rdTemplate=Roster_Attendance_Summary"
