...
Partial Class PAGES_REPORTS_EA_FORM_MANUAL
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        mySetting.GetBtnImgUrl(imgBtnDelete1, Session("Company").ToString, btnColourDef, "btnDelete.png")
...
#Region "Panel Edit"
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        lblresult2.Text = ""
        Try
            ssql = "select dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),dbo.fn_ReturnEmpIDByCodeName('" & Session("Company") & "','" & txtEMPLOYEE_PROFILE_ID.Text & "'),dbo.fn_getOCPIDBYCODENAME(N'" & txtOCP_ID.Text & "','DIVISION')"
            myDS = New DataSet()
            myDS = mySQL.ExecuteSQL(ssql)
            If ValidateAutoFill(myDS) Then
                ssql2 = "Exec sp_pr_insupddelEAManual 'INS','" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & _
                myDS.Tables(0).Rows(0).Item(1).ToString & "','" & txtYEAR.Text & "','" & txtALLOWANCE_1.Text & "','" & _
                txtALLOWANCE_2.Text & "','" & txtALLOWANCE_3.Text & "','" & txtALLOWANCE_4.Text & "','" & _
                txtALLOWANCE_5.Text & "','" & txtALLOWANCE_6.Text & "','" & txtALLOWANCE_7.Text & "','" & _
                txtALLOWANCE_8.Text & "','" & txtALLOWANCE_9.Text & "','" & txtALLOWANCE_10.Text & "','" & _
                txtALLOWANCE_11.Text & "','" & txtALLOWANCE_12.Text & "','" & txtALLOWANCE_13.Text & "','" & _
                txtALLOWANCE_14.Text & "','" & txtALLOWANCE_15.Text & "','" & txtALLOWANCE_16.Text & "','" & _
                txtALLOWANCE_17.Text & "','" & txtALLOWANCE_18.Text & "','" & txtALLOWANCE_19.Text & "','" & _
                txtALLOWANCE_20.Text & "','" & txtALLOWANCE_21.Text & "','" & txtALLOWANCE_22.Text & "','" & _
                txtEPF_EMPLOYEE.Text & "','" & txtPCB.Text & "','" & txtCP38.Text & "','" & _
                txtZAKAT.Text & "','" & txtJOIN_DATE.Text & "','" & txtRESIGN_DATE.Text & "','" & _
                txtBONUS_FROM.Text & "','" & txtBONUS_TO.Text & "','" & txtOTHER_SALARY.Text & "','" & _
                txtCAR_DATE.Text & "','" & txtCAR_TYPE.Text & "','" & txtCAR_YEAR.Text & "','" & _
                txtCAR_MODEL.Text & "','" & txtHOUSE_ADDRESS.Text & "','" & ddlOPTION_BLOCK.SelectedValue & "','" & myDS.Tables(0).Rows(0).Item(2).ToString & "'"
                mySQL.ExecuteSQL(ssql2, Session("Company").ToString, Session("EmpID").ToString)
            End If
            ssql = Nothing
            myDS = Nothing
            ssql2 = Nothing
        ...
        Catch ex As Exception
            ...
            strScript &= "<" & "/script>"
            Page.ClientScript.RegisterClientScriptBlock(Me.GetType, "Update Error!", strScript)
        End Try
    End Sub
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnAdd.Click
        ...
        imgBtnDelete1.CssClass = buttonPosition2
...
#End Region
    ...
    Protected Sub txtYEAR_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtYEAR.TextChanged
        If IsNumeric(txtYEAR.Text) And Len(txtYEAR.Text) = 4 Then
            AutoFillData()
        End If
    End Sub
    Private Sub AutoFillData()
        ...
        myDS = mySQL.ExecuteSQL(ssql)
        If ValidateAutoFill(myDS) Then
            ssql1 = "exec sp_pr_insupddelEAManual 'Search','" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" _
            & txtYEAR.Text & "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" & myDS.Tables(0).Rows(0).Item(2).ToString & "'"
            myDS2 = New DataSet()
            myDS2 = mySQL.ExecuteSQL(ssql1)
            If myDS2.Tables.Count > 0 Then
                If myDS2.Tables(0).Rows.Count > 0 Then
                    txtALLOWANCE_1.Text = myDS2.Tables(0).Rows(0).Item(0).ToString
                    txtALLOWANCE_2.Text = myDS2.Tables(0).Rows(0).Item(1).ToString
                    txtALLOWANCE_3.Text = myDS2.Tables(0).Rows(0).Item(2).ToString
                    txtALLOWANCE_4.Text = myDS2.Tables(0).Rows(0).Item(3).ToString
                    txtALLOWANCE_5.Text = myDS2.Tables(0).Rows(0).Item(4).ToString
                    txtALLOWANCE_6.Text = myDS2.Tables(0).Rows(0).Item(5).ToString
                    txtALLOWANCE_7.Text = myDS2.Tables(0).Rows(0).Item(6).ToString
                    txtALLOWANCE_8.Text = myDS2.Tables(0).Rows(0).Item(7).ToString
                    txtALLOWANCE_9.Text = myDS2.Tables(0).Rows(0).Item(8).ToString
                    txtALLOWANCE_10.Text = myDS2.Tables(0).Rows(0).Item(9).ToString
                    txtALLOWANCE_11.Text = myDS2.Tables(0).Rows(0).Item(10).ToString
                    txtALLOWANCE_12.Text = myDS2.Tables(0).Rows(0).Item(11).ToString
                    txtALLOWANCE_13.Text = myDS2.Tables(0).Rows(0).Item(12).ToString
                    txtALLOWANCE_14.Text = myDS2.Tables(0).Rows(0).Item(13).ToString
                    txtALLOWANCE_15.Text = myDS2.Tables(0).Rows(0).Item(14).ToString
                    txtALLOWANCE_16.Text = myDS2.Tables(0).Rows(0).Item(15).ToString
                    txtALLOWANCE_17.Text = myDS2.Tables(0).Rows(0).Item(16).ToString
                    txtALLOWANCE_18.Text = myDS2.Tables(0).Rows(0).Item(17).ToString
                    txtALLOWANCE_19.Text = myDS2.Tables(0).Rows(0).Item(18).ToString
                    txtALLOWANCE_20.Text = myDS2.Tables(0).Rows(0).Item(19).ToString
                    txtALLOWANCE_21.Text = myDS2.Tables(0).Rows(0).Item(20).ToString
                    txtALLOWANCE_22.Text = myDS2.Tables(0).Rows(0).Item(21).ToString
                    txtEPF_EMPLOYEE.Text = myDS2.Tables(0).Rows(0).Item(22).ToString
                    txtPCB.Text = myDS2.Tables(0).Rows(0).Item(23).ToString
                    txtCP38.Text = myDS2.Tables(0).Rows(0).Item(24).ToString
                    txtZAKAT.Text = myDS2.Tables(0).Rows(0).Item(25).ToString
                    txtJOIN_DATE.Text = myDS2.Tables(0).Rows(0).Item(26).ToString
                    txtRESIGN_DATE.Text = myDS2.Tables(0).Rows(0).Item(27).ToString
                    txtBONUS_FROM.Text = myDS2.Tables(0).Rows(0).Item(28).ToString
                    txtBONUS_TO.Text = myDS2.Tables(0).Rows(0).Item(29).ToString
                    txtOTHER_SALARY.Text = myDS2.Tables(0).Rows(0).Item(30).ToString
                    txtCAR_DATE.Text = myDS2.Tables(0).Rows(0).Item(31).ToString
                    txtCAR_TYPE.Text = myDS2.Tables(0).Rows(0).Item(32).ToString
                    txtCAR_YEAR.Text = myDS2.Tables(0).Rows(0).Item(33).ToString
                    txtCAR_MODEL.Text = myDS2.Tables(0).Rows(0).Item(34).ToString
                    txtHOUSE_ADDRESS.Text = myDS2.Tables(0).Rows(0).Item(35).ToString
                    ddlOPTION_BLOCK.SelectedValue = myDS2.Tables(0).Rows(0).Item(36).ToString
                Else
                    txtALLOWANCE_1.Text = ""
                    txtALLOWANCE_2.Text = ""
                    txtALLOWANCE_3.Text = ""
                    ...
                    txtALLOWANCE_8.Text = ""
                    txtALLOWANCE_9.Text = ""
                    txtALLOWANCE_10.Text = ""
                    txtALLOWANCE_11.Text = ""
                    txtALLOWANCE_12.Text = ""
                    txtALLOWANCE_13.Text = ""
                    txtALLOWANCE_14.Text = ""
                    txtALLOWANCE_15.Text = ""
                    txtALLOWANCE_16.Text = ""
                    txtALLOWANCE_17.Text = ""
                    txtALLOWANCE_18.Text = ""
                    txtALLOWANCE_19.Text = ""
                    txtALLOWANCE_20.Text = ""
                    txtALLOWANCE_21.Text = ""
                    txtALLOWANCE_22.Text = ""
                    txtEPF_EMPLOYEE.Text = ""
                    txtPCB.Text = ""
                    txtCP38.Text = ""
                    txtZAKAT.Text = ""
                    txtJOIN_DATE.Text = ""
                    ...
                    txtBONUS_FROM.Text = ""
                    txtBONUS_TO.Text = ""
                    txtOTHER_SALARY.Text = ""
                    txtCAR_DATE.Text = ""
                    txtCAR_TYPE.Text = ""
                    txtCAR_YEAR.Text = ""
                    txtCAR_MODEL.Text = ""
                    txtHOUSE_ADDRESS.Text = ""
                    ddlOPTION_BLOCK.SelectedValue = ""
                End If
            End If
        End If
    End Sub
    Private Function ValidateAutoFill(ByVal myds As DataSet) As Boolean
        ...
        ElseIf Not IsNumeric(txtYEAR.Text) Then
            lblresult2.Text = "[" & lblYEAR.Text & "] Is Not Numeric!"
            txtYEAR.Focus()
            Return False
        ElseIf Len(txtYEAR.Text) <> 4 Then
            lblresult2.Text = "[" & lblYEAR.Text & "] Is Not Correct Year Format!"
            txtYEAR.Focus()
            Return False
        Else
            Return True
    ...
    Protected Sub imgBtnDelete1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnDelete1.Click
        Try
            ssql = "select dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),dbo.fn_ReturnEmpIDByCodeName('" & Session("Company") & "','" & txtEMPLOYEE_PROFILE_ID.Text & "'),dbo.fn_getOCPIDBYCODENAME(N'" & txtOCP_ID.Text & "','DIVISION')"
            myDS = New DataSet()
            myDS = mySQL.ExecuteSQL(ssql)
            If ValidateAutoFill(myDS) Then
                ssql1 = "exec sp_pr_insupddelEAManual 'DEL','" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "','" _
                & txtYEAR.Text & "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" & myDS.Tables(0).Rows(0).Item(2).ToString & "'"
                mySQL.ExecuteSQL(ssql1)
            End If
            ssql = Nothing
            ssql2 = Nothing
            myDS = Nothing
        ...
        Catch ex As Exception
            ...
            strScript &= "alert('" & ex.Message & "!');"
            strScript &= "<" & "/script>"
            Page.ClientScript.RegisterClientScriptBlock(Me.GetType, "Delete Error!", strScript)
        End Try
    End Sub
End Class