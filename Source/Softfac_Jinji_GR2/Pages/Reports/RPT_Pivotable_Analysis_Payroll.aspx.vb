...
Partial Class PAGES_REPORTS_RPT_PIVOTABLE_ANALYSIS_PAYROLL
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        mySetting.GetBtnImgUrl(imgBtnPrintReport, Session("Company").ToString, btnColourDef, "btnQuery.png")
        ...
        If myDS.Tables.Count > 1 Then
            ...
            ddlMonthssql = "Create Table #Result([Code] nvarchar(50), [Name] nvarchar(255)); Insert Into #Result Select '',''; Insert Into #Result Select '0','All Month';"
            ...
            If myDT1.Rows.Count > 0 Then
                ...
                imgBtnPrintReport.Visible = AllowPrint
            End If
...
#End Region
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        ...
        Url1 = Request.ServerVariables("Server_Name") + ":" + Request.ServerVariables("Server_Port") + Request.ApplicationPath
    ...
    End Sub
    Protected Sub imgBtnPrintReport_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrintReport.Click
        CountRecord = 0
        For Me.i = 0 To myGridView.Rows.Count - 1
            Dim chkEdit As CheckBox = myGridView.Rows(i).Cells(0).Controls(1)
            If chkEdit.Checked Then
        ...
        Next
        If CountRecord > 1 Then
            ShowMessage("You select " & CStr(CountRecord) & " rows for Query, which is invalid. Please select only 1 row!")
        ElseIf CountRecord = 0 Then
            ShowMessage("No row selected for Query. Please select at least one row!")
        Else
            Dim Url1 As String
            Url1 = ""
            If ddlMonth.SelectedValue = "" Then
                ShowMessage("No Month Selected for Query. Please select Month!")
                ddlMonth.Focus()
                Exit Sub
            End If
            If ddlYear.SelectedValue = "" Then
                ShowMessage("No Year Selected for Query. Please select Year!")
                ddlYear.Focus()
                Exit Sub
            End If
            For Me.i = 0 To myGridView.Rows.Count - 1
                ...
                If chkEdit.Checked Then
                    If Request.ServerVariables("SERVER_PORT") = "80" Then
                        If Request.ApplicationPath = "" Then
                            If Left(myGridView.Rows(i).Cells(6).Text, 22) = "rdPage.aspx?rdTemplate" Then
                                Url1 = "http://" + Request.ServerVariables("Server_Name") + "/" + myGridView.Rows(i).Cells(6).Text + "&Company_Profile_Code=" + Session("Company") + "&User_Profile_Code=" + Session("EmpID") + "&Month=" + ddlMonth.SelectedValue + "&Year=" + ddlYear.SelectedValue
                            Else
                                Url1 = "http://" + Request.ServerVariables("Server_Name") + "/" + myGridView.Rows(i).Cells(6).Text
                            End If
                        Else
                            If Left(myGridView.Rows(i).Cells(6).Text, 22) = "rdPage.aspx?rdTemplate" Then
                                Url1 = "http://" + Request.ServerVariables("Server_Name") + Request.ApplicationPath + "/" + myGridView.Rows(i).Cells(6).Text + "&Company_Profile_Code=" + Session("Company") + "&User_Profile_Code=" + Session("EmpID") + "&Month=" + ddlMonth.SelectedValue + "&Year=" + ddlYear.SelectedValue
                            Else
                                Url1 = "http://" + Request.ServerVariables("Server_Name") + Request.ApplicationPath + "/" + myGridView.Rows(i).Cells(6).Text
                            End If
                        End If
                    Else
                        If Request.ApplicationPath = "" Then
                            If Left(myGridView.Rows(i).Cells(6).Text, 22) = "rdPage.aspx?rdTemplate" Then
                                Url1 = "http://" + Request.ServerVariables("Server_Name") + ":" + Request.ServerVariables("Server_Port") + "/" + myGridView.Rows(i).Cells(6).Text + "&Company_Profile_Code=" + Session("Company") + "&User_Profile_Code=" + Session("EmpID") + "&Month=" + ddlMonth.SelectedValue + "&Year=" + ddlYear.SelectedValue
                            Else
                                Url1 = "http://" + Request.ServerVariables("Server_Name") + ":" + Request.ServerVariables("Server_Port") + "/" + myGridView.Rows(i).Cells(6).Text
                            End If

                        Else
                            If Left(myGridView.Rows(i).Cells(6).Text, 22) = "rdPage.aspx?rdTemplate" Then
                                Url1 = "http://" + Request.ServerVariables("Server_Name") + ":" + Request.ServerVariables("Server_Port") + Request.ApplicationPath + "/" + myGridView.Rows(i).Cells(6).Text + "&Company_Profile_Code=" + Session("Company") + "&User_Profile_Code=" + Session("EmpID") + "&Month=" + ddlMonth.SelectedValue + "&Year=" + ddlYear.SelectedValue
                            Else
                                Url1 = "http://" + Request.ServerVariables("Server_Name") + ":" + Request.ServerVariables("Server_Port") + Request.ApplicationPath + "/" + myGridView.Rows(i).Cells(6).Text
                            End If
                ...
                End If
            Next
            Response.Write("<script>window.open('" & Url1 & "');</script>")
        End If
    End Sub
End Class