...
Partial Class Pages_Reports_Report_TabungHaji
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        ...
        If ValidatePrint(myDS) = True Then
            If myDS.Tables(0).Rows.Count = 1 Then
                myTargetURL = myTargetURL & "&RegNo=" & myDS.Tables(0).Rows(0).Item(0).ToString & "&Month=" & myDS.Tables(0).Rows(0).Item(1).ToString & "&Year=" & myDS.Tables(0).Rows(0).Item(2).ToString & "&PIC=" & myDS.Tables(0).Rows(0).Item(3).ToString & "&Cheque=" & myDS.Tables(0).Rows(0).Item(4).ToString & "&rdTemplate=pr_TabungHaji"
