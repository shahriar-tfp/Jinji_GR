        ...
        If ValidatePrint(myDS) = True Then
            If myDS.Tables(0).Rows.Count = 1 Then
                If ddlOPTION_REPORT.SelectedValue = "PAY" Then
                    ssql1 = "Exec sp_pr_InsAps '" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & ddlOPTION_BANK.SelectedValue & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "'," & myDS.Tables(0).Rows(0).Item(2).ToString & ",'" & ddlOPTION_PAY_TYPE.SelectedValue & "','" & ddlOPTION_PAY_CYCLE.SelectedValue & "','PAYROLL','" & myDS.Tables(0).Rows(0).Item(4).ToString & "'"
                ElseIf ddlOPTION_REPORT.SelectedValue = "ADVANCE" Then
                    ssql1 = "Exec sp_pr_InsAps '" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & ddlOPTION_BANK.SelectedValue & "','" & myDS.Tables(0).Rows(0).Item(1).ToString & "'," & myDS.Tables(0).Rows(0).Item(2).ToString & ",'" & ddlOPTION_PAY_TYPE.SelectedValue & "','" & ddlOPTION_PAY_CYCLE.SelectedValue & "','ADVANCE','" & myDS.Tables(0).Rows(0).Item(4).ToString & "'"
                Else
