<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MEDICAL_TRANSACTION.aspx.vb" Inherits="PAGES_MEDICAL_MEDICAL_TRANSACTION" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>MEDICAL_TRANSACTION</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="MEDICAL_TRANSACTION" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyCLAIMTYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCLAIMTYPE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCLAIMTYPE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCLAIMTYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyPANELDOCTOR_PROFILE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPANELDOCTOR_PROFILE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPANELDOCTOR_PROFILE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPANELDOCTOR_PROFILE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyBENEFICIARYVISITER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblBENEFICIARYVISITER" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtBENEFICIARYVISITER" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnBENEFICIARYVISITER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyVISITDATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblVISITDATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtVISITDATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnVISITDATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 8 //-->
<asp:imagebutton id="imgKeyENTITLEMENTAMT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblENTITLEMENTAMT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtENTITLEMENTAMT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnENTITLEMENTAMT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 9 //-->
<asp:imagebutton id="imgKeyUPTODATE_BALANCE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblUPTODATE_BALANCE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtUPTODATE_BALANCE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnUPTODATE_BALANCE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 10 //-->
<asp:imagebutton id="imgKeyAUTOAPPROVALNO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblAUTOAPPROVALNO" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtAUTOAPPROVALNO" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnAUTOAPPROVALNO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 11 //-->
<asp:imagebutton id="imgKeyCLAIMAMT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCLAIMAMT" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCLAIMAMT" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCLAIMAMT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// GST //-->
    ...
    <asp:imagebutton id="imgKeyBILLGSTAMT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblBILLGSTAMT" runat="server" Width="140px" ></asp:label>
    <asp:textbox id="txtBILLGSTAMT" runat="server" Width="150px" ></asp:textbox>
    <asp:imagebutton id="imgbtnBILLGSTAMT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

    <asp:imagebutton id="imgKeyBILLB4GSTAMT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblBILLB4GSTAMT" runat="server" Width="140px" ></asp:label>
    <asp:textbox id="txtBILLB4GSTAMT" runat="server" Width="150px" ></asp:textbox>
    <asp:imagebutton id="imgbtnBILLB4GSTAMT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

    <asp:imagebutton id="imgKeyBILLGSTNO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblBILLGSTNO" runat="server" Width="140px" ></asp:label>
    <asp:textbox id="txtBILLGSTNO" runat="server" Width="150px" ></asp:textbox>
    <asp:imagebutton id="imgbtnBILLGSTNO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

    <asp:imagebutton id="imgKeyCustomerName" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblCustomerName" runat="server" Width="140px" ></asp:label>
    <asp:dropdownlist id="ddlCustomerName" runat="server" Width="150px" ></asp:dropdownlist>
    <asp:imagebutton id="imgbtnCustomerName" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

    <asp:imagebutton id="imgKeyInvoiceType" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblInvoiceType" runat="server" Width="140px" ></asp:label>
    <asp:dropdownlist id="ddlInvoiceType" runat="server" Width="150px" ></asp:dropdownlist>
    <asp:imagebutton id="imgbtnInvoiceType" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
