...
Partial Class Pages_InformationSystem_Employee_Statutory
                            ...
                            Select Case UCase(Trim(myDS1.Tables(0).Rows(j).Item(dt).ToString))
                                Case "OPTION"
                                    ...
                                    Else
                                        ...
                                        If myDS1.Tables(0).Rows(j).Item(1).ToString.Trim = "OPTION_TYPE_STATUTORY" Then
                                            ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID_TYPE" & """," & "" & """" & """," & """" & Session("EmpID").ToString & """," & """" & ddlOPTION_TYPE_STATUTORY.SelectedValue & """"
                                            imgbtnOCP_ID_TYPE.Attributes.Remove("onclick")

                                            mySetting.GetLookupValue_ImageButton(imgbtnOCP_ID_TYPE, Form.ID, "txtOCP_ID_TYPE", "CodeName", "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID_TYPE" & """," & """" & """," & """" & Session("EmpID").ToString & """," & """" & ddlOPTION_TYPE_STATUTORY.SelectedValue & """")
                                        End If
                                    End If
                                Case Else
                            ...
                            If gvHistory.HeaderRow.Cells(intColumn).Text.ToString = myDS.Tables(0).Rows(j).Item(2).ToString Then
                                Select Case myDS.Tables(0).Rows(j).Item(1).ToString.Trim
                                    Case "OPTION"
                                        ...
                                        myDDL = Nothing
                                        If myDS.Tables(0).Rows(j).Item(0).ToString.Trim = "OPTION_TYPE_STATUTORY" Then
                                            ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID_TYPE" & """," & "" & """" & """," & """" & Session("EmpID").ToString & """," & """" & ddlOPTION_TYPE_STATUTORY.SelectedValue & """"
                                            imgbtnOCP_ID_TYPE.Attributes.Remove("onclick")
                                            mySetting.GetLookupValue_ImageButton(imgbtnOCP_ID_TYPE, Form.ID, "txtOCP_ID_TYPE", "CodeName", "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID_TYPE" & """," & """" & """," & """" & Session("EmpID").ToString & """," & """" & ddlOPTION_TYPE_STATUTORY.SelectedValue & """")
                                        End If
                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        Else
                                            If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_TYPE" Then
                                                ssql2 = ssql2 & "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_TYPE_STATUTORY.SelectedValue.ToString & "'),''),"
                                            Else
                                        ...
                                        If myDS.Tables(0).Rows(i).Item(6).ToString = "YES" Then
                                            ...
                                            Else
                                                If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_TYPE" Then
                                                    ssql3 = ssql3 & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_TYPE_STATUTORY.SelectedValue.ToString & "'),0) And "
                                                Else
                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        Else
                                            If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_TYPE" Then
                                                ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_TYPE_STATUTORY.SelectedValue.ToString & "'),''),"
                                            Else
                                ...
                                If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                    ...
                                    Else
                                        ...
                                        If myDST2.Tables(0).Rows.Count > 0 Then
                                            ...
                                            Else
                                                If myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_TYPE" Then
                                                    ssql = ssql & myDS2.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST2.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_TYPE_STATUTORY.SelectedValue.ToString & "'),'') And "
                                                Else
...
#End Region
    ...
    Protected Sub ddlOPTION_TYPE_STATUTORY_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOPTION_TYPE_STATUTORY.SelectedIndexChanged
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID_TYPE" & """," & "" & """" & """," & """" & Session("EmpID").ToString & """," & """" & ddlOPTION_TYPE_STATUTORY.SelectedValue & """"
        imgbtnOCP_ID_TYPE.Attributes.Remove("onclick")
    ...
    Private Sub SetLabelValueDisplayText()
        If ddlOPTION_TYPE_STATUTORY.SelectedValue <> "" Then
            lblVALUE.Text = ddlOPTION_TYPE_STATUTORY.SelectedItem.Text.ToString
        Else
            lblVALUE.Text = "Value"
        End If
    End Sub
