...
Partial Class Pages_InformationSystem_Employee_Status
    Inherits System.Web.UI.Page

#Region "Public Declaration"
    Private WithEvents mySQL As New clsSQL, myDS, myDS2, tmpDS1, tmpDS2, tmpDS3, tmpDS4, tmpDS5, tmpDS6 As New DataSet, mySetting As New clsGlobalSetting
    ...
    Dim logic As Boolean = False
    Dim curDivDll As String = ""
#End Region
...
#Region "Private Declaration"
    ...
    Dim EMPID As String, Job_Grade As String = "NULL", Job_Title As String = "NULL", Appraisal As String = "NULL"
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        ...
        'mySetting.GetBtnImgUrl(imgbtnPrint2, Session("Company").ToString, btnColourDef, "btnPrint.png")
        ...
        'bind division fielddropdownlist
        BindDivision()
        'bind department fielddropdownlist
        BindDepartment()
        'bind section fielddropdownlist
        BindSection()
        'bind line fielddropdownlist
        BindLine()
        'bind group fielddropdownlist
        BindGroup()
        'bind process fielddropdownlist
        BindProcess()
        'bind job grade fielddropdownlist
        BindJobGrade()
        'bind job title field dropdownlist
        BindJobTitle()
        'Bind EmployeeGroup
        BindEmployeeGroup()
        ...
        Try
            ...
            If CType(Session("SearchByFilter"), Boolean) = True Then
                If SearchByPage = True Then
                    ssql = Session("SearchSQL").ToString.Trim & txtGoToPage.Text & "'"
                    ssql2 = Session("SearchSQL1").ToString.Trim & txtGoToPage.Text & "'"
                Else
            ...
            Else
                ...
                'End If
                If SearchByPage = True Then
                    ssql = "Exec sp_sa_FilterTableRecords N'" & Session("Company").ToString & "',N'" & Session("EmpID").ToString & "',N'" & _
                                Session("Module").ToString & "',N'" & Form.ID & "',N'EMPLOYEE_PROFILE_ID',N'%','" & myGridView.PageSize & "','" & txtGoToPage.Text & "'"
                    ssql2 = "Exec sp_sa_FilterCompareTableRecords N'" & Session("Company").ToString & "',N'" & Session("EmpID").ToString & "',N'" & _
                            Session("Module").ToString & "',N'" & Form.ID & "',N'EMPLOYEE_PROFILE_ID',N'%','" & gvHistory.PageSize & "','" & txtGoToPage.Text & "'"
                Else
                    ssql = "Exec sp_sa_FilterTableRecords N'" & Session("Company").ToString & "',N'" & Session("EmpID").ToString & "',N'" & _
                            Session("Module").ToString & "',N'" & Form.ID & "',N'EMPLOYEE_PROFILE_ID',N'%','" & myGridView.PageSize & "','" & _currentPageNumber & "'"
                    ssql2 = "Exec sp_sa_FilterCompareTableRecords N'" & Session("Company").ToString & "',N'" & Session("EmpID").ToString & "',N'" & _
                            Session("Module").ToString & "',N'" & Form.ID & "',N'EMPLOYEE_PROFILE_ID',N'%','" & gvHistory.PageSize & "','" & _currentPageNumber & "'"
                End If
...
#Region "Panel Edit"
    ...
    Protected Sub imgBtnUpdate_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpdate.Click
        If ValidateUpdate() Then
            myDS = New DataSet
            ssql2 = "Select Distinct year,month from Employee_Payroll_Header a, " & Form.ID & " b where a.Employee_Profile_ID = " & EMPID & ""
            myDS = mySQL.ExecuteSQL(ssql2, Session("Company").ToString, Session("EmpID").ToString)
            If myDS.Tables(0).Rows.Count <= 1 Then
                ssql3 = "Update Employee_Increment set "
                If Job_Grade <> "NULL" Then
                    ssql3 = ssql3 & "OCP_ID_Job_Grade_OLD = " & Job_Grade & ",OCP_ID_Job_Grade_NEW = " & Job_Grade & ","
                End If
                If Job_Title <> "NULL" Then
                    ssql3 = ssql3 & "OCP_ID_Job_Title_OLD = " & Job_Title & ",OCP_ID_Job_Title_NEW = " & Job_Title & ","
                End If
                If Appraisal <> "NULL" Then
                    ssql3 = ssql3 & "OCP_ID_Appraisal_OLD = " & Appraisal & ",OCP_ID_Appraisal_NEW = " & Appraisal & ","
                End If
                If ssql3 <> "Update Employee_Increment set " Then
                    ssql3 = ssql3 & "DateTime_Modify = dbo.fn_GetCurrentDatetime(getdate()),User_Profile_Code_Modify = '" & Session("EMPID").ToString & "' where Employee_Profile_ID = " & EMPID & " and Option_Type_Increment = 'NEW_JOIN'"
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnGoToPage_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnGoToPage.Click
        If Trim(txtGoToPage.Text) <> "" Then
            If CInt(txtGoToPage.Text) <= CInt(Session("TotalPages")) And CInt(txtGoToPage.Text) > 0 Then
                SearchByPage = True
                BindGrid()
            Else
                ...
                If chkEdit.Checked Then
                    ...
                    For Me.j = 0 To myDS.Tables(0).Rows.Count - 1
                        For Me.intColumn = 1 To gvHistory.HeaderRow.Cells.Count - 1
                            Dim header As String, tablecode As String
                            header = gvHistory.HeaderRow.Cells(intColumn).Text.ToString
                            tablecode = myDS.Tables(0).Rows(j).Item(2).ToString
                            If gvHistory.HeaderRow.Cells(intColumn).Text.ToString = myDS.Tables(0).Rows(j).Item(2).ToString Then
                                Select Case myDS.Tables(0).Rows(j).Item(1).ToString.Trim
                                    Case "OPTION"
                                        ...
                                        myDDL = Nothing
                                        If myDS.Tables(0).Rows(j).Item(0).ToString.Trim = "OCP_ID_JOB_GRADE" Then
                                            ddlOCP_ID_JOB_GRADE_SelectedIndexChanged(Nothing, Nothing)
                                        ElseIf myDS.Tables(0).Rows(j).Item(0).ToString.Trim = "OCP_ID_DIVISION" Then
                                            ddlOCP_ID_DIVISION_SelectedIndexChanged(Nothing, Nothing)
                                        ElseIf myDS.Tables(0).Rows(j).Item(0).ToString.Trim = "OCP_ID_DEPARTMENT" Then
                                            ddlOCP_ID_DEPARTMENT_SelectedIndexChanged(Nothing, Nothing)
                                        ElseIf myDS.Tables(0).Rows(j).Item(0).ToString.Trim = "OCP_ID_SECTION" Then
                                            ddlOCP_ID_SECTION_SelectedIndexChanged(Nothing, Nothing)
                                        ElseIf myDS.Tables(0).Rows(j).Item(0).ToString.Trim = "OCP_ID_LINE" Then
                                            ddlOCP_ID_LINE_SelectedIndexChanged(Nothing, Nothing)
                                        ElseIf myDS.Tables(0).Rows(j).Item(0).ToString.Trim = "OCP_ID_GROUP" Then
                                            ddlOCP_ID_GROUP_SelectedIndexChanged(Nothing, Nothing)
                                        End If
                                    Case Else
    ...
    Protected Sub ddlOCP_ID_JOB_GRADE_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_JOB_GRADE.SelectedIndexChanged
        ssql2 = "Select * from parameter where company_profile_code = '" & Session("Company") & "' and code = 'JOBGROUP' and string_value1 = 'YES'"
        myDS2 = mySQL.ExecuteSQL(ssql2, Session("Company"), Session("EmpID"))

        If myDS2.Tables(0).Rows.Count > 0 Then
            'bind job title field dropdownlist
            If ddlOCP_ID_JOB_GRADE.SelectedIndex > 0 Then
                ssql = "exec [sp_org_getOCPIDObject] 'JOB_GRADE_1_1','" & Session("Company") & "','" & ddlOCP_ID_JOB_GRADE.SelectedValue.ToString & "','','','','','',''"
                Dim tmpDS As New DataSet
                tmpDS = mySQL.ExecuteSQL(ssql)
                If tmpDS.Tables.Count > 0 Then
                    If tmpDS.Tables(0).Columns.Count > 1 Then
                        ddlOCP_ID_JOB_TITLE.DataTextField = "Name"
                        ddlOCP_ID_JOB_TITLE.DataValueField = "Code"
                        ddlOCP_ID_JOB_TITLE.DataSource = tmpDS
                        ddlOCP_ID_JOB_TITLE.DataBind()
                    End If
                End If
            Else
                BindJobGrade()
                BindJobTitle()
            End If
            ddlOCP_ID_JOB_TITLE.SelectedIndex = 0
        End If
        ssql2 = Nothing
        myDS2 = Nothing
    End Sub

    Protected Sub ddlOCP_ID_JOB_TITLE_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_JOB_TITLE.SelectedIndexChanged
        ssql2 = "Select * from parameter where company_profile_code = '" & Session("Company") & "' and code = 'JOBGROUP' and string_value1 = 'YES'"
        myDS2 = mySQL.ExecuteSQL(ssql2, Session("Company"), Session("EmpID"))

        If myDS2.Tables(0).Rows.Count > 0 Then
            Dim tmpDS As New DataSet
            If ddlOCP_ID_JOB_TITLE.SelectedIndex > 0 Then
                ssql = "exec [sp_org_getOCPIDObject] 'JOB_TITLE_1_1','" & Session("Company") & "','" & ddlOCP_ID_JOB_TITLE.SelectedValue.ToString & "','','','','','',''"
                tmpDS = mySQL.ExecuteSQL(ssql)
                If tmpDS.Tables.Count > 0 Then
                    If tmpDS.Tables(0).Columns.Count > 1 Then
                        ddlOCP_ID_JOB_GRADE.DataTextField = "Name"
                        ddlOCP_ID_JOB_GRADE.DataValueField = "Code"
                        ddlOCP_ID_JOB_GRADE.DataSource = tmpDS
                        ddlOCP_ID_JOB_GRADE.DataBind()
                    End If
                    ddlOCP_ID_JOB_GRADE.SelectedIndex = tmpDS.Tables(0).Rows.Count - 1
                Else
                    ddlOCP_ID_JOB_GRADE.SelectedIndex = 0
                End If
            ElseIf ddlOCP_ID_JOB_TITLE.SelectedIndex = 0 Then
                BindJobTitle()
            End If
        End If
        ssql2 = Nothing
    ...
    Protected Sub ddlOCP_ID_DIVISION_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_DIVISION.SelectedIndexChanged

        If ddlOCP_ID_DIVISION.SelectedIndex > 0 Then
            'Filter for department dll
            ssql = "exec [sp_org_getOCPIDObject] 'DIVISION_1_1','" & Session("Company") & "','','" & ddlOCP_ID_DIVISION.SelectedValue.ToString & "','','','','',''"
            tmpDS1 = mySQL.ExecuteSQL(ssql)
            If tmpDS1.Tables.Count > 0 Then
                ddlOCP_ID_DEPARTMENT.DataTextField = "Name"
                ddlOCP_ID_DEPARTMENT.DataValueField = "Code"
                ddlOCP_ID_DEPARTMENT.DataSource = tmpDS1
                ddlOCP_ID_DEPARTMENT.DataBind()
            End If
            tmpDS1 = Nothing
            ddlOCP_ID_DEPARTMENT.SelectedIndex = 0
        Else
            ReBindOrgRelation()
        End If
    ...
    Protected Sub ddlOCP_ID_DEPARTMENT_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_DEPARTMENT.SelectedIndexChanged
        ...
        Try
            logic = False
            If ddlOCP_ID_DEPARTMENT.SelectedIndex > 0 Then
                If Not sender Is Nothing Then
                    'Filter for division ddl
                    curDivDll = ddlOCP_ID_DIVISION.SelectedValue.ToString
                    ssql = "exec [sp_org_getOCPIDObject] 'DEPARTMENT_2_1','" & Session("Company") & "','','','" & ddlOCP_ID_DEPARTMENT.SelectedValue.ToString & "','','','',''"
                    tmpDS2 = mySQL.ExecuteSQL(ssql)
                    If tmpDS2.Tables.Count > 0 Then
                        ddlOCP_ID_DIVISION.DataTextField = "Name"
                        ddlOCP_ID_DIVISION.DataValueField = "Code"
                        ddlOCP_ID_DIVISION.DataSource = tmpDS2
                        ddlOCP_ID_DIVISION.DataBind()
                    End If
                    If tmpDS2.Tables(0).Rows.Count = 2 Then
                        ddlOCP_ID_DIVISION.SelectedIndex = 1
                    Else
                        'get back prev value if hv
                        For Me.i = 0 To tmpDS2.Tables(0).Rows.Count - 1
                            If tmpDS2.Tables(0).Rows(i).Item(0).ToString = curDivDll Then
                                logic = True
                                Exit For
                            Else
                                logic = False
                        ...
                        Next
                        If logic = True Then
                            ddlOCP_ID_DIVISION.SelectedValue = curDivDll
                        Else
                            ddlOCP_ID_DIVISION.SelectedIndex = 0
                        End If
                    End If
                    tmpDS2 = Nothing
                End If

                'Filter for section ddl
                ssql = "exec [sp_org_getOCPIDObject] 'DEPARTMENT_1_1','" & Session("Company") & "','','" & ddlOCP_ID_DIVISION.SelectedValue.ToString & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue.ToString & "','','','',''"
                tmpDS2 = mySQL.ExecuteSQL(ssql)
                If tmpDS2.Tables.Count > 0 Then
                    ddlOCP_ID_SECTION.DataTextField = "Name"
                    ddlOCP_ID_SECTION.DataValueField = "Code"
                    ddlOCP_ID_SECTION.DataSource = tmpDS2
                    ddlOCP_ID_SECTION.DataBind()
                End If
                tmpDS2 = Nothing
                ddlOCP_ID_SECTION.SelectedIndex = 0
            Else
                BindDepartment()
                BindSection()
                BindLine()
                ...
                ddlOCP_ID_DEPARTMENT.SelectedIndex = 0
                ddlOCP_ID_SECTION.SelectedIndex = 0
                ddlOCP_ID_LINE.SelectedIndex = 0
                ddlOCP_ID_GROUP.SelectedIndex = 0
                ddlOCP_ID_PROCESS.SelectedIndex = 0
            End If
        Catch ex As Exception
    ...
    Protected Sub ddlOCP_ID_SECTION_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_SECTION.SelectedIndexChanged
        ...
        Try
            logic = False
            If ddlOCP_ID_SECTION.SelectedIndex > 0 Then
                If Not sender Is Nothing Then
                    'Filter for department ddl
                    curDivDll = ddlOCP_ID_DEPARTMENT.SelectedValue.ToString
                    ssql = "exec [sp_org_getOCPIDObject] 'SECTION_2_1','" & Session("Company") & "','','','','" & ddlOCP_ID_SECTION.SelectedValue.ToString & "','','',''"
                    tmpDS3 = mySQL.ExecuteSQL(ssql)
                    If tmpDS3.Tables.Count > 0 Then
                        ddlOCP_ID_DEPARTMENT.DataTextField = "Name"
                        ddlOCP_ID_DEPARTMENT.DataValueField = "Code"
                        ddlOCP_ID_DEPARTMENT.DataSource = tmpDS3
                        ddlOCP_ID_DEPARTMENT.DataBind()
                    End If
                    If tmpDS3.Tables(0).Rows.Count = 2 Then
                        ddlOCP_ID_DEPARTMENT.SelectedIndex = 1
                    Else
                        'get back prev value if hv
                        For Me.i = 0 To tmpDS3.Tables(0).Rows.Count - 1
                            If tmpDS3.Tables(0).Rows(i).Item(0).ToString = curDivDll Then
                                logic = True
                                Exit For
                            Else
                                logic = False
                        ...
                        Next
                        If logic = True Then
                            ddlOCP_ID_DEPARTMENT.SelectedValue = curDivDll
                        Else
                            ddlOCP_ID_DEPARTMENT.SelectedIndex = 0
                        End If
                    End If
                    ...
                    If tmpDS3.Tables.Count > 0 Then
                        ddlOCP_ID_DIVISION.DataTextField = "Name"
                        ddlOCP_ID_DIVISION.DataValueField = "Code"
                        ddlOCP_ID_DIVISION.DataSource = tmpDS3
                        ddlOCP_ID_DIVISION.DataBind()
                    End If
                    If tmpDS3.Tables(0).Rows.Count = 2 Then
                        ddlOCP_ID_DIVISION.SelectedIndex = 1
                ...
                'Filter for line ddl
                ssql = "exec [sp_org_getOCPIDObject] 'SECTION_1_1','" & Session("Company") & "','','" & ddlOCP_ID_DIVISION.SelectedValue.ToString & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue.ToString & "','" & ddlOCP_ID_SECTION.SelectedValue.ToString & "','','',''"
                tmpDS3 = mySQL.ExecuteSQL(ssql)
                If tmpDS3.Tables.Count > 0 Then
                    ddlOCP_ID_LINE.DataTextField = "Name"
                    ddlOCP_ID_LINE.DataValueField = "Code"
                    ddlOCP_ID_LINE.DataSource = tmpDS3
                    ddlOCP_ID_LINE.DataBind()
                End If
                tmpDS3 = Nothing
                ddlOCP_ID_LINE.SelectedIndex = 0
            Else
    ...
    Protected Sub ddlOCP_ID_LINE_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_LINE.SelectedIndexChanged

        logic = False
        If ddlOCP_ID_LINE.SelectedIndex > 0 Then
            If Not sender Is Nothing Then
                'Filter for section ddl
                curDivDll = ddlOCP_ID_SECTION.SelectedValue.ToString
                ssql = "exec [sp_org_getOCPIDObject] 'LINE_2_1','" & Session("Company") & "','','','','','" & ddlOCP_ID_LINE.SelectedValue.ToString & "','',''"
                tmpDS4 = mySQL.ExecuteSQL(ssql)
                If tmpDS4.Tables.Count > 0 Then
                    ddlOCP_ID_SECTION.DataTextField = "Name"
                    ddlOCP_ID_SECTION.DataValueField = "Code"
                    ddlOCP_ID_SECTION.DataSource = tmpDS4
                    ddlOCP_ID_SECTION.DataBind()
                End If
                If tmpDS4.Tables(0).Rows.Count = 2 Then
                    ddlOCP_ID_SECTION.SelectedIndex = 1
                Else
                    'get back prev value if hv
                    For Me.i = 0 To tmpDS4.Tables(0).Rows.Count - 1
                        If tmpDS4.Tables(0).Rows(i).Item(0).ToString = curDivDll Then
                            logic = True
                            Exit For
                        Else
                            logic = False
                    ...
                    Next
                    If logic = True Then
                        ddlOCP_ID_SECTION.SelectedValue = curDivDll
                    Else
                        ddlOCP_ID_SECTION.SelectedIndex = 0
                    End If
                End If
                ...
                If tmpDS4.Tables.Count > 0 Then
                    ddlOCP_ID_DEPARTMENT.DataTextField = "Name"
                    ddlOCP_ID_DEPARTMENT.DataValueField = "Code"
                    ddlOCP_ID_DEPARTMENT.DataSource = tmpDS4
                    ddlOCP_ID_DEPARTMENT.DataBind()
                End If
                If tmpDS4.Tables(0).Rows.Count = 2 Then
                    ddlOCP_ID_DEPARTMENT.SelectedIndex = 1
                ...
                If tmpDS4.Tables.Count > 0 Then
                    ddlOCP_ID_DIVISION.DataTextField = "Name"
                    ddlOCP_ID_DIVISION.DataValueField = "Code"
                    ddlOCP_ID_DIVISION.DataSource = tmpDS4
                    ddlOCP_ID_DIVISION.DataBind()
                End If
                If tmpDS4.Tables(0).Rows.Count = 2 Then
                    ddlOCP_ID_DIVISION.SelectedIndex = 1
            ...
            'Filter for group ddl
            ssql = "exec [sp_org_getOCPIDObject] 'LINE_1_1','" & Session("Company") & "','','" & ddlOCP_ID_DIVISION.SelectedValue.ToString & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue.ToString & "','" & ddlOCP_ID_SECTION.SelectedValue.ToString & "','" & ddlOCP_ID_LINE.SelectedValue.ToString & "','',''"
            tmpDS4 = mySQL.ExecuteSQL(ssql)
            If tmpDS4.Tables.Count > 0 Then
                ddlOCP_ID_GROUP.DataTextField = "Name"
                ddlOCP_ID_GROUP.DataValueField = "Code"
                ddlOCP_ID_GROUP.DataSource = tmpDS4
                ddlOCP_ID_GROUP.DataBind()
            End If
            tmpDS4 = Nothing
            ddlOCP_ID_GROUP.SelectedIndex = 0
        Else
    ...
    Protected Sub ddlOCP_ID_GROUP_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_GROUP.SelectedIndexChanged

        logic = False
        If ddlOCP_ID_GROUP.SelectedIndex > 0 Then
            If Not sender Is Nothing Then
                'Filter for line ddl
                curDivDll = ddlOCP_ID_LINE.SelectedValue.ToString
                ssql = "exec [sp_org_getOCPIDObject] 'GROUP_2_1','" & Session("Company") & "','','','','','','" & ddlOCP_ID_GROUP.SelectedValue.ToString & "',''"
                tmpDS5 = mySQL.ExecuteSQL(ssql)
                If tmpDS5.Tables.Count > 0 Then
                    ddlOCP_ID_LINE.DataTextField = "Name"
                    ddlOCP_ID_LINE.DataValueField = "Code"
                    ddlOCP_ID_LINE.DataSource = tmpDS5
                    ddlOCP_ID_LINE.DataBind()
                End If
                If tmpDS5.Tables(0).Rows.Count = 2 Then
                    ddlOCP_ID_LINE.SelectedIndex = 1
                Else
                    'get back prev value if hv
                    For Me.i = 0 To tmpDS5.Tables(0).Rows.Count - 1
                        If tmpDS5.Tables(0).Rows(i).Item(0).ToString = curDivDll Then
                            logic = True
                            Exit For
                        Else
                            logic = False
                    ...
                    Next
                    If logic = True Then
                        ddlOCP_ID_LINE.SelectedValue = curDivDll
                    Else
                        ddlOCP_ID_LINE.SelectedIndex = 0
                    End If
                End If
                ...
                If tmpDS5.Tables.Count > 0 Then
                    ddlOCP_ID_SECTION.DataTextField = "Name"
                    ddlOCP_ID_SECTION.DataValueField = "Code"
                    ddlOCP_ID_SECTION.DataSource = tmpDS5
                    ddlOCP_ID_SECTION.DataBind()
                End If
                If tmpDS5.Tables(0).Rows.Count = 2 Then
                    ddlOCP_ID_SECTION.SelectedIndex = 1
                ...
                If tmpDS5.Tables.Count > 0 Then
                    ddlOCP_ID_DEPARTMENT.DataTextField = "Name"
                    ddlOCP_ID_DEPARTMENT.DataValueField = "Code"
                    ddlOCP_ID_DEPARTMENT.DataSource = tmpDS5
                    ddlOCP_ID_DEPARTMENT.DataBind()
                End If
                If tmpDS5.Tables(0).Rows.Count = 2 Then
                    ddlOCP_ID_DEPARTMENT.SelectedIndex = 1
                ...
                If tmpDS5.Tables.Count > 0 Then
                    ddlOCP_ID_DIVISION.DataTextField = "Name"
                    ddlOCP_ID_DIVISION.DataValueField = "Code"
                    ddlOCP_ID_DIVISION.DataSource = tmpDS5
                    ddlOCP_ID_DIVISION.DataBind()
                End If
                If tmpDS5.Tables(0).Rows.Count = 2 Then
                    ddlOCP_ID_DIVISION.SelectedIndex = 1
            ...
            'Filter for process ddl
            ssql = "exec [sp_org_getOCPIDObject] 'GROUP_1_1','" & Session("Company") & "','','" & ddlOCP_ID_DIVISION.SelectedValue.ToString & "','" & ddlOCP_ID_DEPARTMENT.SelectedValue.ToString & "','" & ddlOCP_ID_SECTION.SelectedValue.ToString & "','" & ddlOCP_ID_LINE.SelectedValue.ToString & "','" & ddlOCP_ID_GROUP.SelectedValue.ToString & "',''"
            tmpDS5 = mySQL.ExecuteSQL(ssql)
            If tmpDS5.Tables.Count > 0 Then
                ddlOCP_ID_PROCESS.DataTextField = "Name"
                ddlOCP_ID_PROCESS.DataValueField = "Code"
                ddlOCP_ID_PROCESS.DataSource = tmpDS5
                ddlOCP_ID_PROCESS.DataBind()
            End If
            tmpDS5 = Nothing
            ddlOCP_ID_PROCESS.SelectedIndex = 0
        Else
    ...
    Protected Sub ddlOCP_ID_PROCESS_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_PROCESS.SelectedIndexChanged

        logic = False
        If ddlOCP_ID_PROCESS.SelectedIndex > 0 Then
            If Not sender Is Nothing Then
                'Filter for group ddl
                curDivDll = ddlOCP_ID_GROUP.SelectedValue.ToString
                ssql = "exec [sp_org_getOCPIDObject] 'PROCESS_2_1','" & Session("Company") & "','','','','','','','" & ddlOCP_ID_PROCESS.SelectedValue.ToString & "'"
                tmpDS6 = mySQL.ExecuteSQL(ssql)
                If tmpDS6.Tables.Count > 0 Then
                    ddlOCP_ID_GROUP.DataTextField = "Name"
                    ddlOCP_ID_GROUP.DataValueField = "Code"
                    ddlOCP_ID_GROUP.DataSource = tmpDS6
                    ddlOCP_ID_GROUP.DataBind()
                End If
                If tmpDS6.Tables(0).Rows.Count = 2 Then
                    ddlOCP_ID_GROUP.SelectedIndex = 1
                Else
                    'get back prev value if hv
                    For Me.i = 0 To tmpDS6.Tables(0).Rows.Count - 1
                        If tmpDS6.Tables(0).Rows(i).Item(0).ToString = curDivDll Then
                            logic = True
                            Exit For
                        Else
                            logic = False
                    ...
                    Next
                    If logic = True Then
                        ddlOCP_ID_GROUP.SelectedValue = curDivDll
                    Else
                        ddlOCP_ID_GROUP.SelectedIndex = 0
                    End If
                End If
                ...
                If tmpDS6.Tables.Count > 0 Then
                    ddlOCP_ID_LINE.DataTextField = "Name"
                    ddlOCP_ID_LINE.DataValueField = "Code"
                    ddlOCP_ID_LINE.DataSource = tmpDS6
                    ddlOCP_ID_LINE.DataBind()
                End If
                If tmpDS6.Tables(0).Rows.Count = 2 Then
                    ddlOCP_ID_LINE.SelectedIndex = 1
                ...
                If tmpDS6.Tables.Count > 0 Then
                    ddlOCP_ID_SECTION.DataTextField = "Name"
                    ddlOCP_ID_SECTION.DataValueField = "Code"
                    ddlOCP_ID_SECTION.DataSource = tmpDS6
                    ddlOCP_ID_SECTION.DataBind()
                End If
                If tmpDS6.Tables(0).Rows.Count = 2 Then
                    ddlOCP_ID_SECTION.SelectedIndex = 1
                ...
                If tmpDS6.Tables.Count > 0 Then
                    ddlOCP_ID_DEPARTMENT.DataTextField = "Name"
                    ddlOCP_ID_DEPARTMENT.DataValueField = "Code"
                    ddlOCP_ID_DEPARTMENT.DataSource = tmpDS6
                    ddlOCP_ID_DEPARTMENT.DataBind()
                End If
                If tmpDS6.Tables(0).Rows.Count = 2 Then
                    ddlOCP_ID_DEPARTMENT.SelectedIndex = 1
                ...
                If tmpDS6.Tables.Count > 0 Then
                    ddlOCP_ID_DIVISION.DataTextField = "Name"
                    ddlOCP_ID_DIVISION.DataValueField = "Code"
                    ddlOCP_ID_DIVISION.DataSource = tmpDS6
                    ddlOCP_ID_DIVISION.DataBind()
                End If
                If tmpDS6.Tables(0).Rows.Count = 2 Then
                    ddlOCP_ID_DIVISION.SelectedIndex = 1
...
#Region "Sub & Function"
    ...
    Sub BindDivision()
        ssql = "exec [sp_org_getOCPIDObject] 'DIVISION_0_1','" & Session("Company") & "','','','','','','',''"
        myDS2 = mySQL.ExecuteSQL(ssql)
        If myDS2.Tables.Count > 0 Then
            If myDS2.Tables(0).Columns.Count > 1 Then
                ddlOCP_ID_DIVISION.DataTextField = "Name"
                ddlOCP_ID_DIVISION.DataValueField = "Code"
                ddlOCP_ID_DIVISION.DataSource = myDS2
                ddlOCP_ID_DIVISION.DataBind()
            End If
        End If
        myDS2 = Nothing
    ...
    Sub BindDepartment()
        ssql = "exec [sp_org_getOCPIDObject] 'DEPARTMENT_0_1','" & Session("Company") & "','','','','','','',''"
        myDS2 = mySQL.ExecuteSQL(ssql)
        If myDS2.Tables.Count > 0 Then
            If myDS2.Tables(0).Columns.Count > 1 Then
                ddlOCP_ID_DEPARTMENT.DataTextField = "Name"
                ddlOCP_ID_DEPARTMENT.DataValueField = "Code"
                ddlOCP_ID_DEPARTMENT.DataSource = myDS2
                ddlOCP_ID_DEPARTMENT.DataBind()
            End If
        End If
        myDS2 = Nothing
    ...
    Sub BindSection()
        ssql = "exec [sp_org_getOCPIDObject] 'SECTION_0_1','" & Session("Company") & "','','','','','','',''"
        myDS2 = mySQL.ExecuteSQL(ssql)
        If myDS2.Tables.Count > 0 Then
            If myDS2.Tables(0).Columns.Count > 1 Then
                ddlOCP_ID_SECTION.DataTextField = "Name"
                ddlOCP_ID_SECTION.DataValueField = "Code"
                ddlOCP_ID_SECTION.DataSource = myDS2
                ddlOCP_ID_SECTION.DataBind()
            End If
        End If
        myDS2 = Nothing
    ...
    Sub BindEmployeeGroup()
        mySetting.GetDropdownlistValue(Form.ID, "OPTION_EMPLOYEE_GROUP", ddlOPTION_EMPLOYEE_GROUP)
        'ssql = "exec [sp_org_getOCPIDObject] 'SECTION_0','" & Session("Company") & "','','','','','','',''"
        'myDS2 = mySQL.ExecuteSQL(ssql)
        'If myDS2.Tables.Count > 0 Then
        '    If myDS2.Tables(0).Columns.Count > 1 Then
        '        ddlOPTION_EMPLOYEE_GROUP.DataTextField = "Name"
        '        ddlOPTION_EMPLOYEE_GROUP.DataValueField = "Code"
        '        ddlOPTION_EMPLOYEE_GROUP.DataSource = myDS2
        '        ddlOPTION_EMPLOYEE_GROUP.DataBind()
        '    End If
        'End If
        'myDS2 = Nothing
    End Sub
    Sub BindEmploymentType()
        mySetting.GetDropdownlistValue(Form.ID, "OPTION_EMPLOYMENT_TYPE", ddlOPTION_EMPLOYMENT_TYPE)
        'ssql = "exec [sp_org_getOCPIDObject] 'SECTION_0','" & Session("Company") & "','','','','','','',''"
        'myDS2 = mySQL.ExecuteSQL(ssql)
        'If myDS2.Tables.Count > 0 Then
        '    If myDS2.Tables(0).Columns.Count > 1 Then
        '        ddlOPTION_EMPLOYMENT_TYPE.DataTextField = "Name"
        '        ddlOPTION_EMPLOYMENT_TYPE.DataValueField = "Code"
        '        ddlOPTION_EMPLOYMENT_TYPE.DataSource = myDS2
        '        ddlOPTION_EMPLOYMENT_TYPE.DataBind()
        '    End If
        'End If
        'myDS2 = Nothing
    End Sub
    ...
    Sub BindLine()
        ssql = "exec [sp_org_getOCPIDObject] 'LINE_0_1','" & Session("Company") & "','','','','','','',''"
        myDS2 = mySQL.ExecuteSQL(ssql)
        If myDS2.Tables.Count > 0 Then
            If myDS2.Tables(0).Columns.Count > 1 Then
                ddlOCP_ID_LINE.DataTextField = "Name"
                ddlOCP_ID_LINE.DataValueField = "Code"
                ddlOCP_ID_LINE.DataSource = myDS2
                ddlOCP_ID_LINE.DataBind()
            End If
        End If
        myDS2 = Nothing
    ...
    Sub BindGroup()
        ssql = "exec [sp_org_getOCPIDObject] 'GROUP_0_1','" & Session("Company") & "','','','','','','',''"
        myDS2 = mySQL.ExecuteSQL(ssql)
        If myDS2.Tables.Count > 0 Then
            If myDS2.Tables(0).Columns.Count > 1 Then
                ddlOCP_ID_GROUP.DataTextField = "Name"
                ddlOCP_ID_GROUP.DataValueField = "Code"
                ddlOCP_ID_GROUP.DataSource = myDS2
                ddlOCP_ID_GROUP.DataBind()
            End If
        End If
        myDS2 = Nothing
    ...
    Sub BindProcess()
        ssql = "exec [sp_org_getOCPIDObject] 'PROCESS_0_1','" & Session("Company") & "','','','','','','',''"
        myDS2 = mySQL.ExecuteSQL(ssql)
        If myDS2.Tables.Count > 0 Then
            If myDS2.Tables(0).Columns.Count > 1 Then
                ddlOCP_ID_PROCESS.DataTextField = "Name"
                ddlOCP_ID_PROCESS.DataValueField = "Code"
                ddlOCP_ID_PROCESS.DataSource = myDS2
                ddlOCP_ID_PROCESS.DataBind()
            End If
        End If
        myDS2 = Nothing
    ...
    Sub BindJobGrade()
        ...
        If myDS2.Tables.Count > 0 Then
            ddlOCP_ID_JOB_GRADE.DataTextField = "Name"
            ddlOCP_ID_JOB_GRADE.DataValueField = "Code"
            ddlOCP_ID_JOB_GRADE.DataSource = myDS2
            ddlOCP_ID_JOB_GRADE.DataBind()
        End If
        myDS2 = Nothing
    End Sub
    ...
    Sub BindJobTitle()
        ...
        If myDS2.Tables.Count > 0 Then
            ddlOCP_ID_JOB_TITLE.DataTextField = "Name"
            ddlOCP_ID_JOB_TITLE.DataValueField = "Code"
            ddlOCP_ID_JOB_TITLE.DataSource = myDS2
            ddlOCP_ID_JOB_TITLE.DataBind()
        End If
        myDS2 = Nothing
    End Sub
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        Else
                                            If myDST.Tables(0).Rows(0).Item(2).ToString.Trim <> "" Then
                                                ssql2 = ssql2 & "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "',N'" & ReturnSessionValue(myDST.Tables(0).Rows(0).Item(2).ToString.Trim) & "'),''),"
                                            Else
                                        ...
                                        If myDS.Tables(0).Rows(i).Item(6).ToString = "YES" Then
                                            ...
                                            Else
                                                If myDST.Tables(0).Rows(0).Item(2).ToString.Trim <> "" Then
                                                    ssql3 = ssql3 & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "',N'" & ReturnSessionValue(myDST.Tables(0).Rows(0).Item(2).ToString.Trim) & "'),0) And "
                                                Else
        ...
        If Not myDS Is Nothing Then
            If myDS.Tables.Count > 0 Then
                    ...
                    Select Case myDR(2).ToString
                        Case "OPTION"
                            ...
                            If myDDL.Visible = True And myDDL.SelectedValue <> "" Then
                                ...
                                If Left(myDR(0).ToString, 6) = "OCP_ID" Then
                                    myDS2 = mySQL.ExecuteSQL("Select dbo.fn_getOCPCodeNameByID('" & Trim(myDDL.SelectedValue) & "')")
                                    ssql3 = ssql3 & myDS2.Tables(0).Rows(0).Item(0).ToString & "@@"
                                Else
                                    ssql3 = ssql3 & myDDL.SelectedValue.ToString.Trim & "@@"
                                End If
                ...
                Else
                    ...
                    'ssql2 = ssql.ToString.Replace("sp_sa_FilterTableRecords", "sp_sa_FilterCompareTableRecords")
                    ...
                    Session("SearchByFilter") = "True"
                    Session("SearchSQL") = "Exec sp_sa_FilterTableRecords N'" & Session("Company").ToString & "',N'" & Session("EmpID").ToString & "',N'" & _
                            Session("Module").ToString & "',N'" & ssql & "',N'" & ssql2 & "',N'" & ssql3 & _
                            "','" & myGridView.PageSize & "','"
                    Session("SearchSQL1") = "Exec sp_sa_FilterCompareTableRecords N'" & Session("Company").ToString & "',N'" & Session("EmpID").ToString & "',N'" & _
                            Session("Module").ToString & "',N'" & ssql & "',N'" & ssql2 & "',N'" & ssql3 & _
                            "','" & myGridView.PageSize & "','"
            ...
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                Select Case myDS.Tables(0).Rows(i).Item(2).ToString
                    Case "OPTION"
                        Dim myDropdownlist As DropDownList = Page.FindControl("ddl" & Trim(myDS.Tables(0).Rows(i).Item(0)))
                        If myDropdownlist.Visible = True Then
                            If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_JOB_GRADE" Then
                                Job_Grade = "N'" & Trim(myDropdownlist.SelectedValue) & "'"
                            ElseIf myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_JOB_TITLE" Then
                                Job_Title = "N'" & Trim(myDropdownlist.SelectedValue) & "'"
                            End If
                            If mySetting.CheckTextNull(myDropdownlist.SelectedValue) = True Then
                                If mySetting.ValidateInput(myDropdownlist, myDS.Tables(0).Rows(i).Item(1).ToString) = True Then
                        ...
                        If myTextBox.Visible = True Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                            If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_APPRAISAL" Then
                                                Appraisal = "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "'),'')"
                                            End If
                                            ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "'),''),"
                                        Else
                                            If myDST.Tables(0).Rows(0).Item(2).ToString.ToUpper.Trim <> "" Then
                                                If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_APPRAISAL" Then
                                                    Appraisal = "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "',N'" & ReturnSessionValue(myDST.Tables(0).Rows(0).Item(2).ToString.Trim) & "'),'')"
                                                End If
                                                ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "',N'" & ReturnSessionValue(myDST.Tables(0).Rows(0).Item(2).ToString.Trim) & "'),''),"
                                            Else
                                                If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_APPRAISAL" Then
                                                    Appraisal = "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "'),'')"
                                                End If
                                    ...
                                    Else
                                        If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_APPRAISAL" Then
                                            Appraisal = "ISNULL(N'" & myTextBox.Text.ToString & "','')"
                                        End If
                                        ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(N'" & myTextBox.Text.ToString & "',''),"
                                    End If
                                    myDST = Nothing
                            ...
                            Else
                                ...
                                Else
                                    If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID_APPRAISAL" Then
                                        Appraisal = "ISNULL(N'" & myTextBox.Text.ToString.Trim & "','')"
                                    End If
                                ...
                                If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                    If myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper = "EMPLOYEE_PROFILE_ID" Then
                                        ...
                                        If myUpdate.Tables(0).Rows.Count > 0 Then
                                            ...
                                            EMPID = myUpdate.Tables(0).Rows(0).Item(0).ToString
                                        Else
                                    ...
                                    Else
                                        ...
                                        If myDST2.Tables(0).Rows.Count > 0 Then
                                            ...
                                            Else
                                                If myDST2.Tables(0).Rows(0).Item(2).ToString.Trim <> "" Then
                                                    ssql = ssql & myDS2.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST2.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST2.Tables(0).Rows(0).Item(1).ToString.Trim & "',N'" & ReturnSessionValue(myDST2.Tables(0).Rows(0).Item(2).ToString.Trim) & "),'') And "
                                                Else
