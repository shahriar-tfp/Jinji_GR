...
Partial Class Pages_InformationSystem_Employee_Resign
...
#Region "Private Declaration"
    ...
    Dim EMPID As String, dateJoin As String = ""
#End Region
#Region "Page Setting"
    ...
    Protected Sub imgBtnUpdate_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpdate.Click
        If ValidateUpdate() Then
            ...
            If myDS.Tables(0).Rows.Count = 1 Then
                ssql2 = "Exec [sp_is_UpdDateJoin] '" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & dateJoin & "','" & Session("EmpID").ToString & "'"
                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                If IsNumeric(mySetting.ConvertDateToDecimal(myTextBox.Text, Session("Company").ToString, Session("Module").ToString)) = True Then
                                    ...
                                    Else
                                        ...
                                        If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "JOIN_DATE" Then
                                            dateJoin = mySetting.ConvertDateToDecimal(myTextBox.Text, Session("Company").ToString, Session("Module").ToString)
                                        End If
                                    End If
                                    myDST = Nothing
                                Else
                                ...
                                If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                    If myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper = "EMPLOYEE_PROFILE_ID" Then
                                        ...
                                        If myUpdate.Tables(0).Rows.Count > 0 Then
                                            ...
                                            EMPID = "ISNULL(dbo.fn_ReturnEmpIDByCodeName(N'" & Session("Company").ToString & "',N'" & myTextBox.Text.ToString & "'),'')"
                                        Else
