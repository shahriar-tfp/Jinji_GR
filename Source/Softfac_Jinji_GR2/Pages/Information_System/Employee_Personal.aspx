<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Personal.aspx.vb" Inherits="Pages_InformationSystem_Employee_Personal" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee Personal Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet"/>
</head>
<body id="body" runat="server">
  <form id="Employee_Personal_Vw" runat="server">
    <div>
    ...
    <!--// 4 //-->
    <asp:imagebutton id="imgKeyOPTION_TITLE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_TITLE" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_TITLE" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_TITLE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 5 //-->
    ...
    <!--// 7 //-->
    <asp:imagebutton id="imgKeyFIRST_NAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblFIRST_NAME" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtFIRST_NAME" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnFIRST_NAME" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 8 //-->
    <asp:imagebutton id="imgKeyMIDDLE_NAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblMIDDLE_NAME" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtMIDDLE_NAME" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnMIDDLE_NAME" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 9 //-->
    <asp:imagebutton id="imgKeyLAST_NAME" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblLAST_NAME" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtLAST_NAME" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnLAST_NAME" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 10 //-->
    <asp:imagebutton id="imgKeyPLACE_OF_BIRTH" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblPLACE_OF_BIRTH" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtPLACE_OF_BIRTH" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnPLACE_OF_BIRTH" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 11 //-->
    ...
    <asp:dropdownlist id="ddlOPTION_RELIGION" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_RELIGION" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 12 //-->
    ...
    <asp:dropdownlist id="ddlOPTION_SEX" runat="server" Width="157px"></asp:dropdownlist>
    ...
    <asp:dropdownlist id="ddlOPTION_CITIZENSHIP" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_CITIZENSHIP" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 15 //-->
    ...
    <asp:dropdownlist id="ddlOPTION_RACE" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_RACE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 16 //-->
    ...
    <asp:imagebutton id="imgbtnNAME2" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 22 //-->
    <asp:imagebutton id="imgKeyFIRST_NAME2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblFIRST_NAME2" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtFIRST_NAME2" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnFIRST_NAME2" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 23 //-->
    <asp:imagebutton id="imgKeyMIDDLE_NAME2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblMIDDLE_NAME2" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtMIDDLE_NAME2" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnMIDDLE_NAME2" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 24 //-->
    <asp:imagebutton id="imgKeyLAST_NAME2" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblLAST_NAME2" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtLAST_NAME2" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnLAST_NAME2" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 25 //-->
    <asp:imagebutton id="imgKeyOLD_IDENTITY_CARD_NO" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOLD_IDENTITY_CARD_NO" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOLD_IDENTITY_CARD_NO" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOLD_IDENTITY_CARD_NO" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 26 //-->
    ...
    <asp:dropdownlist id="ddlOption_Resign_Flag" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOption_Resign_Flag" runat="server" Height="21px" ></asp:imagebutton>
    ...
    <!--// Button //-->  
    <asp:imagebutton id="ImgbtnAdd1" runat="server" Width="74" height="21"></asp:imagebutton>
    ...
    <asp:imagebutton id="imgBtnRefresh" runat="server" Width="74" Height="21"></asp:imagebutton>
											...
											<table cellspacing="0" cellpadding="0" border="0">
												...
												<tr>
												    ...
												    <td style="width:350px" align="left">
														...
														<asp:imagebutton id="ImgBtnQuery" runat="server" Height="21px" Width="74px"></asp:imagebutton>
													   </td>
													<td align="left">
    ...
    <br />
    <asp:imagebutton id="imgbtnPrevioPage" runat="server" Height="21px" Width="74px"></asp:imagebutton>
    <asp:imagebutton id="imgbtnNextPage" runat="server" Height="21px" Width="74px"></asp:imagebutton>
