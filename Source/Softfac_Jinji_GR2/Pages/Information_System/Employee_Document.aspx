<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Document.aspx.vb" Inherits="Pages_InformationSystem_Employee_Document" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee Document Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_Document" runat="server">
    <div>
    ...
    <!--// 4 //-->
    <asp:imagebutton id="imgKeyEXPIRY_DATE" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    ...
    <!--// 5 //-->
    <asp:imagebutton id="imgKeyDOCUMENT_NO" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblDOCUMENT_NO" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtDOCUMENT_NO" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnDOCUMENT_NO" runat="server" Height="21px"></asp:imagebutton>
