<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_No_Of_Child.aspx.vb" Inherits="Pages_InformationSystem_Employee_No_Of_Child" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee No Of Child Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet">
</head>
<body id="body" runat="server">
    <form id="Employee_No_Of_Child" runat="server">
    <div>
    ...
    <!--// 2 //-->
    <asp:imagebutton id="imgKeyWORK_CHILD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblWORK_CHILD" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtWORK_CHILD" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnWORK_CHILD" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 3 //-->
    <asp:imagebutton id="imgKeyNON_WORK_CHILD" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblNON_WORK_CHILD" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtNON_WORK_CHILD" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnNON_WORK_CHILD" runat="server" Height="21px" ></asp:imagebutton>
    
    <asp:imagebutton id="imgKeyOPTION_SPOUSE_WORK_STATUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_SPOUSE_WORK_STATUS" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_SPOUSE_WORK_STATUS" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_SPOUSE_WORK_STATUS" runat="server" Height="21px" ></asp:imagebutton>
