...
Partial Class Pages_InformationSystem_Employee_Info
...
#Region "Private Declaration"
    ...
    Dim buttonPosition1 As String = "B1_", buttonPosition2 As String = "B2_", buttonPosition3 As String = "B3_", ButtonPosition4 As String = "B4_", labelPosition1 As String = "L1_"
            ...
            For Me.i = 0 To myGridView.Rows.Count - 1
                ...
                If chkDelete.Checked Then
                    ...
                    If ssql3 <> Nothing And ssql4 <> Nothing Then
                        ...
                        mySQL.ExecuteSQL8Transaction(ssql8, ssql2, ssql3, ssql4, ssql5, ssql6, ssql7, ssql, "Delete Employee_Personal_Vw", Session("Company").ToString, Session("EmpID").ToString)
                        tmpEmpID = ""
                        ssql = Nothing
                    End If
        ...
        If Not myDS Is Nothing Then
            For Me.j = 0 To myGridView.HeaderRow.Cells.Count - 1
                If myDS.Tables(0).Rows(0).Item(0).ToString = myGridView.HeaderRow.Cells(j).Text.ToString Then
                    ...
                    sqlString = "Select Isnull(dbo.fn_ReturnEmpIDByCodeName('" & Session("Company").ToString & "','" & myGridView.Rows(RowIndex).Cells(j).Text.ToString.Replace("&amp;", "&").Replace("&nbsp;", "&") & "'),'') As Employee_Profile_ID"
...
#End Region
    ...
    Protected Sub imgBtnPrint_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles imgBtnPrint.Unload
