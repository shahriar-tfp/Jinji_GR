...
Partial Class PAGES_PAYROLL_EMPLOYEE_BANK_SPLIT
...
#Region "Panel Edit"
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        lblresult2.Text = ""
        If ValidateInsert() = True And ValidateInsertPercentage() = True Then
    ...
    Protected Sub imgBtnUpdate_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpdate.Click
        If ValidateUpdate() = True And ValidateUpdatePercentage() = True Then
            mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
            pnlEdit.Visible = False
            pnlMain.Visible = True
            BindGrid()
...
#Region "Sub & Function"
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        If myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" Then
                                            ...
                                            Else
                                                ssql2 = ssql2 & "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "',N'" & Session("Company").ToString & "'),''),"
                                            End If
                                        Else
                                            If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                        ...
                                        If myDS.Tables(0).Rows(i).Item(6).ToString = "YES" Then
                                            If myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" Then
                                                If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                                    ssql3 = ssql3 & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & Session("Company").ToString & "'),0) And "
                                                Else
                                                    ssql3 = ssql3 & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "',N'" & Session("Company").ToString & "'),0) And "
                                                End If
                                            Else
                                                If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        If myDST.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" Then
                                            If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                                ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & Session("Company").ToString & "'),''),"
                                            Else
                                                ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "',N'" & Session("Company").ToString & "'),''),"
                                            End If
                                        Else
                                            If myDST.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                            ...
                            If myTextBox.Visible = True Then
                                If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                    ...
                                    Else
                                        ...
                                        myDST2 = mySQL.ExecuteSQL("Select Function_Name,Default_Value,Default_Value2 From User_Define_Function Where Company_Profile_Code='" & Session("Company").ToString & "' And Module_Profile_Code='" & Session("Module").ToString & "' And Table_Profile_Code='" & Form.ID & "' And Table_Field_Code='" & myDS2.Tables(0).Rows(i).Item(0).ToString & "' And Query_Action='UPDATE'")
                                        If myDST2.Tables(0).Rows.Count > 0 Then
                                            If myDST2.Tables(0).Rows(0).Item(2).ToString.Trim = "COMPANY" Then
                                                If myDST2.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
                                                    ssql = ssql & myDS2.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST2.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & Session("Company").ToString & "'),'') And "
                                                Else
                                                    ssql = ssql & myDS2.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST2.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST2.Tables(0).Rows(0).Item(1).ToString.Trim & "',N'" & Session("Company").ToString & "'),'') And "
                                                End If
                                            Else
                                                If myDST2.Tables(0).Rows(0).Item(1).ToString.Trim = "" Then
    ...
    Private Function ValidateInsertPercentage() As Boolean
        ssql2 = "Select isnull(sum(percentage),0) from " & Form.ID & " where Employee_profile_id = dbo.fn_ReturnEmpIDByCodeName('" & Session("Company").ToString & "',N'" & txtEMPLOYEE_PROFILE_ID.Text.Trim & "') and Effective_Date = '" & mySetting.ConvertDateToDecimal(txtEFFECTIVE_DATE.Text, Session("Company").ToString, Session("Module").ToString) & "'"
        Dim MYDS2 As New DataSet
        Dim Percentage As New Integer
        Percentage = 0
        MYDS2 = mySQL.ExecuteSQL(ssql2)

        If MYDS2.Tables(0).Rows.Count > 0 Then
            Percentage = MYDS2.Tables(0).Rows(0).Item(0).ToString
            Percentage = txtPERCENTAGE.Text + Percentage
            If Percentage > 100 Then
                lblresult2.Text = "Total Percentage cannot Bigger than 100% at same Effective Date."
                Return False
            Else
                Return True
            End If
    ...
    Private Function ValidateUpdatePercentage() As Boolean
        ssql2 = "Select isnull(sum(percentage),0) from " & Form.ID & " where Employee_profile_id = dbo.fn_ReturnEmpIDByCodeName('" & Session("Company").ToString & "',N'" & txtEMPLOYEE_PROFILE_ID.Text.Trim & "') and Effective_Date = '" & mySetting.ConvertDateToDecimal(txtEFFECTIVE_DATE.Text, Session("Company").ToString, Session("Module").ToString) & "'"
        ssql3 = "Select isnull(sum(percentage),0) from " & Form.ID & " where Employee_profile_id = dbo.fn_ReturnEmpIDByCodeName('" & Session("Company").ToString & "',N'" & txtEMPLOYEE_PROFILE_ID.Text.Trim & "') and Effective_Date = '" & mySetting.ConvertDateToDecimal(txtEFFECTIVE_DATE.Text, Session("Company").ToString, Session("Module").ToString) & "' and Bank_Profile_Code = dbo.fn_GetCode_BANK_PROFILE_Vw(N'" & txtBANK_PROFILE_CODE.Text & "','" & Session("company").ToString & "') and Currency_profile_code = dbo.fn_GetCode_CURRENCY_PROFILE_Vw(N'" & txtCURRENCY_PROFILE_CODE.Text & "')"
        Dim MYDS2 As New DataSet
        Dim MYDS3 As New DataSet
        Dim Percentage As New Integer
        Percentage = 0
        MYDS2 = mySQL.ExecuteSQL(ssql2)
        MYDS3 = mySQL.ExecuteSQL(ssql3)

        If MYDS2.Tables(0).Rows.Count > 0 Then
            Percentage = MYDS2.Tables(0).Rows(0).Item(0).ToString
            If MYDS3.Tables(0).Rows.Count > 0 Then
                Percentage = Percentage - MYDS3.Tables(0).Rows(0).Item(0).ToString
            End If
            Percentage = txtPERCENTAGE.Text + Percentage
            If Percentage > 100 Then
                lblresult2.Text = "Total Percentage cannot Bigger than 100% at same Effective Date."
