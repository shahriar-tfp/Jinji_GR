<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GR_CUSTOMER_SERVICE_RECORD.aspx.vb" Inherits="PAGES_INFORMATION_SYSTEM_GR_CUSTOMER_SERVICE_RECORD" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>GR_CUSTOMER_SERVICE_RECORD</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="GR_CUSTOMER_SERVICE_RECORD" runat="server">
<div>
...
<!--// 4 //-->
<asp:imagebutton id="imgKeyCUSTOMER_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCUSTOMER_CODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCUSTOMER_CODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCUSTOMER_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyPROJECT_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPROJECT_CODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPROJECT_CODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPROJECT_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyTIME_ARRIVE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTIME_ARRIVE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTIME_ARRIVE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTIME_ARRIVE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 7 //-->
<asp:imagebutton id="imgKeyTIME_DEPART" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTIME_DEPART" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTIME_DEPART" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTIME_DEPART" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 11 //-->
<asp:imagebutton id="imgKeyTOTAL_HRS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblTOTAL_HRS" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtTOTAL_HRS" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnTOTAL_HRS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 12 //-->
<asp:imagebutton id="imgKeyAPPROVAL_STATUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblAPPROVAL_STATUS" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlAPPROVAL_STATUS" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnAPPROVAL_STATUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 13 //-->
<asp:imagebutton id="imgKeyPAYMENT_STATUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPAYMENT_STATUS" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlPAYMENT_STATUS" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnPAYMENT_STATUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 14 //-->
<asp:imagebutton id="imgKeyAPPROVAL_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblAPPROVAL_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtAPPROVAL_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnAPPROVAL_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
