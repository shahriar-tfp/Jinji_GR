...
Partial Class Pages_InformationSystem_Employee_Increment
...
#Region "Page Setting"
    ...
    Sub PagePreload()
        txtAction.Value = ""
        txtOCP_ID_JOB_GRADE_OLD.Value = ""
        txtOCP_ID_JOB_TITLE_OLD.Value = ""
        txtOCP_ID_APPRAISAL_OLD.Value = ""
...
#Region "Panel Edit"
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        lblresult2.Text = ""
        If ValidateAddUpdDel(txtEMPLOYEE_PROFILE_ID.Text.Trim, txtEFFECTIVE_DATE.Text.Trim, txtDATETIME_CREATE.Text.Trim, txtDATETIME_MODIFY.Text.Trim, "Insert") = True Then
    ...
    Protected Sub imgBtnUpdate_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpdate.Click
        If ValidateAddUpdDel(txtEMPLOYEE_PROFILE_ID.Text.Trim, txtEFFECTIVE_DATE.Text.Trim, txtDATETIME_CREATE.Text.Trim, txtDATETIME_MODIFY.Text.Trim, "Update") = True Then
...
#Region "Panel Action"
                            ...
                            If gvHistory.HeaderRow.Cells(intColumn).Text.ToString = myDS.Tables(0).Rows(j).Item(2).ToString Then
                                Select Case myDS.Tables(0).Rows(j).Item(1).ToString.Trim
                                    Case "OPTION"
                                        ...
                                        myDDL = Nothing
                                        If myDS.Tables(0).Rows(j).Item(0).ToString.Trim = "OCP_ID_JOB_GRADE_NEW" Then
                                            ddlOCP_ID_JOB_GRADE_NEW_SelectedIndexChanged(Nothing, Nothing)
                                        ElseIf myDS.Tables(0).Rows(j).Item(0).ToString.Trim = "OCP_ID_JOB_GRADE_OLD" Then
                                            ddlOCP_ID_JOB_GRADE_OLD_SelectedIndexChanged(Nothing, Nothing)
                                        End If
                                    Case Else
        ...
        If ActionValidateDelete() Then
            For Me.i = 0 To myGridView.Rows.Count - 1
                ...
                If chkDelete.Checked Then
                    ...
                    For k = 0 To myGridView.Rows.Count - 1
                        Dim chkEdit As CheckBox = myGridView.Rows(k).Cells(0).Controls(1)
                        If chkEdit.Checked Then
                            chkEdit.Checked = False
                            myDS = New DataSet
                            myDS = mySQL.ExecuteSQL("SELECT Code,Option_Data_Type,Name FROM Table_Field Where Table_Profile_Code='" & Form.ID & "' ORDER BY SEQUENCE_NO", Session("Company").ToString, Session("EmpID").ToString)
                                ...
                                For Me.intColumn = 1 To gvHistory.HeaderRow.Cells.Count - 1
                                    If gvHistory.HeaderRow.Cells(intColumn).Text.ToString = myDS.Tables(0).Rows(j).Item(2).ToString Then
                                        Select Case myDS.Tables(0).Rows(j).Item(1).ToString.Trim
                                            Case "OPTION"
                                                Dim myDDL As DropDownList = Page.FindControl("ddl" & myDS.Tables(0).Rows(j).Item(0).ToString.Trim)
                                                mySetting.ArrangeDDLSelectedIndex(myDDL, clsGlobalSetting.DDLSelection.SelectedText, Replace(Replace(gvHistory.Rows(k).Cells(intColumn).Text.ToString.Trim, "&nbsp;", "&"), "&amp;", "&"))
                                                myDDL = Nothing
                                            Case Else
                                                Dim myTXT As TextBox = Page.FindControl("txt" & myDS.Tables(0).Rows(j).Item(0).ToString.Trim)
                                                If gvHistory.Rows(k).Cells(j + 1).Text.Trim = "&nbsp;" Then
                                                    myTXT.Text = ""
                                                Else
                                                    myTXT.Text = Replace(Replace(gvHistory.Rows(k).Cells(intColumn).Text.ToString.Trim, "&nbsp;", "&"), "&amp;", "&")
                                                End If
                                                myTXT = Nothing
                                        End Select
                                    End If
                    ...
                    If ValidateAddUpdDel(txtEMPLOYEE_PROFILE_ID.Text.Trim, txtEFFECTIVE_DATE.Text.Trim, txtDATETIME_CREATE.Text.Trim, txtDATETIME_MODIFY.Text.Trim, "Delete") = True Then
    ...
    Protected Sub ddlOCP_ID_JOB_GRADE_NEW_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_JOB_GRADE_NEW.SelectedIndexChanged
        ...
        If myDS2.Tables(0).Rows.Count > 0 Then
            ...
            If ddlOCP_ID_JOB_GRADE_NEW.SelectedIndex > 0 Then
                ssql = "exec [sp_org_getOCPIDObject] 'JOB_GRADE_1_1','" & Session("Company") & "','" & ddlOCP_ID_JOB_GRADE_NEW.SelectedValue.ToString & "','','','','','',''"
                ...
                If tmpDS.Tables.Count > 0 Then
                    If tmpDS.Tables(0).Columns.Count > 1 Then
                        ...
                        ddlOCP_ID_JOB_TITLE_NEW.DataSource = tmpDS
            ...
            Else
                ...
                BindJobTitleNew()
            End If
            ddlOCP_ID_JOB_TITLE_NEW.SelectedIndex = 0
        End If
        ssql2 = Nothing
        myDS2 = Nothing
    ...
    Protected Sub ddlOCP_ID_JOB_GRADE_OLD_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_JOB_GRADE_OLD.SelectedIndexChanged
        ssql2 = "Select * from parameter where company_profile_code = '" & Session("Company") & "' and code = 'JOBGROUP' and string_value1 = 'YES'"
        myDS2 = mySQL.ExecuteSQL(ssql2, Session("Company"), Session("EmpID"))

        If myDS2.Tables(0).Rows.Count > 0 Then
            'bind job title field dropdownlist
            If ddlOCP_ID_JOB_GRADE_OLD.SelectedIndex > 0 Then
                ssql = "exec [sp_org_getOCPIDObject] 'JOB_GRADE_1_1','" & Session("Company") & "','" & ddlOCP_ID_JOB_GRADE_OLD.SelectedValue.ToString & "','','','','','',''"
                Dim tmpDS As New DataSet
                tmpDS = mySQL.ExecuteSQL(ssql)
                If tmpDS.Tables.Count > 0 Then
                    If tmpDS.Tables(0).Columns.Count > 1 Then
                        ddlOCP_ID_JOB_TITLE_OLD.DataTextField = "Name"
                        ddlOCP_ID_JOB_TITLE_OLD.DataValueField = "Code"
                        ddlOCP_ID_JOB_TITLE_OLD.DataSource = tmpDS
                        ddlOCP_ID_JOB_TITLE_OLD.DataBind()
                    End If
                End If
            Else
                BindJobGradeOld()
                BindJobTitleOld()
            End If
            ddlOCP_ID_JOB_TITLE_OLD.SelectedIndex = 0
        End If
        ssql2 = Nothing
        myDS2 = Nothing
    End Sub

    Protected Sub ddlOCP_ID_JOB_TITLE_NEW_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_JOB_TITLE_NEW.SelectedIndexChanged
        ssql2 = "Select * from parameter where company_profile_code = '" & Session("Company") & "' and code = 'JOBGROUP' and string_value1 = 'YES'"
        myDS2 = mySQL.ExecuteSQL(ssql2, Session("Company"), Session("EmpID"))

        If myDS2.Tables(0).Rows.Count > 0 Then
            Dim tmpDS As New DataSet
            If ddlOCP_ID_JOB_TITLE_NEW.SelectedIndex > 0 Then
                ssql = "exec [sp_org_getOCPIDObject] 'JOB_TITLE_1_1','" & Session("Company") & "','" & ddlOCP_ID_JOB_TITLE_NEW.SelectedValue.ToString & "','','','','','',''"
                tmpDS = mySQL.ExecuteSQL(ssql)
                If tmpDS.Tables.Count > 0 Then
                    If tmpDS.Tables(0).Columns.Count > 1 Then
                        ddlOCP_ID_JOB_GRADE_NEW.DataTextField = "Name"
                        ddlOCP_ID_JOB_GRADE_NEW.DataValueField = "Code"
                        ddlOCP_ID_JOB_GRADE_NEW.DataSource = tmpDS
                        ddlOCP_ID_JOB_GRADE_NEW.DataBind()
                    End If
                    ddlOCP_ID_JOB_GRADE_NEW.SelectedIndex = tmpDS.Tables(0).Rows.Count - 1
                Else
                    ddlOCP_ID_JOB_GRADE_NEW.SelectedIndex = 0
                End If
            ElseIf ddlOCP_ID_JOB_TITLE_NEW.SelectedIndex = 0 Then
                BindJobTitleNew()
            End If
        End If
        ssql2 = Nothing
    ...
    Protected Sub ddlOCP_ID_JOB_TITLE_OLD_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOCP_ID_JOB_TITLE_OLD.SelectedIndexChanged
        ssql2 = "Select * from parameter where company_profile_code = '" & Session("Company") & "' and code = 'JOBGROUP' and string_value1 = 'YES'"
        myDS2 = mySQL.ExecuteSQL(ssql2, Session("Company"), Session("EmpID"))

        If myDS2.Tables(0).Rows.Count > 0 Then
            Dim tmpDS As New DataSet
            If ddlOCP_ID_JOB_TITLE_OLD.SelectedIndex > 0 Then
                ssql = "exec [sp_org_getOCPIDObject] 'JOB_TITLE_1_1','" & Session("Company") & "','" & ddlOCP_ID_JOB_TITLE_OLD.SelectedValue.ToString & "','','','','','',''"
                tmpDS = mySQL.ExecuteSQL(ssql)
                If tmpDS.Tables.Count > 0 Then
                    If tmpDS.Tables(0).Columns.Count > 1 Then
                        ddlOCP_ID_JOB_GRADE_OLD.DataTextField = "Name"
                        ddlOCP_ID_JOB_GRADE_OLD.DataValueField = "Code"
                        ddlOCP_ID_JOB_GRADE_OLD.DataSource = tmpDS
                        ddlOCP_ID_JOB_GRADE_OLD.DataBind()
                    End If
                    ddlOCP_ID_JOB_GRADE_OLD.SelectedIndex = tmpDS.Tables(0).Rows.Count - 1
                Else
                    ddlOCP_ID_JOB_GRADE_OLD.SelectedIndex = 0
                End If
            ElseIf ddlOCP_ID_JOB_TITLE_OLD.SelectedIndex = 0 Then
                BindJobTitleOld()
            End If
        End If
        ssql2 = Nothing
...
#Region "Sub & Function"
    ...
    Sub BindJobGradeOld()
        ...
        If myDS2.Tables.Count > 0 Then
            ddlOCP_ID_JOB_GRADE_OLD.DataTextField = "Name"
            ddlOCP_ID_JOB_GRADE_OLD.DataValueField = "Code"
            ddlOCP_ID_JOB_GRADE_OLD.DataSource = myDS2
            ddlOCP_ID_JOB_GRADE_OLD.DataBind()
        End If
        myDS2 = Nothing
    End Sub
    ...
    Sub BindJobTitleOld()
        ...
        If myDS2.Tables.Count > 0 Then
            ddlOCP_ID_JOB_TITLE_OLD.DataTextField = "Name"
            ddlOCP_ID_JOB_TITLE_OLD.DataValueField = "Code"
            ddlOCP_ID_JOB_TITLE_OLD.DataSource = myDS2
            ddlOCP_ID_JOB_TITLE_OLD.DataBind()
        End If
        myDS2 = Nothing
    End Sub
    ...
    Sub BindOTI()
        ssql = "exec [sp_org_getOCPIDObject] 'OTI','" & Session("Company") & "','','','','','','',''"
        myDS2 = mySQL.ExecuteSQL(ssql)
        If myDS2.Tables.Count > 0 Then
            If myDS2.Tables(0).Columns.Count > 1 Then
                ddlOPTION_TYPE_INCREMENT.DataTextField = "Name"
                ddlOPTION_TYPE_INCREMENT.DataValueField = "Code"
                ddlOPTION_TYPE_INCREMENT.DataSource = myDS2
                ddlOPTION_TYPE_INCREMENT.DataBind()
            End If
        End If
        myDS2 = Nothing
    End Sub

    Sub BindAppraisalOld()
        ssql = "exec [sp_org_getOCPIDObject] 'APPRAISAL_0_1','" & Session("Company") & "','','','','','','',''"
        myDS2 = mySQL.ExecuteSQL(ssql)
        If myDS2.Tables.Count > 0 Then
            ddlOCP_ID_APPRAISAL_OLD.DataTextField = "Name"
            ddlOCP_ID_APPRAISAL_OLD.DataValueField = "Code"
            ddlOCP_ID_APPRAISAL_OLD.DataSource = myDS2
            ddlOCP_ID_APPRAISAL_OLD.DataBind()
        End If
        myDS2 = Nothing
    End Sub
    ...
    Private Function ValidateInsert() As Boolean
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
                        ...
                        If myTextBox.Visible = True Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                If IsNumeric(myTextBox.Text) = True Then
                                    ...
                                    myDST = mySQL.ExecuteSQL("Select string_value1 From parameter Where Company_Profile_Code='" & Session("Company").ToString & "' And Module_Profile_Code='" & "SYSTEM_MANAGER" & "' And Code='" & "ENCODE_SALARY" & "'")
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        If myDST.Tables(0).Rows(0).Item(0).ToString = "Y" Then
                                            Dim myDST1 As New DataSet
                                            myDST1 = mySQL.ExecuteSQL("Exec sp_sa_EDPwordv2 'ENCODE','" & Session("Company").ToString & "','" & Form.ID & "', '" & Trim(myTextBox.Text) & "', ''")
                                            If myDST1.Tables(0).Rows.Count > 0 Then
                                                ssql2 = ssql2 & "'" & myDST1.Tables(0).Rows(0).Item(0).ToString & "',"
                                                If myDS.Tables(0).Rows(i).Item(6).ToString = "YES" Then
            ...
            DefaultDS = mySQL.ExecuteSQL("SELECT Code,Option_Data_Type,Default_Value_Date,Default_Value_DateTime,Default_Value_Time,Default_Value_Integer,Default_Value_Decimal,Default_Value_Character,Option_Primary_Key FROM Table_Field Where Table_Profile_Code='" & Form.ID & "' AND Option_View_Card='NO' ORDER BY Sequence_No")
                            ...
                            Select Case DefaultDR(1).ToString
                                ...
                                Case "LOOKUP"
                                    If DefaultDR("Default_Value_Character").ToString.Trim <> "" Then
                                        Dim Temp As String = ""
                                        If DefaultDR("Default_Value_Character").ToString.Trim = "Company" Then
                                            Temp = Session("Company")
                                        ElseIf DefaultDR("Default_Value_Character").ToString.Trim = "Empid" Then
                                            Temp = Session("Empid")
                                        Else
                                            Temp = DefaultDR("Default_Value_Character").ToString.Trim
                                        End If
                                        ssql = ssql & DefaultDR(0).ToString & ","
                                        ssql2 = ssql2 & "'" & Temp & "',"
                                        If DefaultDR(8).ToString = "YES" Then
                                            ssql3 = ssql3 & DefaultDR(0).ToString & "='" & Temp & "' And "
                                        End If
                                    Else
                                        ssql = ssql & DefaultDR(0).ToString & ","
                                        ssql2 = ssql2 & ""
                                ...
                                If IsNumeric(myTextBox.Text) Then
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        If myDST.Tables(0).Rows(0).Item(0).ToString = "Y" Then
                                            ...
                                            myDST1 = mySQL.ExecuteSQL("Exec sp_sa_EDPwordv2 'ENCODE','" & Session("Company").ToString & "','" & Form.ID & "', '" & Trim(myTextBox.Text) & "', ''")
                                            If myDST1.Tables(0).Rows.Count > 0 Then
                                                ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "=N'" & myDST1.Tables(0).Rows(0).Item(0).ToString & "',"
                                            End If
                                            myDST1 = Nothing
                                        Else
    ...
    Public Function ValidateAddUpdDel(ByVal Empid As String, ByVal strEDate As String, ByVal strCDate As String, ByVal strMDate As String, ByVal type As String) As Boolean

        strEDate = mySetting.ConvertDateToDecimal(strEDate, Session("Company"), Session("Module"))
        strCDate = mySetting.ConvertDateToDecimal(strCDate, Session("Company"), Session("Module"))
        strMDate = mySetting.ConvertDateToDecimal(strMDate, Session("Company"), Session("Module"))

        Dim strNDate As String = mySetting.ConvertDateToDecimal(txtEFFECTIVE_DATE.Text, Session("Company"), Session("Module"))

        ssql = "Exec sp_is_ValEmpIncrement '" & Session("Company") & "','" & Empid.Replace("'", "''") & "','" & type & "','" & strEDate & "','" & strCDate & "','" & strNDate & "'"
        myDS1 = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
        If myDS1.Tables(0).Rows.Count > 0 Then
            If UCase(myDS1.Tables(0).Rows(0).Item(0)) = "SUCCESS" Then
                Return True
            Else
                If type = "Insert" Then
                    lblresult2.Text = myDS1.Tables(0).Rows(0).Item(1)
                Else
                    lblresult.Text = myDS1.Tables(0).Rows(0).Item(1)
                End If

                Return False
            End If
        Else
            lblresult.Text = "Validation Fail!"
            Return False
        End If
    ...
    Sub CalNewSalary()
        If txtINCREMENT.Text = "" Or txtINCREMENT.Text = "0" Then
            txtINCREMENT.Text = "0.00"
        End If
        If txtPROMOTION.Text = "" Or txtPROMOTION.Text = "0" Then
            txtPROMOTION.Text = "0.00"
        End If
        If txtOLD_SALARY.Text = "" Or txtOLD_SALARY.Text = "0" Then
            txtOLD_SALARY.Text = "0.00"
        End If
        If IsNumeric(txtINCREMENT.Text) = False Then
            lblresult.Text = lblINCREMENT.Text & " is NOT Numeric!"
            txtNEW_SALARY.Text = "0.00"
            Exit Sub
        End If
        If IsNumeric(txtPROMOTION.Text) = False Then
            lblresult.Text = lblPROMOTION.Text & " is NOT Numeric!"
            txtNEW_SALARY.Text = "0.00"
            Exit Sub
        End If
        If IsNumeric(txtOLD_SALARY.Text) = False Then
            lblresult.Text = lblOLD_SALARY.Text & " is NOT Numeric!"
            txtNEW_SALARY.Text = "0.00"
            Exit Sub
        End If
        txtNEW_SALARY.Text = CDec(txtINCREMENT.Text) + CDec(txtOLD_SALARY.Text) + CDec(txtPROMOTION.Text)
    End Sub

    Protected Sub txtOLD_SALARY_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtOLD_SALARY.TextChanged
        If txtAction.Value <> "Search" Then
            CalNewSalary()
        End If
    End Sub
    ...
    Protected Sub txtOCP_ID_JOB_GRADE_OLD_ValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtOCP_ID_JOB_GRADE_OLD.ValueChanged
        If txtAction.Value <> "Search" Then
            ddlOCP_ID_JOB_GRADE_OLD.SelectedValue = txtOCP_ID_JOB_GRADE_OLD.Value
        End If
    End Sub

    Protected Sub txtOCP_ID_JOB_TITLE_OLD_ValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtOCP_ID_JOB_TITLE_OLD.ValueChanged
        If txtAction.Value <> "Search" Then
            ddlOCP_ID_JOB_TITLE_OLD.SelectedValue = txtOCP_ID_JOB_TITLE_OLD.Value
        End If
    End Sub

    Protected Sub txtOCP_ID_APPRAISAL_OLD_ValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtOCP_ID_APPRAISAL_OLD.ValueChanged
        If txtAction.Value <> "Search" Then
            ddlOCP_ID_APPRAISAL_OLD.SelectedValue = txtOCP_ID_APPRAISAL_OLD.Value
        End If
    End Sub
#End Region
