<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Salary.aspx.vb" Inherits="Pages_InformationSystem_Employee_Salary" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee Salary Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet">
</head>
<body id="body" runat="server">
    <form id="Employee_Salary" runat="server">
    <div>
    ...
    <!--// 2 //-->
    <asp:imagebutton id="imgKeyBASIC_SALARY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblBASIC_SALARY" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtBASIC_SALARY" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnBASIC_SALARY" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 3 //-->
    ...
    <asp:imagebutton id="imgbtnCURRENCY_PROFILE_CODE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 4 //-->
    <asp:imagebutton id="imgKeyOPTION_PAY_MODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_PAY_MODE" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_PAY_MODE" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_PAY_MODE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 5 //-->
