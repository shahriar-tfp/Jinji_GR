...
Partial Class PAGES_INFORMATION_SYSTEM_IMPORT_EMPLOYEE_INCREMENT
    ...
    Protected Sub imgBtnUpload_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpload.Click
        If Not (txtFileName.PostedFile Is Nothing) Then
            Try
                ...
                Dim myData As New OleDbDataAdapter("SELECT * FROM [EMPINCREMENT$]", strConn)
                    ...
                    If myds1.Tables(0).Rows.Count > 0 Then
                        If myds1.Tables(0).Rows(0).Item(0).ToString > 0 Then
                            ...
                            If CInt(employee_id) > 0 Then
                                ssql = "exec sp_is_impEmpIncrement "
                                ssql = ssql & " N'" & GVUpload.Rows(i).Cells(1).Text.Trim.ToUpper.Replace("'", "''") & "',N'" & employee_id & "',"
                                ssql = ssql & "N'" & mySetting.UnDisplayDateTime(Trim(GVUpload.Rows(i).Cells(3).Text.Trim.ToUpper.Replace("'", "''")), Session("Company").ToString, Session("Module").ToString) & "',"
                                ...
                                ssql = ssql & "N'" & Session("EmpID").ToString & "'"
                                ...
                                If myds2.Tables.Count > 0 Then
                                    ...
                                    End If
                                Else
                                    GVUpload.Rows(i).Cells(0).Text = "Failed Insert Data."
                                End If
                                ssql = Nothing
                            Else
