...
Partial Class Pages_InformationSystem_Employee_Category
                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        Else
                                            If myDST.Tables(0).Rows(0).Item(2).ToString.Trim <> "" Then
                                                ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & myDST.Tables(0).Rows(0).Item(1).ToString.Trim & "',N'" & ReturnSessionValue(myDST.Tables(0).Rows(0).Item(1).ToString.Trim) & "'),''),"
                                            Else
