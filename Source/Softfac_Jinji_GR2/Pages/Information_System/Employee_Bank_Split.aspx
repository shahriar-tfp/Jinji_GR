<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Bank_Split.aspx.vb" Inherits="PAGES_PAYROLL_EMPLOYEE_BANK_SPLIT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Info - Employee Bank Split Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="EMPLOYEE_BANK_SPLIT" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyBANK_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblBANK_PROFILE_CODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtBANK_PROFILE_CODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnBANK_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyBANK_ACCOUNT_NUMBER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblBANK_ACCOUNT_NUMBER" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtBANK_ACCOUNT_NUMBER" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnBANK_ACCOUNT_NUMBER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 5 //-->
<asp:imagebutton id="imgKeyPERCENTAGE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblPERCENTAGE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtPERCENTAGE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnPERCENTAGE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 6 //-->
<asp:imagebutton id="imgKeyCURRENCY_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCURRENCY_PROFILE_CODE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCURRENCY_PROFILE_CODE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCURRENCY_PROFILE_CODE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnEFFECTIVE_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
