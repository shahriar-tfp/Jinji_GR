<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Resign.aspx.vb" Inherits="Pages_InformationSystem_Employee_Resign" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee Resign Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet">
</head>
<body id="body" runat="server">
    <form id="Employee_Resign" runat="server">
    <div>
    ...
    <asp:imagebutton id="imgbtnJOIN_DATE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 5 //-->
    ...
    <asp:imagebutton id="imgbtnCONFIRM_DATE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 6 //-->
    ...
    <asp:imagebutton id="imgbtnRESIGN_DATE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 7 //-->
    <asp:imagebutton id="imgKeySUBMIT_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblSUBMIT_DATE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtSUBMIT_DATE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnSUBMIT_DATE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 8 //-->
    <asp:imagebutton id="imgKeyOPTION_RESIGN_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_RESIGN_TYPE" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_RESIGN_TYPE" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_RESIGN_TYPE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 9 //-->
