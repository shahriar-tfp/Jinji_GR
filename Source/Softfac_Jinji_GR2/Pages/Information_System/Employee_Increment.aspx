<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Increment.aspx.vb" Inherits="Pages_InformationSystem_Employee_Increment" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee Increment Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_Increment" runat="server">
    <div>
    ...
    <asp:textbox id="txtPROMOTION" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnPROMOTION" runat="server" Height="21px"></asp:imagebutton>
    <!--// 9 //-->
    <asp:imagebutton id="imgKeyOCP_ID_JOB_GRADE_OLD" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOCP_ID_JOB_GRADE_OLD" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOCP_ID_JOB_GRADE_OLD" runat="server" Width="157px" autopostback ="true"  ></asp:dropdownlist>
    <asp:HiddenField ID="txtOCP_ID_JOB_GRADE_OLD" runat="server"></asp:HiddenField>
    <asp:imagebutton id="imgbtnOCP_ID_JOB_GRADE_OLD" runat="server" Height="21px"></asp:imagebutton>
    <!--// 10 //-->
    ...
    <asp:dropdownlist id="ddlOCP_ID_JOB_GRADE_NEW" runat="server" Width="157px" autopostback ="true"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOCP_ID_JOB_GRADE_NEW" runat="server" Height="21px"></asp:imagebutton>
    <!--// 11 //-->
    <asp:imagebutton id="imgKeyOCP_ID_JOB_TITLE_OLD" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOCP_ID_JOB_TITLE_OLD" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOCP_ID_JOB_TITLE_OLD" runat="server" Width="157px" autopostback ="true"></asp:dropdownlist>
    <asp:HiddenField ID="txtOCP_ID_JOB_TITLE_OLD" runat="server"></asp:HiddenField>
    <asp:imagebutton id="imgbtnOCP_ID_JOB_TITLE_OLD" runat="server" Height="21px"></asp:imagebutton>
    <!--// 12 //-->
    ...
    <asp:dropdownlist id="ddlOCP_ID_JOB_TITLE_NEW" runat="server" Width="157px" autopostback ="true"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOCP_ID_JOB_TITLE_NEW" runat="server" Height="21px"></asp:imagebutton>
    <!--// 13 //-->
    <asp:imagebutton id="imgKeyOCP_ID_APPRAISAL_OLD" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOCP_ID_APPRAISAL_OLD" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOCP_ID_APPRAISAL_OLD" runat="server" Width="157px" AutoPostBack="true"></asp:dropdownlist>
    <asp:HiddenField ID="txtOCP_ID_APPRAISAL_OLD" runat="server"></asp:HiddenField>
    <asp:imagebutton id="imgbtnOCP_ID_APPRAISAL_OLD" runat="server" Height="21px"></asp:imagebutton>
    <!--// 14 //-->
    ...
    <asp:imagebutton id="imgbtnREMARK" runat="server" Height="21px"></asp:imagebutton>
     <!--// 16 //-->
