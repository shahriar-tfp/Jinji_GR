<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Statutory.aspx.vb" Inherits="Pages_InformationSystem_Employee_Statutory" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>JINJI : Info - Employee Statutory Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet">
</head>
<body id="body" runat="server">
    <form id="Employee_Statutory" runat="server">
    <div>
    ...
    <!--// 3 //-->
    <asp:imagebutton id="imgKeyOPTION_TYPE_STATUTORY" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOPTION_TYPE_STATUTORY" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_TYPE_STATUTORY" runat="server" Width="157px" AutoPostBack="true"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_TYPE_STATUTORY" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 4 //-->
    ...
    <!--// 5 //-->
    <asp:imagebutton id="imgKeyOCP_ID_TYPE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
    <asp:label id="lblOCP_ID_TYPE" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtOCP_ID_TYPE" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnOCP_ID_TYPE" runat="server" Height="21px" ></asp:imagebutton>
    <!--// 6 //-->
    ...
    <asp:imagebutton id="imgbtnOPTION_LOCATION" runat="server" Height="21px" ></asp:imagebutton>
 ...
 <%-- "add the link to next page"  <asp:HyperLink ID="HyplnkReport1" runat="server" Text="Personal Info" NavigateUrl="../Information_system/Employee_profile.aspx"></asp:HyperLink>
    <asp:HyperLink ID="HyplnkReport2" runat="server" Text="Personal status" NavigateUrl="../Information_system/Employee_status.aspx"></asp:HyperLink>
--%>
										</asp:panel></td>
								</tr>
							</table>
