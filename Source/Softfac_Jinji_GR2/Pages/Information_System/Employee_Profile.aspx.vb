...
Partial Class Pages_InformationSystem_Employee_Profile
                ...
                Select Case myDS.Tables(0).Rows(i).Item(1).ToString
                    ...
                    Case Else   '"CHARACTER", "LOOKUP"
                        ...
                        If myTextBox.Visible = True Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & ","
                                If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "CODE" Then
                                    ssql2 = ssql2 & "ISNULL(dbo.fn_ReturnEmpCodeByCodeName('" & Session("Company").ToString & "','" & myTextBox.Text.ToString & "'),''),"
            ...
            For Me.i = 0 To myDS.Tables(0).Rows.Count - 1
                Select Case myDS.Tables(0).Rows(i).Item(2).ToString
                    ...
                    Case Else '"CHARACTER","LOOKUP"
                        ...
                        If myTextBox.Visible = True Then
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "ID" Then
                ...
                For Me.i = 0 To myDS2.Tables(0).Rows.Count - 1
                    Select Case myDS2.Tables(0).Rows(i).Item(2).ToString
                        ...
                        Case Else '"CHARACTER","LOOKUP"
                            ...
                            If myTextBox.Visible = True Then
                                If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                    If myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper = "ID" Then
...
#End Region
    ...
    Protected Sub imgBtnPrint_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnPrint.Click
        ...
        Dim a As String
        a = Session("Module").ToString
        a = Session("Language").ToString
        a = Session("Filterfield").ToString
        a = Session("FilterCriteria").ToString
