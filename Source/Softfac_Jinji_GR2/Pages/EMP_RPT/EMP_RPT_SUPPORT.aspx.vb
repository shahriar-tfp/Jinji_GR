...
Partial Class PAGES_EMP_RPT_EMP_RPT_SUPPORT
...
#Region "Public Declaration"
    ...
    Dim imgBtnBluePath As String = "../../Images/Default/blue/"
    Dim imgBtnGreyPath As String = "../../Images/Default/grey/"
...
Session("Module")="EMP_RPT"
            ...
            End If
            Dim width As Integer = Session("ScreenWidth") - 270
            Dim height As Integer = (Session("ScreenHeight") / 2) - 40
            If Not Request.Browser.IsMobileDevice Then
                pnlGridview.Width = width
                pnlGridview.Height = height
            End If
            pnlGridview.Width = width
            pnlGridview.Height = height
            PagePreload()
    ...
    Sub PagePreload()
        ...
        mySetting.GetBtnImgUrl(imgBtnClear, Session("Company").ToString, btnColourDef, "btnClear.gif")
        mySetting.GetBtnImgUrl(imgBtnCancel, Session("Company").ToString, btnColourDef, "btnCancel.gif")
        mySetting.GetBtnImgUrl(imgBtnAdd, Session("Company").ToString, btnColourDef, "btnAdd.gif")
        mySetting.GetBtnImgUrl(imgBtnFilter, Session("Company").ToString, btnColourDef, "btnFilter.gif")
        mySetting.GetBtnImgUrl(imgBtnDelete, Session("Company").ToString, btnColourDef, "btnDelete.gif")
        mySetting.GetBtnImgUrl(imgBtnUpdate, Session("Company").ToString, btnColourDef, "btnUpdate.gif")
        mySetting.GetBtnImgUrl(imgBtnEdit, Session("Company").ToString, btnColourDef, "btnEdit.gif")
        mySetting.GetBtnImgUrl(imgBtnPrint, Session("Company").ToString, btnColourDef, "btnPrint.gif")
        mySetting.GetBtnImgUrl(imgBtnGoToPage, Session("Company").ToString, btnColourDef, "btngo.gif")
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnAdd.Click
        ...
        mySetting.GetImgTypeUrl(imgtop, Session("Company"), "Gif", "imgtop_add.gif")
        mySetting.GetImgTypeUrl(imgbottom, Session("Company"), "Gif", "imgbottom.gif")
    ...
    Protected Sub imgBtnEdit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnEdit.Click
        If ActionValidateEdit() Then
            ...
            mySetting.GetImgTypeUrl(imgtop, Session("Company"), "Gif", "imgtop_edit.gif")
            mySetting.GetImgTypeUrl(imgbottom, Session("Company"), "Gif", "imgbottom.gif")
        End If
    End Sub
    ...
    Protected Sub imgBtnFilter_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnFilter.Click
        ...
        mySetting.GetImgTypeUrl(imgtop, Session("Company"), "Gif", "imgtop_search.gif")
        mySetting.GetImgTypeUrl(imgbottom, Session("Company"), "Gif", "imgbottom.gif")
...
#Region "Sub & Function"
    ...
    Private Sub AutoAdjustPosition(ByVal strSelect As String)
        Try
            ...
            buttonPosition1 = buttonPosition1 & autonum
            buttonPosition2 = buttonPosition2 & autonum
            buttonPosition3 = buttonPosition3 & autonum

            labelPosition1 = labelPosition1 & autonum
