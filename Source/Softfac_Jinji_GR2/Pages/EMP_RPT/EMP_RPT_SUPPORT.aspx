<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EMP_RPT_SUPPORT.aspx.vb" Inherits="PAGES_EMP_RPT_EMP_RPT_SUPPORT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>JINJI : Employee Report Support Page</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body>
<form id="EMP_RPT_SUPPORT" runat="server">
<div>
...
<!--// 3 //-->
<asp:imagebutton id="imgKeyOPT_CUSTOMER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPT_CUSTOMER" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPT_CUSTOMER" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPT_CUSTOMER" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 4 //-->
<asp:imagebutton id="imgKeyCONTACT_PERSON" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblCONTACT_PERSON" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtCONTACT_PERSON" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnCONTACT_PERSON" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 7 //-->
<asp:imagebutton id="imgKeyREPORTED_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblREPORTED_DATE" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtREPORTED_DATE" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnREPORTED_DATE" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<!--// 10 //-->
<asp:imagebutton id="imgKeyOPT_STATUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPT_STATUS" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPT_STATUS" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPT_STATUS" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
