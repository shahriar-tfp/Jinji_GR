...
Partial Class PAGES_KPI_STRATEGY_STATEMENT
...
#Region "Sub & Function"
    ...
    Private Sub SetLabelValueDisplayText()
        If ddlGROUP_BY.SelectedValue <> "" Then
            lblOBJECTIVE_STATEMENT_OCP_ID.Text = ddlGROUP_BY.SelectedItem.Text.ToString
        Else
            lblOBJECTIVE_STATEMENT_OCP_ID.Text = "OCP ID"
        End If
    End Sub
#End Region
    ...
    Protected Sub ddlGROUP_BY_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlGROUP_BY.SelectedIndexChanged
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OBJECTIVE_STATEMENT_OCP_ID" & """," & "" & """" & """," & """" & Session("EmpID").ToString & """," & """" & ddlGROUP_BY.SelectedValue & """"
        imgbtnOBJECTIVE_STATEMENT_OCP_ID.Attributes.Remove("onclick")

        mySetting.GetLookupValue_ImageButton(imgbtnOBJECTIVE_STATEMENT_OCP_ID, Form.ID, "txtOBJECTIVE_STATEMENT_OCP_ID", "CodeName", "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OBJECTIVE_STATEMENT_OCP_ID" & """," & """" & """," & """" & Session("EmpID").ToString & """," & """" & ddlGROUP_BY.SelectedValue & """")
