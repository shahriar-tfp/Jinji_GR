...
Partial Class PAGES_KPI_SWOT_ANALYSIS_PROTFOLIO
...
#Region "Sub & Function"
    ...
    Private Sub SetLabelValueDisplayText()
        If ddlCOMMENT_GROUP_BY.SelectedValue <> "" Then
            lblGROUP_OCP_ID.Text = ddlCOMMENT_GROUP_BY.SelectedItem.Text.ToString
        Else
            lblGROUP_OCP_ID.Text = "OCP ID"
        End If
    End Sub
#End Region
    ...
    End Sub
    Protected Sub ddlCOMMENT_GROUP_BY_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlCOMMENT_GROUP_BY.SelectedIndexChanged
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "GROUP_OCP_ID" & """," & "" & """" & """," & """" & Session("EmpID").ToString & """," & """" & ddlCOMMENT_GROUP_BY.SelectedValue & """"
        imgbtnGROUP_OCP_ID.Attributes.Remove("onclick")

        mySetting.GetLookupValue_ImageButton(imgbtnGROUP_OCP_ID, Form.ID, "txtGROUP_OCP_ID", "CodeName", "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "GROUP_OCP_ID" & """," & """" & """," & """" & Session("EmpID").ToString & """," & """" & ddlCOMMENT_GROUP_BY.SelectedValue & """")
        SetLabelValueDisplayText()
    End Sub
    Protected Sub ddlOPTION_GROUP_BY_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOPTION_GROUP_BY.SelectedIndexChanged
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "SWOT_SETUP_CODE" & """," & "" & """" & """," & """" & Session("EmpID").ToString & """," & """" & ddlOPTION_GROUP_BY.SelectedValue & """"
        imgbtnSWOT_SETUP_CODE.Attributes.Remove("onclick")

        mySetting.GetLookupValue_ImageButton(imgbtnSWOT_SETUP_CODE, Form.ID, "txtSWOT_SETUP_CODE", "CodeName", "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "SWOT_SETUP_CODE" & """," & """" & """," & """" & Session("EmpID").ToString & """," & """" & ddlOPTION_GROUP_BY.SelectedValue & """")
    End Sub
End Class