<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Process_Advance.aspx.vb" Inherits="Pages_Payroll_Process_Advance" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - Payroll Advance Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Payroll_Advance_Vw" runat="server">
    <div>
        ...
        <table>
            <tr>
                <td>
                    ...
                    <asp:TextBox ID="txtYEAR" runat="server" Width="70px"></asp:TextBox>
                    <asp:TextBox ID="txtMONTH" runat="server" Width="70px"></asp:TextBox>
                </td>
                <td>
                    <asp:ImageButton ID="imgKeyPAY_CYCLE" runat="server" Width="21px" Height="21px" />
                    <asp:Label ID="lblPAY_CYCLE" runat="server" Width="120px"></asp:Label>
                    <asp:Dropdownlist ID="ddlPAY_CYCLE" runat="server" Width="157px" AutoPostBack="true"></asp:Dropdownlist>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:ImageButton ID="imgkeyPay_Type" runat="server" Width="21px" Height="21px"/>
                    <asp:Label ID="lblPay_Type" runat="server" Width="120px"></asp:Label>
                    <asp:Dropdownlist ID="ddlPay_Type" runat="server" Width="157px" AutoPostBack="true"></asp:Dropdownlist>
                    
                </td>
                <td>
                    <asp:ImageButton ID="imgkeyAmount" runat="server" Width="21px" Height="21px" />
                    <asp:Label ID="lblAmount" runat="server" Width="120px"></asp:Label>
                    <asp:TextBox ID="txtAmount" runat="server" Width="157px"></asp:TextBox>
                    
                </td>
            </tr>
            
            <asp:Panel ID = "pnlMETHOD"  runat="server">
            <tr><td><asp:ImageButton ID="imgkeyMethod" runat="server" Width="21px" Height="21px" />
            <asp:Label ID="lblMethod" runat="server" Width="120px"></asp:Label>
                    <asp:Dropdownlist ID="ddlMethod" runat="server" Width="157px" AutoPostBack="true"></asp:Dropdownlist></td>
                    <td></td></tr>
            </asp:Panel>
            <tr>
                <td>
                ...
                <td><asp:ImageButton ID="imgKeyOCP_ID_Salary" runat="server" Width="21px" Height="21px"/>
                    <asp:Label ID="lblOCP_ID_Salary" runat="server" Width="120px"></asp:Label>
                    <asp:TextBox ID="txtOCP_ID_Salary" runat="server" Width="157px"></asp:TextBox>
                    <asp:ImageButton ID="imgBtnOCP_ID_Salary" runat="server" Width="21px" Height="21px"/></td>
            </tr>
            <tr>
                <td>
                    <asp:ImageButton ID="imgkeyJoin_Date" runat="server" Width="21px" Height="21px"/>
                    <asp:Label ID="lblJoin_Date" runat="server" Width="120px"></asp:Label>
                    <asp:TextBox ID="txtJoin_Date" runat="server" Width="157px"></asp:TextBox>
                    <asp:ImageButton ID="imgbtnJoin_Date" runat="server" Width="21px" Height="21px"/>
                </td>
                <td><asp:ImageButton ID="imgkeyResign_Date" runat="server" Width="21px" Height="21px"/>
                    <asp:Label ID="lblResign_Date" runat="server" Width="120px"></asp:Label>
                    <asp:TextBox ID="txtResign_Date" runat="server" Width="157px"></asp:TextBox>
                    <asp:ImageButton ID="imgbtnResign_Date" runat="server" Width="21px" Height="21px"/>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    ...
                    <asp:label id="lblOption_Race" runat="server" Width="120px"></asp:label>
	        ...
	        <%--<div style="border-top-style: double; border-right-style: double; border-left-style: double; border-bottom-style: double;border-color :#F2F4FF;">--%>
	            <asp:GridView id="myGridView" Width="100%" runat="server" AutoGenerateColumns="true" AutoGenerateEditButton="false" AutoGenerateDeleteButton="false" AutoGenerateSelectButton="false" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Status" ItemStyle-Width="157" >
                            <ItemTemplate>
                                <center><asp:label ID="lblStatus" runat="server" /></center>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
