<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Process_Payroll_Retro.aspx.vb" Inherits="Pages_Payroll_Process_Payroll_Retro" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - Payroll Process Page</title>
...
<body id="body" runat="server">
    ...
    <div >
		...
		<table id="Table13" width="50%" cellpadding="0" cellspacing="0" border="0" visible="false">
			...
			<tr>
				<td align="center" valign="middle" style="background-color:#cccccc; height:33px; width:100%">
					<asp:Label ID="lblCopyRight" CssClass="wordstyle9" runat="server">Copyright 2006 Softfac Technology Sdn Bhd<br /><i>All Rights Reserved</i>
					</asp:Label>
				</td>
			</tr>
		</table>  
