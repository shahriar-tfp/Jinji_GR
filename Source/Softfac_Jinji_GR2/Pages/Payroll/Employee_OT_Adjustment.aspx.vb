...
Partial Class PAGES_PAYROLL_EMPLOYEE_OT_ADJUSTMENT
...
#Region "Page Setting"
        ...
        If myDS.Tables.Count > 1 Then
            ...
            If myDT2.Rows.Count > 0 Then
                For Me.i = 0 To myDT2.Rows.Count - 1
                    ...
                    If myLabel.ID = "lblOT" Then
                        lblAdjustOTHour.Text = myLabel.Text + " (Hours)"
                        lblAdjustOTHour.CssClass = "wordstyle12"
                        lblAdjustOTMinute.Text = myLabel.Text + " (Minutes)"
                        lblAdjustOTMinute.CssClass = "wordstyle12"
                    End If
            ...
            mySetting.GetGridViewSetting(Session("Company").ToString, Session("Module").ToString, "No_Of_Record", Form.ID, "GetGridViewRecord", myGridView1)
            mySetting.GetGridViewSetting(Session("Company").ToString, Session("Module").ToString, "No_Of_Record", Form.ID, "GetGridViewRecord", myGridview2)
        End If
    End Sub
    ...
    Sub GetRequireData()
        ...
        Try
            ssql = "Exec sp_app_GetInfo 'EmployeeOTAdjustment','" & Session("Company") & "','" & Session("Module") & "'"
            myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
            If myDS.Tables(0).Rows.Count > 0 Then
...
#Region "Panel Edit"
    Protected Sub imgBtnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnSubmit.Click
        lblresult2.Text = ""
        If ActionValidateAdd() = True And ActionValidateAdd2() = True And ValidateInsert() = True Then
    ...
    Protected Sub imgBtnUpdate_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnUpdate.Click
        If ActionValidateAdd() = True And ActionValidateAdd2() = True And ValidateUpdate() Then
            mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
            pnlEdit.Visible = False
            pnlMain.Visible = True
            BindGrid()
...
#Region "Panel Action"
    ...
    Protected Sub imgBtnAdd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnAdd.Click
        ...
        txtAdjustOTHour.Visible = True
        txtAdjustOTMinute.Visible = True
        lblAdjustOTHour.Visible = True
        lblAdjustOTMinute.Visible = True
        CountRecord = 0
        ClearText()
        txtAdjustOTHour.Text = ""
        txtAdjustOTMinute.Text = ""
    ...
    Protected Sub imgBtnFilter_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnFilter.Click
        ...
        txtAdjustOTHour.Visible = False
        txtAdjustOTMinute.Visible = False
        lblAdjustOTHour.Visible = False
        lblAdjustOTMinute.Visible = False
        pnlEdit.Visible = True
        pnldescription.Visible = True
        pnlMain.Visible = False
        imgBtnSubmit.Visible = False
    ...
    Protected Sub ddlOPTION_CUT_OFF_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOPTION_CUT_OFF.SelectedIndexChanged
        ValueChange()
    End Sub

    Protected Sub ddlOPTION_PAY_CYCLE_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOPTION_PAY_CYCLE.SelectedIndexChanged
        ValueChange()
    End Sub
...
#Region "Sub & Function"
    Public Sub RetrieveDetail()
        ssql1 = "select dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),dbo.fn_ReturnEmpIDByCodeName(dbo.fn_ReturnCompanyProfileCode(N'" & txtCOMPANY_PROFILE_CODE.Text & "'),'" & txtEMPLOYEE_PROFILE_ID.Text.Replace("'", "''") & "')"

        myDS1 = mySQL.ExecuteSQL(ssql1, Session("Company").ToString, Session("EmpID").ToString)
        If myDS1.Tables(0).Rows.Count = 1 Then
            ssql = "exec sp_pr_SelTmsSummary '" & myDS1.Tables(0).Rows(0).Item(0).ToString & "','" & myDS1.Tables(0).Rows(0).Item(1).ToString & "','" & ddlOPTION_PAY_CYCLE.SelectedValue & "','" & ddlMONTH.SelectedValue & "','" & ddlYEAR.SelectedValue & "','" & ddlOPTION_CUT_OFF.SelectedValue & "','','OT'"
        Else
            ssql = "exec sp_pr_SelTmsSummary '','','','','','','','OT'"
        End If
        myDS1 = Nothing
        ssql1 = Nothing
        myDS = mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
    ...
    Private Function ActionValidateAdd() As Boolean
        RecFound = False
        CountRecord = 0
        For Me.i = 0 To myGridView1.Rows.Count - 1
            Dim chkEdit As CheckBox = myGridView1.Rows(i).Cells(0).Controls(1)
            If chkEdit.Checked Then
                RecFound = True
                CountRecord = CountRecord + 1
            End If
    ...
    Private Function ActionValidateAdd2() As Boolean
        If mySetting.CheckTextNullAndReplaceSingleQuote(txtAdjustOTHour) = True Or mySetting.CheckTextNullAndReplaceSingleQuote(txtAdjustOTMinute) = True Then
            If mySetting.CheckTextNullAndReplaceSingleQuote(txtAdjustOTHour) = False Then
                txtAdjustOTHour.Text = 0
            End If
            If mySetting.CheckTextNullAndReplaceSingleQuote(txtAdjustOTMinute) = False Then
                txtAdjustOTMinute.Text = 0
            End If

            If IsNumeric(txtAdjustOTHour.Text) = True And IsNumeric(txtAdjustOTMinute.Text) = True Then
                Return True
            Else
                ShowMessage(lblAdjustOTHour.Text & " or " & lblAdjustOTMinute.Text & " must be Numeric.")
                Return False
            End If
        Else
            ShowMessage(lblAdjustOTHour.Text & " or " & lblAdjustOTMinute.Text & " must be has value.")
            Return False
        End If
    End Function
    ...
    Sub AutoAdjustPosition(ByVal strSelect As String)
        ...
        Try
            ...
            If pnlgridview1.Visible = True Then
                ...
                autonum2 = autonum2 + 10 + EditRowCount
                lblAdjustOTHour.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                lblAdjustOTHour.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                lblAdjustOTHour.Style.Add("position", "absolute")
                autonum2 = autonum2 + 1
                txtAdjustOTHour.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                txtAdjustOTHour.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                txtAdjustOTHour.Style.Add("position", "absolute")
                txtAdjustOTHour.Width = txtWidth
                autonum2 = autonum2 + 3
                lblAdjustOTMinute.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                lblAdjustOTMinute.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                lblAdjustOTMinute.Style.Add("position", "absolute")
                autonum2 = autonum2 + 1
                txtAdjustOTMinute.Style.Add("left", mySetting.GetObjPosition(EctWidth, autonum2, "X"))
                txtAdjustOTMinute.Style.Add("top", mySetting.GetObjPosition(EctWidth, autonum2, "Y"))
                txtAdjustOTMinute.Style.Add("position", "absolute")
                txtAdjustOTMinute.Width = txtWidth
                buttonPosition1 = buttonPosition1 & autonum + rowCount + 1
                buttonPosition2 = buttonPosition2 & autonum + rowCount + 1
                buttonPosition3 = buttonPosition3 & autonum + rowCount + 1

                labelPosition1 = labelPosition1 & autonum + rowCount + 1
    ...
    Private Function ValidateInsert() As Boolean
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            ...
            If mySetting.CheckTextNullAndReplaceSingleQuote(txtAdjustOTHour) = True And mySetting.CheckTextNullAndReplaceSingleQuote(txtAdjustOTMinute) = True Then
                OverTime = (txtAdjustOTHour.Text * 60) + txtAdjustOTMinute.Text
            Else
                OverTime = 0
            End If
            ...
            For Me.i = 0 To myGridView1.Rows.Count - 1
                Dim chkEdit As CheckBox = myGridView1.Rows(i).Cells(0).Controls(1)
                If chkEdit.Checked Then
                    ssql = ssql & "OCP_ID_Day_Type,OT_Rate_Type,OT,"
                    ssql2 = ssql2 & "N'" & myGridview2.Rows(i).Cells(1).Text & "',N'" & myGridview2.Rows(i).Cells(4).Text & "'," & OverTime & ","
                    ssql3 = ssql3 & "OCP_ID_Day_Type = N'" & myGridview2.Rows(i).Cells(1).Text & "' and OT_Rate_Type= N'" & myGridview2.Rows(i).Cells(4).Text & "' and "
                End If
                chkEdit = Nothing
            Next
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
            ...
            If myDS2.Tables(0).Rows.Count > 0 Then
                ...
                For Me.i = 0 To myGridView1.Rows.Count - 1
                    Dim chkEdit As CheckBox = myGridView1.Rows(i).Cells(0).Controls(1)
                    If chkEdit.Checked Then
                        ssql = ssql & "OCP_ID_Day_Type=N'" & myGridview2.Rows(i).Cells(1).Text & "' and OT_Rate_Type=N'" & myGridview2.Rows(i).Cells(4).Text & "' and "
                    End If
                    chkEdit = Nothing
                Next
            End If
