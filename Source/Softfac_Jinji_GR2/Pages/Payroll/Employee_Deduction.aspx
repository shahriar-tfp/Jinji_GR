<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Employee_Deduction.aspx.vb" Inherits="Pages_Payroll_Employee_Deduction" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - Employee Deduction Page</title>
    <link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server">
    <form id="Employee_Deduction" runat="server">
<div>
    ...
    <!--// 3 //-->
    <asp:imagebutton id="imgKeyDATE_FROM" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblDATE_FROM" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtDATE_FROM" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnDATE_FROM" runat="server" Height="21px"></asp:imagebutton>
    <!--// 4 //-->
    <asp:imagebutton id="imgKeyDATE_TO" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblDATE_TO" runat="server" Width="140px"></asp:label>
    <asp:textbox id="txtDATE_TO" runat="server" Width="150px"></asp:textbox>
    <asp:imagebutton id="imgbtnDATE_TO" runat="server" Height="21px"></asp:imagebutton>
    <!--// 5 //-->
    ...
    <!--// 7 //-->
    <asp:imagebutton id="imgKeyOPTION_CALCULATE_ON" runat="server" Width="21px" Height="21px"></asp:imagebutton>
    <asp:label id="lblOPTION_CALCULATE_ON" runat="server" Width="140px"></asp:label>
    <asp:dropdownlist id="ddlOPTION_CALCULATE_ON" runat="server" Width="157px"></asp:dropdownlist>
    <asp:imagebutton id="imgbtnOPTION_CALCULATE_ON" runat="server" Height="21px"></asp:imagebutton>
    <!--// 8 //-->
