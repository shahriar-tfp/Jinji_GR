<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Publish_Retro.aspx.vb" Inherits="Pages_Payroll_Publish_Retro" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - Publish Retro Page</title>
...
<body id="body" runat="server">
    ...
    <asp:Panel ID="pnlEdit" runat="server">
        ...
        <table>
            <tr>
                <td>
                    ...
                    <asp:Dropdownlist ID="ddlMONTH" runat="server" Width="80px" AutoPostBack="true"></asp:Dropdownlist>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:ImageButton ID="imgKeyPayMonth" runat="server" Width="21px" Height="21px"/>
                    <asp:Label ID="lblPayMonth" runat="server" Width="120px"></asp:Label>
                    <asp:Dropdownlist ID="ddlPayYear" runat="server" Width="70px" AutoPostBack="true"></asp:Dropdownlist>
                    <asp:Dropdownlist ID="ddlPayMonth" runat="server" Width="80px" AutoPostBack="true"></asp:Dropdownlist>
                </td>
                <td>
                    <asp:ImageButton ID="imgKeyPayCycle" runat="server" Width="21px" Height="21px" />
                    <asp:Label ID="lblPayCycle" runat="server" Width="120px"></asp:Label>
                    <asp:Dropdownlist ID="ddlPayCycle" runat="server" Width="157px" AutoPostBack="true"></asp:Dropdownlist>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <table id="tblEditButton" runat="server">
            <tr align="left">
                <td>
                    <asp:ImageButton ID="imgbtnUpdate" runat="server" Width="74" Height="21" OnClientClick="return confirm('Confirm Publish To Payroll?')"></asp:ImageButton>
                    <asp:ImageButton ID="imgbtnUpdate2" runat="server" Width="74" Height="21" OnClientClick="return confirm('Confirm RePublish Paid To Payroll?')"></asp:ImageButton>
                    <asp:ImageButton ID="imgbtnUpdate3" runat="server" Width="74" Height="21" OnClientClick="return confirm('Confirm Unpublish To Payroll?')"></asp:ImageButton>
