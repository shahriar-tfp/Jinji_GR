<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Process_Batch_Payroll.aspx.vb" Inherits="Pages_Payroll_Process_Batch_Payroll" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>JINJI : Payroll - Payroll Batch Process Page</title>
...
<body id="body" runat="server">
        ...
        <table>
            <tr>
                <td>
                    ...
                    <asp:Label ID="lblDateStart" runat="server" Width="120px"></asp:Label>
                    <asp:TextBox ID="txtDateStart" runat="server" Width="150px"></asp:TextBox>
                    <asp:ImageButton ID="imgbtnDateStart" runat="server" />                
                </td>
                <td>                
                    <asp:ImageButton ID="imgKeyHOUR_MINUTE" runat="server" Width="21px" Height="21px"/>
                    <asp:Label ID="lblHOUR" runat="server" Width="80px"></asp:Label>
                    <asp:TextBox ID="txtHOUR" runat="server" Width="50px"></asp:TextBox>
                    <asp:Label ID="lblMINUTE" runat="server" Width="90px"></asp:Label>
                    <asp:TextBox ID="txtMINUTE" runat="server" Width="50px"></asp:TextBox>   
                    <asp:DropDownList ID="lstAP" runat="server" >
    ...
    <hr />
    <asp:Panel ID="pnlBatchProcess" runat="server" Visible="true"  >
        <div>
	            <asp:GridView id="grdBatchProcess" Width="100%" runat="server" AutoGenerateColumns="true" AutoGenerateEditButton="false" AutoGenerateDeleteButton="false" AutoGenerateSelectButton="false" 
	                cellspacing="0" cellpadding="1" EmptyDataText="No data found!">
	                <AlternatingRowStyle BackColor="#F2F4FF" />
	                <EditRowStyle BackColor="#FFC7C6" Font-Size="Smaller" Height="20"/>
	                <SelectedRowStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
