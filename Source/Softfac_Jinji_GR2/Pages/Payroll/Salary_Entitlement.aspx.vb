...
Partial Class Pages_Payroll_Salary_Entitlement
...
#Region "Sub & Function"
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        Else
                                            If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID" Then
                                                ssql2 = ssql2 & "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_OCP_TYPE.SelectedValue.ToString & "'),''),"
                                            Else
                                        ...
                                        If myDS.Tables(0).Rows(i).Item(6).ToString = "YES" Then
                                            ...
                                            Else
                                                If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID" Then
                                                    ssql3 = ssql3 & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_OCP_TYPE.SelectedValue.ToString & "'),0) And "
                                                Else
                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        Else
                                            If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID" Then
                                                ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_OCP_TYPE.SelectedValue.ToString & "'),''),"
                                            Else
                                        ...
                                        If myDST2.Tables(0).Rows.Count > 0 Then
                                            ...
                                            Else
                                                If myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID" Then
                                                    ssql = ssql & myDS2.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST2.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_OCP_TYPE.SelectedValue.ToString & "'),'') And "
                                                Else
    ...
    Private Sub SetLabelValueDisplayText()
        If ddlOPTION_OCP_TYPE.SelectedValue <> "" Then
            lblOCP_ID.Text = ddlOPTION_OCP_TYPE.SelectedItem.Text.ToString
        Else
...
#End Region
    ...
    Protected Sub ddlOPTION_OCP_TYPE_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOPTION_OCP_TYPE.SelectedIndexChanged
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID" & """," & "" & """" & """," & """" & Session("EmpID").ToString & """," & """" & ddlOPTION_OCP_TYPE.SelectedValue & """"
        imgbtnOCP_ID.Attributes.Remove("onclick")

        mySetting.GetLookupValue_ImageButton(imgbtnOCP_ID, Form.ID, "txtOCP_ID", "CodeName", "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID" & """," & """" & """," & """" & Session("EmpID").ToString & """," & """" & ddlOPTION_OCP_TYPE.SelectedValue & """")
