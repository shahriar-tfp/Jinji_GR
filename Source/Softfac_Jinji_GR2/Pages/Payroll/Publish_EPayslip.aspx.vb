...
Partial Class Pages_Payroll_Publish_EPayslip
    ...
    Private Sub PagePreload()
        ...
        SetInvisibleAll()
        ssql = "Exec sp_app_GetInfo 'Publish_EPayslip','" & Session("Company") & "','" & Session("Module") & "'"
    ...
    Private Sub BindGrid()
        Try
            ...
            End If
            If SearchCriteria = False Then
                ssql = "Exec sp_pr_selPublishEPayslip N'" & Session("Company").ToString & "',N'" & ddlYEAR.SelectedValue & "',N'" & ddlMONTH.SelectedValue & "',N'" & ddlFILTER_BY.SelectedValue & "'"
                'Else
            ...
            For Me.i = 0 To myGridView.Rows.Count - 1
                ...
                If chkBox.Checked = True Then
                    ...
                    If myDS.Tables(0).Rows(0).Item(0).ToString <> "" Then
                        ssql = "exec sp_pr_UpdPublishEPayslip '" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & ddlMONTH.SelectedValue & "','" & ddlYEAR.SelectedValue & "','YES','ADD'"
                        mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
                    End If
                    ssql1 = Nothing
                    myDS = Nothing
                End If
            Next
            ssql1 = "exec sp_pr_UpdPublishEPayslip '','','','','Publish Result'"
        ...
        If pnlGridview.Visible = True Then
            For Me.i = 0 To myGridView.Rows.Count - 1
                ...
                If chkBox.Checked = True Then
                    ...
                    myDS = mySQL.ExecuteSQL(ssql1)
                    If myDS.Tables(0).Rows(0).Item(0).ToString <> "" Then
                        ssql = "exec sp_pr_UpdPublishEPayslip '" & myDS.Tables(0).Rows(0).Item(0).ToString & "','" & ddlMONTH.SelectedValue & "','" & ddlYEAR.SelectedValue & "','NO','ADD'"
                        mySQL.ExecuteSQL(ssql, Session("Company").ToString, Session("EmpID").ToString)
                    End If
                    ssql1 = Nothing
                    myDS = Nothing
                End If
            Next
            ssql1 = "exec sp_pr_UpdPublishEPayslip '','','','','UnPublish Result'"
            myDS = mySQL.ExecuteSQL(ssql1, Session("Company").ToString, Session("EmpID").ToString)
            lblSysName.Visible = True
            lblSysName.Text = myDS.Tables(0).Rows(0).Item(0).ToString
            pnlProgress.Visible = True
