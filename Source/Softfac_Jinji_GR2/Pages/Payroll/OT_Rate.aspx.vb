...
Partial Class Pages_Payroll_OT_Rate
...
#Region "Sub & Function"
    ...
    Private Function ValidateInsert() As Boolean
        ...
        If myDS.Tables(0).Rows.Count > 0 Then
                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        Else
                                            If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID" Then
                                                ssql2 = ssql2 & "ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_OCP_ID_TYPE.SelectedValue.ToString & "'),''),"
                                            Else
                                        ...
                                        If myDS.Tables(0).Rows(i).Item(6).ToString = "YES" Then
                                            ...
                                            Else
                                                If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID" Then
                                                    ssql3 = ssql3 & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_OCP_ID_TYPE.SelectedValue.ToString & "'),0) And "
                                                Else
            ...
            ssql4 = "Select isnull(Max(OT_Rate_Type)+1,0) from " & Form.ID
            myDS2 = New DataSet
            myDS2 = mySQL.ExecuteSQL(ssql4)
            ssql = ssql & "OT_RATE_TYPE,"
            ssql2 = ssql2 & "'" & myDS2.Tables(0).Rows(0).Item(0).ToString & "',"
            ssql4 = Nothing
            myDS2 = Nothing
                            ...
                            If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                ...
                                Else
                                    ...
                                    If myDST.Tables(0).Rows.Count > 0 Then
                                        ...
                                        Else
                                            If myDS.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID" Then
                                                ssql = ssql & myDS.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_OCP_ID_TYPE.SelectedValue.ToString & "'),''),"
                                            Else
                                ...
                                If mySetting.CheckTextNullAndReplaceSingleQuote(myTextBox) = True Then
                                    ...
                                    Else
                                        ...
                                        If myDST2.Tables(0).Rows.Count > 0 Then
                                            ...
                                            Else
                                                If myDS2.Tables(0).Rows(i).Item(0).ToString.ToUpper = "OCP_ID" Then
                                                    ssql = ssql & myDS2.Tables(0).Rows(i).Item(0) & "=ISNULL(" & myDST2.Tables(0).Rows(0).Item(0).ToString & "(N'" & myTextBox.Text.ToString & "',N'" & ddlOPTION_OCP_ID_TYPE.SelectedValue.ToString & "'),'') And "
                                                Else
...
#End Region
    ...
    Protected Sub ddlOPTION_OCP_ID_TYPE_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOPTION_OCP_ID_TYPE.SelectedIndexChanged
        ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID" & """," & "" & """" & """," & """" & Session("EmpID").ToString & """," & """" & ddlOPTION_OCP_ID_TYPE.SelectedValue & """"
        imgbtnOCP_ID.Attributes.Remove("onclick")

        mySetting.GetLookupValue_ImageButton(imgbtnOCP_ID, Form.ID, "txtOCP_ID", "CodeName", "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID" & """," & """" & """," & """" & Session("EmpID").ToString & """," & """" & ddlOPTION_OCP_ID_TYPE.SelectedValue & """")
        SetLabelValueDisplayText()
    End Sub

    Private Sub SetLabelValueDisplayText()
        If ddlOPTION_OCP_ID_TYPE.SelectedValue <> "" Then
            lblOCP_ID.Text = ddlOPTION_OCP_ID_TYPE.SelectedItem.Text.ToString
        Else
            lblOCP_ID.Text = "OCP Code"
        End If
    End Sub
