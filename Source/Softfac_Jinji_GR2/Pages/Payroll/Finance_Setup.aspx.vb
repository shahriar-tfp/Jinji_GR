                ...
                If chkDelete.Checked Then
                    ...
                    If Not myDS Is Nothing Then
                        ...
                        Else
                            ...
                            If GetParameter("CLOCK IN", i) = "" Then
                                ssql = "Exec sp_tms_delattendance N'" & Session("Company").ToString & "',N'" & _
                                    GetParameter("EMPLOYEE CODE", i) & "','" & _
                                    "','','"
                            Else
                                ssql = "Exec sp_tms_delattendance '" & Session("Company").ToString & "',N'" & _
                                    GetParameter("EMPLOYEE CODE", i) & "','" & _
                                    Left(mySetting.UnDisplayDateTime(GetParameter("CLOCK IN", i), Session("Company").ToString, "ROSTER"), 8) & "000000" & "','" & _
                                    Right(mySetting.UnDisplayDateTime(GetParameter("CLOCK IN", i), Session("Company").ToString, "ROSTER"), 6) & "','"
                            End If
                            If GetParameter("CLOCK OUT", i) = "" Then
                                ssql &= "','','','" & Session("EmpID").ToString & "'"
                            Else
                                ssql &= Left(mySetting.UnDisplayDateTime(GetParameter("CLOCK OUT", i), Session("Company").ToString, "ROSTER"), 8) & "000000" & "','" & _
                                            Right(mySetting.UnDisplayDateTime(GetParameter("CLOCK OUT", i), Session("Company").ToString, "ROSTER"), 6) & "','','" & Session("EmpID").ToString & "'"
                            End If
                            'mySQL.ExecuteSQL(ssql)
