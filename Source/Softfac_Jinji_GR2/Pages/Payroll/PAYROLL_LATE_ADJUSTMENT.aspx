<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PAYROLL_LATE_ADJUSTMENT.aspx.vb" Inherits="PAGES_PAYROLL_PAYROLL_LATE_ADJUSTMENT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"" http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
<title>PAYROLL_LATE_ADJUSTMENT</title>
<link href="../../App_Themes/hcrmStyles1.css" type="text/css" rel="stylesheet" />
</head>
<body id="body" runat="server"> 
<form id="PAYROLL_LATE_ADJUSTMENT" runat="server">
<div>
...
<asp:dropdownlist id="ddlOPTION_PAY_CYCLE" runat="server" Width="150px" ></asp:dropdownlist>
...
<!--// 6 //-->
<asp:imagebutton id="imgKeyOPTION_ID_CUT_OFF" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblOPTION_ID_CUT_OFF" runat="server" Width="140px" ></asp:label>
<asp:dropdownlist id="ddlOPTION_ID_CUT_OFF" runat="server" Width="150px" ></asp:dropdownlist>
<asp:imagebutton id="imgbtnOPTION_ID_CUT_OFF" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnLATE_IN" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
...
<asp:imagebutton id="imgbtnEARLY_OUT" runat="server" Width="21px" Height="21px" ></asp:imagebutton>

<!--// 9 //-->
<asp:imagebutton id="imgKeyABSENT_HOUR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
<asp:label id="lblABSENT_HOUR" runat="server" Width="140px" ></asp:label>
<asp:textbox id="txtABSENT_HOUR" runat="server" Width="150px" ></asp:textbox>
<asp:imagebutton id="imgbtnABSENT_HOUR" runat="server" Width="21px" Height="21px" ></asp:imagebutton>
