...
Partial Class Pages_Payroll_Bonus_Simulation
    ...
    Private Sub PagePreload()
        ...
        lblOCP_ID_Salary.Text = "Bonus Code"
        ...
        imgbtnOption_Race.Visible = False
        ...
        mySetting.GetImgUrl(imgbtnOption_Race, clsGlobalSetting.ImageType._LOOKUP, Session("Company").ToString)
        ...
        mySetting.GetDropdownlistValue(Form.ID, "OPTION_RACE", ddlOption_Race)
        ...
        'ssql = "Exec sp_sa_GetLookupCodeName " & """" & Session("Company").ToString & """," & """" & Session("Module").ToString & """," & """" & Form.ID & """," & """" & "OCP_ID_SALARY" & """," & """" & """," & """" & Session("EmpID").ToString & """"
            ...
            If pnlGridview.Visible = True Then
                For Me.i = 0 To myGridView.Rows.Count - 1
                    ...
                    If chkBox.Checked = True Then
                        ...
                        empid = ""
                        salaryID = ""
                        ssql2 = "select dbo.fn_ReturnEmpIDByCodeName(N'" & Session("Company").ToString & "',N'" & myGridView.Rows(i).Cells(2).Text.ToString.Replace("&amp;", "&").Replace("'", "''") & "'),dbo.fn_GetOCPIDByCodeName(N'" & txtOCP_ID_Salary.Text & "','SALARY')"
                        ...
                        ssql = "Exec [sp_pr_insUpdDelEmpBonus] N'" & Session("Company").ToString & "',N'" & _
                             Trim(salaryID) & "',N'" & empid & "',N'" & _
                             Trim(txtYEAR.Text.ToString) & "',N'" & Trim(txtMONTH.Text) & "',N'" & ddlPAY_CYCLE.SelectedValue & "',N'" & ddlPay_Type.SelectedValue & _
    ...
    Private Function ValidateProcess() As Boolean
        ...
        If txtOCP_ID_Salary.Text = "" Then
            ShowMessage("Cannot be Blank! Bonus Code")
