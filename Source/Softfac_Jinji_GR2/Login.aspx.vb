...
Partial Class Login
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '    tblLogin.Style.Add("display", "block")
        '    tblLogin.Style.Add("margin-left", "auto")
        '    tblLogin.Style.Add("margin-right", "auto")
        '    tblLogin.Style.Add("margin-top", "100px")
        '    tblLogin.Style.Add("margin-bottom", "auto")
    ...
    Protected Sub imgBtnLogin_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgBtnLogin.Click
        '-- Start Active Directory Server to find User 2013/04/01
        Dim activeDir As Boolean = False
        ...
        If DomainLogin = "YES" Then
            activeDir = mySQL.ValidateActiveDirectoryLogin(Trim(txtEmployeeID.Text), Trim(txtPassword.Text))
        Else
            activeDir = False
        End If
        If activeDir Then
            ...
            If myDS.Tables.Count > 0 Then
                If myDS.Tables(0).Rows.Count > 0 Then
                    If myDS.Tables(0).Rows(0).Item(0).ToString = "E02" Then
                        SetFieldToFalse()
                        pnlResult.Visible = True
                ...
                If myDS.Tables.Count > 0 Then
                    If myDS.Tables(0).Rows.Count > 0 Then
                        ...
                        ElseIf myDS.Tables(0).Rows(0).Item(0).ToString = "E05" Or myDS.Tables(0).Rows(0).Item(0).ToString = "E14" Then
                            ...
                            Session("TString") = myDS.Tables(0).Rows(0).Item(4).ToString
