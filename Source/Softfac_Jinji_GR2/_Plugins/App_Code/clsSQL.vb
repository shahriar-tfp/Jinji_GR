...
Public Class clsSQL
    ...
    Dim strServer As String, strDatabase As String, strUserid As String, strPassword As String
    ...
    Const SQLTimeOut As Integer = 12000
    ...
    Public Function AddBatchQuery(ByVal query As StringBuilder, ByVal EmpID As String, ByVal count As Integer, ByVal batchdate As String) As String
        Dim MyConnection As New SqlConnection
        Dim myCommand As New SqlCommand()
        ...
        Try
            ...
            myCommand.CommandText = "insert into Payroll_Batch_Process(query,querydate,userid,count) values(@query,'" + batchdate.ToString() + "','" + EmpID.ToString() + "','" + count.ToString() + "')"
            myCommand.ExecuteNonQuery()
    ...
    Public Function GetConnectionStringDetails(ByVal enmSQLInfo As SQLInfo) As String
        ...
        Return strOutput
    End Function
    '-- Start Active Directory Server to find User 2013/04/01
    Public Function ValidateActiveDirectoryLogin(ByVal Username As String, ByVal Password As String) As Boolean
        ...
        If File.Exists(strPath & "Setup\Setup.ini") Then
            Dim ReadIniFile As New clsReadFile(strPath & "\Setup\Setup.ini")
            Domain = ReadIniFile.GetString("Setup", "DomainServer", "(none)")
        Else
        ...
        End Try
        Return Success
        '-- End Active Directory Server to find User 2013/04/01
    End Function

    Public Function CheckLogin() As Boolean
        Call GetProjectPath()

        Dim DomainLogin As String = "NO"

        If File.Exists(strPath & "Setup\Setup.ini") Then
            Dim ReadIniFile As New clsReadFile(strPath & "\Setup\Setup.ini")
            DomainLogin = ReadIniFile.GetString("Setup", "DomainLogin", "(none)")
        Else
            'ShowMessage("Setup.ini File Not Found At " & strPath & "\bin")
        End If

        If DomainLogin = "YES" Then
            Return True
        Else
            Return False
        End If
