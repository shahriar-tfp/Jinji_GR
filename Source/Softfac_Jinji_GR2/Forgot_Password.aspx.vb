    ...
    Public Sub SendMail(ByVal strCode As String, ByVal strPass As String, ByVal strMailTo As String)
        ...
        If File.Exists(strFilePath & "Setup\Setup.ini") Then
            Try
                ...
                Dim strMailUser As String = ReadIniFile.GetString("Mail", "AdminUser", "(none)")
                Dim strMailport As String = ReadIniFile.GetString("Mail", "AdminPort", "(none)")
                Dim strUseDefaultCredentials As String = ReadIniFile.GetString("Mail", "UseDefaultCredentials", "(none)")
                ...
                Dim basicAuthenticationInfo As New System.Net.NetworkCredential(strMailUser, strMailPass)
                Dim from As New System.Net.Mail.MailAddress(strMailAdd, strMailDsp)
                Dim subemail As Array = Split(strMailTo, ";")
                Dim message As New System.Net.Mail.MailMessage()
                Dim toEmail As New System.Net.Mail.MailAddress(strMailAdd)
                ...
                For j = 0 To subemail.Length - 1
                    toEmail = New System.Net.Mail.MailAddress(subemail(j))
                ...
                mailClient.Port = strMailport
                mailClient.UseDefaultCredentials = strUseDefaultCredentials
